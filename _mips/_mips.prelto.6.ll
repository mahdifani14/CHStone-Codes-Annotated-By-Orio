...
.thread:                                          ; preds = %157, %35
  %n_inst.0.lcssa = phi i32 [ %n_inst.0, %35 ], [ %n_inst.0, %157 ]
...
; <label>:271                                     ; preds = %261
  ...
  %272 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str1, i32 0, i32 0), i32 %main_result.0.lcssa) #3
  %273 = icmp eq i32 %main_result.0.lcssa, 9
  br i1 %273, label %274, label %276

; <label>:274                                     ; preds = %271
  %275 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #3
  br label %278

; <label>:276                                     ; preds = %271
  %277 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str3, i32 0, i32 0)) #3
  br label %278
