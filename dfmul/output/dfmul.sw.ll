...
; <label>:126                                     ; preds = %normalizeFloat64Subnormal.exit.i, %100
  ...
  %142 = mul i64 %139, %134
  %143 = mul i64 %137, %134
  %overflow_intrinsic.i = zext i64 %141 to i65
  %overflow_intrinsic1.i = zext i64 %142 to i65
  %overflow_intrinsic2.i = add i65 %overflow_intrinsic.i, %overflow_intrinsic1.i
  %overflow_intrinsic_sum.i = trunc i65 %overflow_intrinsic2.i to i64
  %overflow_intrinsic3.i = lshr i65 %overflow_intrinsic2.i, 64
  %overflow_intrinsic_carry.i = trunc i65 %overflow_intrinsic3.i to i1
  %144 = zext i1 %overflow_intrinsic_carry.i to i64
  %145 = shl nuw nsw i64 %144, 32
  %146 = lshr i64 %overflow_intrinsic_sum.i, 32
  %147 = or i64 %145, %146
  %148 = shl i64 %overflow_intrinsic_sum.i, 32
  %overflow_intrinsic4.i = zext i64 %140 to i65
  %overflow_intrinsic5.i = zext i64 %148 to i65
  %overflow_intrinsic6.i = add i65 %overflow_intrinsic4.i, %overflow_intrinsic5.i
  %overflow_intrinsic_sum7.i = trunc i65 %overflow_intrinsic6.i to i64
  %overflow_intrinsic8.i = lshr i65 %overflow_intrinsic6.i, 64
  %overflow_intrinsic_carry9.i = trunc i65 %overflow_intrinsic8.i to i1
  %149 = zext i1 %overflow_intrinsic_carry9.i to i64
  %150 = add i64 %149, %143
  %151 = add i64 %150, %147
  %152 = icmp ne i64 %overflow_intrinsic_sum7.i, 0
...
float64_mul.exit:                                 ; preds = %.thread6.i.i, %167, %106, %80, %73, %71, %float64_is_signaling_nan.exit.i.i, %43, %41, %float64_is_signaling_nan.exit.i12.i
  ...
  %212 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([65 x i8]* @.str, i32 0, i32 0), i64 %3, i64 %5, i64 %208, i64 %.0.i)
...
; <label>:214                                     ; preds = %float64_mul.exit
  ...
  %215 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %.lcssa)
  %216 = icmp eq i32 %.lcssa, 20
  br i1 %216, label %217, label %219

; <label>:217                                     ; preds = %214
  %218 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0))
  br label %221

; <label>:219                                     ; preds = %214
  %220 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str3, i32 0, i32 0))
  br label %221
