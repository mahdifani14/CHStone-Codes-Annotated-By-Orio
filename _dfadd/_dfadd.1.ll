...
; <label>:1                                       ; preds = %float64_add.exit, %0
  ...
  %i.01 = phi i32 [ 0, %0 ], [ %242, %float64_add.exit ]
  ...
  %2 = load i64* %scevgep3, align 8, !tbaa !5
  %3 = load i64* %scevgep2, align 8, !tbaa !5
  %4 = lshr i64 %2, 63
...
float64_is_signaling_nan.exit1.i10.i:             ; preds = %22
  ...
  %.mux2.v.i14.i = select i1 %27, i64 %3, i64 %2
...
; <label>:30                                      ; preds = %20
  ...
  %expDiff.0.i = add nsw i32 %34, %13
  %35 = icmp eq i32 %expDiff.0.i, 0
  br i1 %35, label %shift64RightJamming.exit9.i, label %36

; <label>:36                                      ; preds = %30
  %37 = icmp slt i32 %expDiff.0.i, 64
  br i1 %37, label %38, label %48

; <label>:38                                      ; preds = %36
  %39 = zext i32 %expDiff.0.i to i64
  %40 = lshr i64 %33, %39
  %41 = sub nsw i32 0, %expDiff.0.i
  %42 = and i32 %41, 63
...
; <label>:55                                      ; preds = %53
  %56 = icmp eq i64 %18, 0
  br i1 %56, label %63, label %float64_is_signaling_nan.exit1.i1.i

float64_is_signaling_nan.exit1.i1.i:              ; preds = %55
  ...
  %.mux2.v.i5.i = select i1 %60, i64 %3, i64 %2
...
; <label>:66                                      ; preds = %53
  ...
  %expDiff.1.i = add nsw i32 %13, %70
  %71 = sub nsw i32 0, %expDiff.1.i
  %72 = icmp eq i32 %expDiff.1.i, 0
  br i1 %72, label %shift64RightJamming.exit9.i, label %73

; <label>:73                                      ; preds = %66
  %74 = icmp sgt i32 %expDiff.1.i, -64
  br i1 %74, label %75, label %84

; <label>:75                                      ; preds = %73
  %76 = zext i32 %71 to i64
  %77 = lshr i64 %69, %76
  %78 = and i32 %expDiff.1.i, 63
...
; <label>:88                                      ; preds = %87
  %89 = or i64 %18, %16
  %90 = icmp eq i64 %89, 0
  br i1 %90, label %float64_add.exit, label %float64_is_signaling_nan.exit1.i.i

float64_is_signaling_nan.exit1.i.i:               ; preds = %88
  ...
  %.mux2.v.i.i = select i1 %94, i64 %3, i64 %2
...
shift64RightJamming.exit9.i:                      ; preds = %84, %75, %66, %48, %38, %30
  %105 = phi i64 [ %16, %30 ], [ %16, %38 ], [ %16, %48 ], [ %83, %75 ], [ %86, %84 ], [ %69, %66 ]
  %106 = phi i64 [ %33, %30 ], [ %47, %38 ], [ %50, %48 ], [ %18, %75 ], [ %18, %84 ], [ %18, %66 ]
  %zExp.0.i = phi i32 [ %10, %30 ], [ %10, %38 ], [ %10, %48 ], [ %12, %75 ], [ %12, %84 ], [ %12, %66 ]
  %107 = or i64 %105, 2305843009213693952
  %108 = add i64 %107, %106
  %109 = shl i64 %108, 1
  %110 = icmp slt i64 %109, 0
  %not..i = xor i1 %110, true
  %111 = sext i1 %not..i to i32
  %zExp.0..i = add nsw i32 %111, %zExp.0.i
  %..i = select i1 %110, i64 %108, i64 %109
  br label %112

; <label>:112                                     ; preds = %shift64RightJamming.exit9.i, %102
  %zExp.1.i = phi i32 [ %10, %102 ], [ %zExp.0..i, %shift64RightJamming.exit9.i ]
  %zSig.0.i = phi i64 [ %104, %102 ], [ %..i, %shift64RightJamming.exit9.i ]
  %113 = tail call fastcc i64 @roundAndPackFloat64(i32 %5, i32 %zExp.1.i, i64 %zSig.0.i) #1
  br label %float64_add.exit
...
; <label>:123                                     ; preds = %122
  ...
  br i1 %125, label %132, label %float64_is_signaling_nan.exit1.i11.i

float64_is_signaling_nan.exit1.i11.i:             ; preds = %123
  ...
  %.mux2.v.i15.i = select i1 %129, i64 %3, i64 %2
  %.mux2.i16.i = or i64 %.mux2.v.i15.i, 2251799813685248
  br label %float64_add.exit

; <label>:132                                     ; preds = %123
  %133 = load i32* @float_exception_flags, align 4, !tbaa !1
  %134 = or i32 %133, 16
  store i32 %134, i32* @float_exception_flags, align 4, !tbaa !1
  br label %float64_add.exit
...
; <label>:136                                     ; preds = %135, %122
  %aExp.0.i = phi i32 [ 1, %135 ], [ %10, %122 ]
  %bExp.0.i = phi i32 [ 1, %135 ], [ %12, %122 ]
...
; <label>:142                                     ; preds = %140
  ...
  br i1 %143, label %150, label %float64_is_signaling_nan.exit1.i4.i

float64_is_signaling_nan.exit1.i4.i:              ; preds = %142
  ...
  %.mux2.v.i8.i = select i1 %147, i64 %3, i64 %2
...
; <label>:155                                     ; preds = %140
  ...
  %expDiff.0.i3 = add nsw i32 %13, %159
  %160 = sub nsw i32 0, %expDiff.0.i3
  %161 = icmp eq i32 %expDiff.0.i3, 0
  br i1 %161, label %shift64RightJamming.exit3.i, label %162

; <label>:162                                     ; preds = %155
  %163 = icmp sgt i32 %expDiff.0.i3, -64
  br i1 %163, label %164, label %173

; <label>:164                                     ; preds = %162
  %165 = zext i32 %160 to i64
  %166 = lshr i64 %158, %165
  %167 = and i32 %expDiff.0.i3, 63
...
shift64RightJamming.exit3.i:                      ; preds = %173, %164, %155
  %z.0.i2.i = phi i64 [ %172, %164 ], [ %175, %173 ], [ %158, %155 ]
  %176 = or i64 %118, 4611686018427387904
  br label %177

; <label>:177                                     ; preds = %shift64RightJamming.exit3.i, %138
  %178 = phi i64 [ %z.0.i2.i, %shift64RightJamming.exit3.i ], [ %116, %138 ]
  %179 = phi i64 [ %176, %shift64RightJamming.exit3.i ], [ %118, %138 ]
  %bExp.1.i = phi i32 [ %12, %shift64RightJamming.exit3.i ], [ %bExp.0.i, %138 ]
  %180 = sub i64 %179, %178
  %181 = xor i32 %5, 1
  br label %218
...
; <label>:184                                     ; preds = %182
  ...
  br i1 %185, label %float64_add.exit, label %float64_is_signaling_nan.exit1.i.i4

float64_is_signaling_nan.exit1.i.i4:              ; preds = %184
  ...
  %.mux2.v.i.i8 = select i1 %189, i64 %3, i64 %2
...
; <label>:192                                     ; preds = %182
  ...
  %expDiff.1.i11 = add nsw i32 %196, %13
  %197 = icmp eq i32 %expDiff.1.i11, 0
  br i1 %197, label %shift64RightJamming.exit.i, label %198

; <label>:198                                     ; preds = %192
  %199 = icmp slt i32 %expDiff.1.i11, 64
  br i1 %199, label %200, label %210

; <label>:200                                     ; preds = %198
  %201 = zext i32 %expDiff.1.i11 to i64
  %202 = lshr i64 %195, %201
  %203 = sub nsw i32 0, %expDiff.1.i11
  %204 = and i32 %203, 63
...
shift64RightJamming.exit.i:                       ; preds = %210, %200, %192
  %z.0.i.i = phi i64 [ %209, %200 ], [ %212, %210 ], [ %195, %192 ]
  %213 = or i64 %116, 4611686018427387904
  br label %214

; <label>:214                                     ; preds = %shift64RightJamming.exit.i, %136
  %215 = phi i64 [ %213, %shift64RightJamming.exit.i ], [ %116, %136 ]
  %216 = phi i64 [ %z.0.i.i, %shift64RightJamming.exit.i ], [ %118, %136 ]
  %aExp.1.i = phi i32 [ %10, %shift64RightJamming.exit.i ], [ %aExp.0.i, %136 ]
  %217 = sub i64 %215, %216
  br label %218

; <label>:218                                     ; preds = %214, %177
  %.0.i12 = phi i32 [ %5, %214 ], [ %181, %177 ]
  %zExp.0.i13 = phi i32 [ %aExp.1.i, %214 ], [ %bExp.1.i, %177 ]
  %zSig.0.i14 = phi i64 [ %217, %214 ], [ %180, %177 ]
  %219 = add nsw i32 %zExp.0.i13, -1
  %220 = icmp ult i64 %zSig.0.i14, 4294967296
  %221 = lshr i64 %zSig.0.i14, 32
  %a.sink.i.i.i = select i1 %220, i64 %zSig.0.i14, i64 %221
  %extract.t.i.i.i = trunc i64 %a.sink.i.i.i to i32
  %222 = icmp ult i32 %extract.t.i.i.i, 65536
  %223 = shl i32 %extract.t.i.i.i, 16
  %.a.i.i.i.i = select i1 %222, i32 %223, i32 %extract.t.i.i.i
  %..i.i.i.i = select i1 %222, i32 16, i32 0
  %224 = icmp ult i32 %.a.i.i.i.i, 16777216
  br i1 %224, label %225, label %normalizeRoundAndPackFloat64.exit.i

; <label>:225                                     ; preds = %218
  %226 = or i32 %..i.i.i.i, 8
  %227 = shl i32 %.a.i.i.i.i, 8
  br label %normalizeRoundAndPackFloat64.exit.i

normalizeRoundAndPackFloat64.exit.i:              ; preds = %225, %218
  %.1.i.i.i.i = phi i32 [ %227, %225 ], [ %.a.i.i.i.i, %218 ]
  %shiftCount.1.i.i.i.i = phi i32 [ %226, %225 ], [ %..i.i.i.i, %218 ]
  %228 = lshr i32 %.1.i.i.i.i, 24
  ...
  %232 = add nsw i32 %shiftCount.1.i.i.i.i, %231
  %233 = add i32 %232, %230
  %234 = sub i32 %219, %233
  %235 = zext i32 %233 to i64
  %236 = shl i64 %zSig.0.i14, %235
  %237 = tail call fastcc i64 @roundAndPackFloat64(i32 %.0.i12, i32 %234, i64 %236) #1
  br label %float64_add.exit

float64_add.exit:                                 ; preds = %normalizeRoundAndPackFloat64.exit.i, %float64_is_signaling_nan.exit1.i.i4, %184, %150, %float64_is_signaling_nan.exit1.i4.i, %138, %132, %float64_is_signaling_nan.exit1.i11.i, %112, %97, %float64_is_signaling_nan.exit1.i.i, %88, %63, %float64_is_signaling_nan.exit1.i1.i, %float64_is_signaling_nan.exit1.i10.i, %22
  %.0.i = phi i64 [ %.mux2.i15.i, %float64_is_signaling_nan.exit1.i10.i ], [ %113, %112 ], [ %.mux2.i6.i, %float64_is_signaling_nan.exit1.i1.i ], [ %65, %63 ], [ %.mux2.i.i, %float64_is_signaling_nan.exit1.i.i ], [ %101, %97 ], [ %2, %22 ], [ %2, %88 ], [ %.mux2.i.i9, %float64_is_signaling_nan.exit1.i.i4 ], [ %237, %normalizeRoundAndPackFloat64.exit.i ], [ %.mux2.i9.i, %float64_is_signaling_nan.exit1.i4.i ], [ %154, %150 ], [ %.mux2.i16.i, %float64_is_signaling_nan.exit1.i11.i ], [ 9223372036854775807, %132 ], [ %2, %184 ], [ 0, %138 ]
  %238 = load i64* %scevgep, align 8, !tbaa !5
  %239 = icmp eq i64 %.0.i, %238
  %240 = zext i1 %239 to i32
  %241 = add nsw i32 %240, %main_result.02
  %242 = add nsw i32 %i.01, 1
  %exitcond1 = icmp eq i32 %242, 46
  br i1 %exitcond1, label %243, label %1

; <label>:243                                     ; preds = %float64_add.exit
  %.lcssa = phi i32 [ %241, %float64_add.exit ]
  %244 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %.lcssa) #1
  %245 = icmp eq i32 %.lcssa, 46
  br i1 %245, label %246, label %248

; <label>:246                                     ; preds = %243
  %247 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0)) #1
  br label %250

; <label>:248                                     ; preds = %243
  %249 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #1
  br label %250
