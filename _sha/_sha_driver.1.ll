...
.preheader.lr.ph.i.i:                             ; preds = %sha_update.exit.i, %0
  %j.02.i = phi i32 [ 0, %0 ], [ %67, %sha_update.exit.i ]
...
; <label>:9                                       ; preds = %9, %.preheader.i.i
  %indvar1 = phi i32 [ %indvar.next2, %9 ], [ 0, %.preheader.i.i ]
  %10 = mul i32 %indvar1, 4
  %11 = add i32 %4, %10
  ...
  %exitcond3 = icmp ne i32 %indvar.next2, 16
  br i1 %exitcond3, label %9, label %memcpy.exit.i.i

memcpy.exit.i.i:                                  ; preds = %9
...
; <label>:30                                      ; preds = %memcpy.exit.i.i
  %31 = add i32 %1, -64
  %32 = and i32 %31, -64
  %33 = sub i32 %31, %32
...
; <label>:47                                      ; preds = %47, %.lr.ph.i.i1.i
  %indvar13 = phi i32 [ %indvar.next14, %47 ], [ 0, %.lr.ph.i.i1.i ]
  %48 = mul i32 %indvar13, 4
  %49 = add i32 %43, %48
  %scevgep20 = getelementptr [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 %49
  %50 = add i32 %44, %48
  %p2.01.i4.i.i = getelementptr [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 %50
  %51 = add i32 %45, %48
  %scevgep18 = getelementptr [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 %51
  %52 = add i32 %46, %48
  %scevgep17 = getelementptr [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 %52
  %p1.02.i3.i.i = getelementptr [16 x i32]* @sha_info_data, i32 0, i32 %indvar13
  %53 = load i8* %p2.01.i4.i.i, align 1, !tbaa !5
  %54 = zext i8 %53 to i32
  %55 = load i8* %scevgep20, align 1, !tbaa !5
  %56 = zext i8 %55 to i32
  %57 = shl nuw nsw i32 %56, 8
  %58 = or i32 %57, %54
  %59 = load i8* %scevgep18, align 1, !tbaa !5
  %60 = zext i8 %59 to i32
  %61 = shl nuw nsw i32 %60, 16
  %62 = or i32 %58, %61
  %63 = load i8* %scevgep17, align 1, !tbaa !5
  %64 = zext i8 %63 to i32
  %65 = shl nuw i32 %64, 24
  %66 = or i32 %62, %65
  store i32 %66, i32* %p1.02.i3.i.i, align 4, !tbaa !1
  %indvar.next14 = add i32 %indvar13, 1
  %exitcond15 = icmp ne i32 %indvar.next14, %39
  br i1 %exitcond15, label %47, label %sha_update.exit.i.loopexit

sha_update.exit.i.loopexit:                       ; preds = %47
  br label %sha_update.exit.i

sha_update.exit.i:                                ; preds = %sha_update.exit.i.loopexit, %30
  %67 = add nsw i32 %j.02.i, 1
  %exitcond21 = icmp eq i32 %67, 2
  br i1 %exitcond21, label %.lr.ph.i8.preheader.i.i, label %.preheader.lr.ph.i.i
...
.lr.ph.i8.i.i:                                    ; preds = %.lr.ph.i8.i.i, %.lr.ph.i8.preheader.i.i
  ...
  %68 = add i32 %indvar, 1
  %p.11.i7.i.i = getelementptr [16 x i32]* @sha_info_data, i32 0, i32 %68
  store i32 0, i32* %p.11.i7.i.i, align 4, !tbaa !1
  %indvar.next = add i32 %indvar, 1
  %exitcond = icmp ne i32 %indvar.next, 13
  br i1 %exitcond, label %.lr.ph.i8.i.i, label %sha_stream.exit
...
sha_stream.exit:                                  ; preds = %.lr.ph.i8.i.i
  ...
  %83 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %82) #1
  %84 = icmp eq i32 %82, 5
  br i1 %84, label %85, label %87

; <label>:85                                      ; preds = %sha_stream.exit
  %86 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0)) #1
  br label %89

; <label>:87                                      ; preds = %sha_stream.exit
  %88 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #1
  br label %89
...
.preheader2.preheader:                            ; preds = %21
  %.lcssa6 = phi i32 [ %36, %21 ]
  %.lcssa5 = phi i32 [ %33, %21 ]
  %A.023.lcssa = phi i32 [ %A.023, %21 ]
  %C.025.lcssa = phi i32 [ %C.025, %21 ]
  %D.026.lcssa = phi i32 [ %D.026, %21 ]
  br label %.preheader2
...
.preheader2:                                      ; preds = %.preheader2, %.preheader2.preheader
  ...
  %C.119 = phi i32 [ %51, %.preheader2 ], [ %.lcssa6, %.preheader2.preheader ]
  %B.118 = phi i32 [ %A.117, %.preheader2 ], [ %A.023.lcssa, %.preheader2.preheader ]
  %A.117 = phi i32 [ %48, %.preheader2 ], [ %.lcssa5, %.preheader2.preheader ]
...
.preheader1.preheader:                            ; preds = %.preheader2
  %.lcssa4 = phi i32 [ %51, %.preheader2 ]
  %.lcssa3 = phi i32 [ %48, %.preheader2 ]
...
.preheader1:                                      ; preds = %.preheader1, %.preheader1.preheader
  ...
  %C.213 = phi i32 [ %67, %.preheader1 ], [ %.lcssa4, %.preheader1.preheader ]
  %B.212 = phi i32 [ %A.211, %.preheader1 ], [ %A.117.lcssa, %.preheader1.preheader ]
  %A.211 = phi i32 [ %64, %.preheader1 ], [ %.lcssa3, %.preheader1.preheader ]
...
.preheader.preheader:                             ; preds = %.preheader1
  %.lcssa2 = phi i32 [ %67, %.preheader1 ]
  %.lcssa1 = phi i32 [ %64, %.preheader1 ]
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %C.37 = phi i32 [ %81, %.preheader ], [ %.lcssa2, %.preheader.preheader ]
  %B.36 = phi i32 [ %A.35, %.preheader ], [ %A.211.lcssa, %.preheader.preheader ]
  %A.35 = phi i32 [ %78, %.preheader ], [ %.lcssa1, %.preheader.preheader ]
...
; <label>:82                                      ; preds = %.preheader
  %.lcssa8 = phi i32 [ %81, %.preheader ]
  %.lcssa = phi i32 [ %78, %.preheader ]
