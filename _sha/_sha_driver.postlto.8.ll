; ModuleID = '_sha_driver.postlto.8.bc'
...
sha_stream.exit:                                  ; preds = %.lr.ph.i8.i.i
  ...
  %68 = icmp eq i32 %.pre, 6969911
  %69 = zext i1 %68 to i32
  %70 = icmp eq i32 %.pre4, -1814260603
  %71 = zext i1 %70 to i32
  %72 = add nuw nsw i32 %69, %71
  %73 = icmp eq i32 %.pre5, 742465810
  %74 = zext i1 %73 to i32
  %75 = add nuw nsw i32 %72, %74
  %76 = icmp eq i32 %.pre6, 1677179459
  %77 = zext i1 %76 to i32
  %78 = add nuw nsw i32 %75, %77
  %79 = icmp eq i32 %.pre7, -1384908510
  %80 = zext i1 %79 to i32
  %81 = add nuw nsw i32 %78, %80
  %82 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %81) #1
  %83 = icmp eq i32 %81, 5
  br i1 %83, label %84, label %86

; <label>:84                                      ; preds = %sha_stream.exit
  %85 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0)) #1
  br label %88

; <label>:86                                      ; preds = %sha_stream.exit
  %87 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #1
  br label %88
