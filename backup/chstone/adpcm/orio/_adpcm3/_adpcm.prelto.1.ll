...
; <label>:5                                       ; preds = %5, %0
  ...
  %12 = tail call i32 @encode(i32 %8, i32 %11) #4
  %13 = getelementptr inbounds [100 x i32]* @compressed, i32 0, i32 %i1.05
  ...
  %21 = tail call i32 @encode(i32 %17, i32 %20) #4
  ...
  %29 = load i32* %28, align 4, !tbaa !1
  %30 = tail call i32 @encode(i32 %26, i32 %29) #4
  ...
  %38 = load i32* %37, align 4, !tbaa !1
  %39 = tail call i32 @encode(i32 %35, i32 %38) #4
  ...
  %48 = tail call i32 @encode(i32 %44, i32 %47) #4
  ...
  %56 = load i32* %55, align 4, !tbaa !1
  %57 = tail call i32 @encode(i32 %53, i32 %56) #4
  ...
  %66 = tail call i32 @encode(i32 %62, i32 %65) #4
  ...
  %74 = load i32* %73, align 4, !tbaa !1
  %75 = tail call i32 @encode(i32 %71, i32 %74) #4
  %76 = getelementptr inbounds [100 x i32]* @compressed, i32 0, i32 %68
  store i32 %75, i32* %76, align 4, !tbaa !1
  %77 = add nsw i32 %i1.05, 8
  %78 = icmp slt i32 %77, 93
  br i1 %78, label %5, label %.preheader2

; <label>:79                                      ; preds = %79, %.preheader2
  %i.03 = phi i32 [ 0, %.preheader2 ], [ %88, %79 ]
  %80 = sdiv i32 %i.03, 2
  %81 = getelementptr inbounds [100 x i32]* @compressed, i32 0, i32 %80
  %82 = load i32* %81, align 4, !tbaa !1
  tail call void @decode(i32 %82) #4
  %83 = load i32* @xout1, align 4, !tbaa !1
  %84 = getelementptr inbounds [100 x i32]* @result, i32 0, i32 %i.03
  store i32 %83, i32* %84, align 4, !tbaa !1
  %85 = load i32* @xout2, align 4, !tbaa !1
  %86 = or i32 %i.03, 1
  %87 = getelementptr inbounds [100 x i32]* @result, i32 0, i32 %86
  store i32 %85, i32* %87, align 4, !tbaa !1
  %88 = add nsw i32 %i.03, 2
