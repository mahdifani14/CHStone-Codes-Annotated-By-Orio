...
; <label>:5                                       ; preds = %5, %0
  ...
  %12 = tail call fastcc i32 @encode(i32 %8, i32 %11) #2
  ...
  %21 = tail call fastcc i32 @encode(i32 %17, i32 %20) #2
  ...
  %29 = load i32* %28, align 4, !tbaa !1
  %30 = tail call fastcc i32 @encode(i32 %26, i32 %29) #2
  ...
  %39 = tail call fastcc i32 @encode(i32 %35, i32 %38) #2
  ...
  %48 = tail call fastcc i32 @encode(i32 %44, i32 %47) #2
  ...
  %56 = load i32* %55, align 4, !tbaa !1
  %57 = tail call fastcc i32 @encode(i32 %53, i32 %56) #2
  ...
  %66 = tail call fastcc i32 @encode(i32 %62, i32 %65) #2
  ...
  %74 = load i32* %73, align 4, !tbaa !1
  %75 = tail call fastcc i32 @encode(i32 %71, i32 %74) #2
...
; <label>:79                                      ; preds = %79, %.preheader2.i
  ...
  tail call fastcc void @upzero(i32 %117, i32* getelementptr inbounds ([6 x i32]* @dec_del_dltx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @dec_del_bpl, i32 0, i32 0)) #2
  ...
  tail call fastcc void @upzero(i32 %196, i32* getelementptr inbounds ([6 x i32]* @dec_del_dhx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @dec_del_bph, i32 0, i32 0)) #2
...
; <label>:306                                     ; preds = %.preheader
  ...
  %307 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %.main_result.2.lcssa) #2
  %308 = icmp eq i32 %.main_result.2.lcssa, 150
  br i1 %308, label %309, label %311

; <label>:309                                     ; preds = %306
  %310 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #2
  br label %313

; <label>:311                                     ; preds = %306
  %312 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #2
  br label %313
