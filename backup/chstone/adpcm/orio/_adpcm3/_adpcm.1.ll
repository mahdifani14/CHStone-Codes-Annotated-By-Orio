...
; <label>:1                                       ; preds = %5, %0
  %indvar35 = phi i64 [ %indvar.next36, %5 ], [ 0, %0 ]
  %2 = mul i64 %indvar35, 4
  ...
  br i1 %exitcond37, label %legup_memset_4_i64.exit.preheader, label %5
...
legup_memset_4_i64.exit:                          ; preds = %legup_memset_4_i64.exit, %legup_memset_4_i64.exit.preheader
  ...
  %exitcond10 = icmp ne i32 %indvar.next9, 12
...
; <label>:58                                      ; preds = %58, %.preheader2.i
  ...
  %accumd.10.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.9.0, %58 ]
  %accumd.9.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.8.0, %58 ]
  %accumd.8.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.7.0, %58 ]
  %accumd.7.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.6.0, %58 ]
  %accumd.6.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.5.0, %58 ]
  %accumd.5.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.4.0, %58 ]
  %accumd.4.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.3.0, %58 ]
  %accumd.3.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.2.0, %58 ]
  %accumd.2.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.1.0, %58 ]
  %accumd.1.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.0.0, %58 ]
  %accumd.0.0 = phi i32 [ 0, %.preheader2.i ], [ %218, %58 ]
  %accumc.10.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.9.0, %58 ]
  %accumc.9.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.8.0, %58 ]
  %accumc.8.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.7.0, %58 ]
  %accumc.7.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.6.0, %58 ]
  %accumc.6.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.5.0, %58 ]
  %accumc.5.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.4.0, %58 ]
  %accumc.4.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.3.0, %58 ]
  %accumc.3.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.2.0, %58 ]
  %accumc.2.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.1.0, %58 ]
  %accumc.1.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.0.0, %58 ]
  %accumc.0.0 = phi i32 [ 0, %.preheader2.i ], [ %217, %58 ]
  %dec_ph2.0 = phi i32 [ 0, %.preheader2.i ], [ %dec_ph1.0, %58 ]
  %dec_ph1.0 = phi i32 [ 0, %.preheader2.i ], [ %192, %58 ]
  %dec_nbh.0 = phi i32 [ 0, %.preheader2.i ], [ %...i2.i.i, %58 ]
  %dec_deth.0 = phi i32 [ 8, %.preheader2.i ], [ %191, %58 ]
  %dec_ah2.0 = phi i32 [ 0, %.preheader2.i ], [ %...i.i.i, %58 ]
  %dec_rh2.0 = phi i32 [ 0, %.preheader2.i ], [ %dec_rh1.0, %58 ]
  %dec_ah1.0 = phi i32 [ 0, %.preheader2.i ], [ %apl1.2.i.i.i, %58 ]
  %dec_rh1.0 = phi i32 [ 0, %.preheader2.i ], [ %216, %58 ]
  %dec_plt2.0 = phi i32 [ 0, %.preheader2.i ], [ %dec_plt1.0, %58 ]
  %dec_plt1.0 = phi i32 [ 0, %.preheader2.i ], [ %119, %58 ]
  %dec_nbl.0 = phi i32 [ 0, %.preheader2.i ], [ %...i13.i.i, %58 ]
  %dec_detl.0 = phi i32 [ 32, %.preheader2.i ], [ %118, %58 ]
  %dec_al2.0 = phi i32 [ 0, %.preheader2.i ], [ %...i11.i.i, %58 ]
  %dec_rlt2.0 = phi i32 [ 0, %.preheader2.i ], [ %dec_rlt1.0, %58 ]
  %dec_al1.0 = phi i32 [ 0, %.preheader2.i ], [ %apl1.2.i7.i.i, %58 ]
  %dec_rlt1.0 = phi i32 [ 0, %.preheader2.i ], [ %143, %58 ]
  ...
  br i1 %exitcond5, label %58, label %adpcm_main.exit.preheader
...
; <label>:277                                     ; preds = %.preheader
  ...
  %278 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %.main_result.2.lcssa) #2
  %279 = icmp eq i32 %.main_result.2.lcssa, 150
