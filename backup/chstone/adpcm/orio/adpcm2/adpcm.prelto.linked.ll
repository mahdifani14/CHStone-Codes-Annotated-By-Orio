...
; <label>:1                                       ; preds = %1, %0
  ...
  %2 = sdiv i32 %i.02, 2
  %3 = getelementptr inbounds [100 x i32]* @test_data, i32 0, i32 %i.02
  %4 = load i32* %3, align 4, !tbaa !1
  %5 = or i32 %i.02, 1
...
; <label>:1                                       ; preds = %1, %0
  ...
  %2 = sdiv i32 %i.02.i, 2
  %3 = getelementptr inbounds [100 x i32]* @test_data, i32 0, i32 %i.02.i
  %4 = load i32* %3, align 4, !tbaa !1
  %5 = or i32 %i.02.i, 1
  %6 = getelementptr inbounds [100 x i32]* @test_data, i32 0, i32 %5
  %7 = load i32* %6, align 4, !tbaa !1
  %8 = tail call i32 @encode(i32 %4, i32 %7) #5
  %9 = getelementptr inbounds [100 x i32]* @compressed, i32 0, i32 %2
  store i32 %8, i32* %9, align 4, !tbaa !1
...
; <label>:41                                      ; preds = %36
  %42 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #5
  br label %43
