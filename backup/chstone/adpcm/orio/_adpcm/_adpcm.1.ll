...
; <label>:111                                     ; preds = %113
  %112 = icmp slt i32 %115, 30
  br i1 %112, label %113, label %quantl.exit

; <label>:113                                     ; preds = %111, %0
  %114 = phi i32 [ 0, %0 ], [ %120, %111 ]
  %115 = add i32 %114, 1
  %scevgep = getelementptr [30 x i32]* @decis_levl, i32 0, i32 %114
  %116 = load i32* %scevgep, align 4, !tbaa !1
  %117 = mul nsw i32 %116, %108
  %118 = ashr i32 %117, 15
  %119 = icmp sgt i32 %m.0.i.i, %118
  %120 = add nsw i32 %114, 1
  br i1 %119, label %111, label %quantl.exit

quantl.exit:                                      ; preds = %113, %111
  %mil.0.lcssa.i = phi i32 [ %114, %113 ], [ %115, %111 ]
...
; <label>:1                                       ; preds = %5, %0
  %indvar17 = phi i64 [ %indvar.next18, %5 ], [ 0, %0 ]
  %2 = mul i64 %indvar17, 4
  ...
  br i1 %exitcond19, label %legup_memset_4_i64.exit.preheader, label %5
...
.preheader2.i:                                    ; preds = %legup_memset_4_i64.exit
  %6 = tail call fastcc i32 @encode(i32 0, i32 undef) #2
...
legup_memset_4_i64.exit:                          ; preds = %legup_memset_4_i64.exit, %legup_memset_4_i64.exit.preheader
  ...
  %15 = tail call fastcc i32 @encode(i32 %13, i32 %14) #2
  ...
  %20 = tail call fastcc i32 @encode(i32 %18, i32 %19) #2
  ...
  %25 = tail call fastcc i32 @encode(i32 %23, i32 %24) #2
  ...
  %exitcond10 = icmp ne i32 %indvar.next9, 166
  br i1 %exitcond10, label %legup_memset_4_i64.exit, label %.preheader2.i

; <label>:27                                      ; preds = %27, %.preheader2.i
  %indvar = phi i32 [ %indvar.next, %27 ], [ 0, %.preheader2.i ]
  %accumd.10.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.9.0, %27 ]
  %accumd.9.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.8.0, %27 ]
  %accumd.8.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.7.0, %27 ]
  %accumd.7.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.6.0, %27 ]
  %accumd.6.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.5.0, %27 ]
  %accumd.5.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.4.0, %27 ]
  %accumd.4.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.3.0, %27 ]
  %accumd.3.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.2.0, %27 ]
  %accumd.2.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.1.0, %27 ]
  %accumd.1.0 = phi i32 [ 0, %.preheader2.i ], [ %accumd.0.0, %27 ]
  %accumd.0.0 = phi i32 [ 0, %.preheader2.i ], [ %187, %27 ]
  %accumc.10.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.9.0, %27 ]
  %accumc.9.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.8.0, %27 ]
  %accumc.8.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.7.0, %27 ]
  %accumc.7.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.6.0, %27 ]
  %accumc.6.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.5.0, %27 ]
  %accumc.5.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.4.0, %27 ]
  %accumc.4.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.3.0, %27 ]
  %accumc.3.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.2.0, %27 ]
  %accumc.2.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.1.0, %27 ]
  %accumc.1.0 = phi i32 [ 0, %.preheader2.i ], [ %accumc.0.0, %27 ]
  %accumc.0.0 = phi i32 [ 0, %.preheader2.i ], [ %186, %27 ]
  %dec_ph2.0 = phi i32 [ 0, %.preheader2.i ], [ %dec_ph1.0, %27 ]
  %dec_ph1.0 = phi i32 [ 0, %.preheader2.i ], [ %161, %27 ]
  %dec_nbh.0 = phi i32 [ 0, %.preheader2.i ], [ %...i2.i.i, %27 ]
  %dec_deth.0 = phi i32 [ 8, %.preheader2.i ], [ %160, %27 ]
  %dec_ah2.0 = phi i32 [ 0, %.preheader2.i ], [ %...i.i.i, %27 ]
  %dec_rh2.0 = phi i32 [ 0, %.preheader2.i ], [ %dec_rh1.0, %27 ]
  %dec_ah1.0 = phi i32 [ 0, %.preheader2.i ], [ %apl1.2.i.i.i, %27 ]
  %dec_rh1.0 = phi i32 [ 0, %.preheader2.i ], [ %185, %27 ]
  %dec_plt2.0 = phi i32 [ 0, %.preheader2.i ], [ %dec_plt1.0, %27 ]
  %dec_plt1.0 = phi i32 [ 0, %.preheader2.i ], [ %88, %27 ]
  %dec_nbl.0 = phi i32 [ 0, %.preheader2.i ], [ %...i13.i.i, %27 ]
  %dec_detl.0 = phi i32 [ 32, %.preheader2.i ], [ %87, %27 ]
  %dec_al2.0 = phi i32 [ 0, %.preheader2.i ], [ %...i11.i.i, %27 ]
  %dec_rlt2.0 = phi i32 [ 0, %.preheader2.i ], [ %dec_rlt1.0, %27 ]
  %dec_al1.0 = phi i32 [ 0, %.preheader2.i ], [ %apl1.2.i7.i.i, %27 ]
  %dec_rlt1.0 = phi i32 [ 0, %.preheader2.i ], [ %112, %27 ]
  %i.03.i = mul i32 %indvar, 2
  %28 = add i32 %i.03.i, 1
  ...
  tail call fastcc void @upzero(i32 %66, i32* getelementptr inbounds ([6 x i32]* @dec_del_dltx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @dec_del_bpl, i32 0, i32 0)) #2
  ...
  tail call fastcc void @upzero(i32 %145, i32* getelementptr inbounds ([6 x i32]* @dec_del_dhx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @dec_del_bph, i32 0, i32 0)) #2
  ...
  %exitcond5 = icmp ne i32 %indvar.next, 500
  br i1 %exitcond5, label %27, label %adpcm_main.exit.preheader

adpcm_main.exit.preheader:                        ; preds = %27
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  br i1 %exitcond1, label %246, label %.preheader

; <label>:246                                     ; preds = %.preheader
  %.main_result.2.lcssa = phi i32 [ %.main_result.2, %.preheader ]
  %247 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %.main_result.2.lcssa) #2
  %248 = icmp eq i32 %.main_result.2.lcssa, 496
  br i1 %248, label %249, label %251

; <label>:249                                     ; preds = %246
  %250 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str1, i32 0, i32 0)) #2
  br label %253

; <label>:251                                     ; preds = %246
  %252 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #2
  br label %253
