...
; <label>:1                                       ; preds = %2, %0
  ...
  br i1 %exitcond19, label %legup_memset_4_i64.exit.preheader, label %2
...
; <label>:27                                      ; preds = %27, %.preheader2.i
  ...
  br i1 %exitcond5, label %adpcm_main.exit.preheader, label %27
...
; <label>:246                                     ; preds = %.preheader
  %247 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %.main_result.2) #2
