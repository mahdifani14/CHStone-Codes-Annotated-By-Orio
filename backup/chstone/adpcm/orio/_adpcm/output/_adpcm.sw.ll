...
define internal fastcc void @upzero(i32 %dlt, i32* %dlti, i32* %bli) {
  %1 = icmp eq i32 %dlt, 0
...
define internal fastcc i32 @encode(i32 %xin1, i32 %xin2) {
...
quantl.exit:                                      ; preds = %113, %111
  ...
  tail call fastcc void @upzero(i32 %124, i32* getelementptr inbounds ([6 x i32]* @delay_dltx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @delay_bpl, i32 0, i32 0))
...
; <label>:213                                     ; preds = %211, %quantl.exit
  ...
  tail call fastcc void @upzero(i32 %218, i32* getelementptr inbounds ([6 x i32]* @delay_dhx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @delay_bph, i32 0, i32 0))
...
define i32 @main() section "_main_section" {
  ...
  call void @llvm.memset.p0i8.i64(i8* bitcast ([24 x i32]* @tqmf to i8*), i8 0, i64 96, i32 4, i1 false)
  br label %2

.preheader2.i:                                    ; preds = %2
  %1 = tail call fastcc i32 @encode(i32 0, i32 undef)
...
; <label>:2                                       ; preds = %2, %0
  ...
  %9 = tail call fastcc i32 @encode(i32 %5, i32 %8)
  ...
  %18 = tail call fastcc i32 @encode(i32 %14, i32 %17)
  ...
  %27 = tail call fastcc i32 @encode(i32 %23, i32 %26)
...
; <label>:31                                      ; preds = %31, %.preheader2.i
  ...
  tail call fastcc void @upzero(i32 %69, i32* getelementptr inbounds ([6 x i32]* @dec_del_dltx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @dec_del_bpl, i32 0, i32 0))
  ...
  tail call fastcc void @upzero(i32 %148, i32* getelementptr inbounds ([6 x i32]* @dec_del_dhx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @dec_del_bph, i32 0, i32 0))
...
; <label>:258                                     ; preds = %.preheader
  ...
  %259 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %.main_result.2.lcssa)
  %260 = icmp eq i32 %.main_result.2.lcssa, 496
  br i1 %260, label %261, label %263

; <label>:261                                     ; preds = %258
  %262 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str1, i32 0, i32 0))
  br label %265

; <label>:263                                     ; preds = %258
  %264 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0))
  br label %265
