...
; <label>:31                                      ; preds = %31, %.preheader2
  ...
  %36 = getelementptr inbounds [1000 x i32]* @result, i32 0, i32 %i.03
  store i32 %35, i32* %36, align 4, !tbaa !1
  %37 = load i32* @xout2, align 4, !tbaa !1
  %38 = or i32 %i.03, 1
  %39 = getelementptr inbounds [1000 x i32]* @result, i32 0, i32 %38
...
; <label>:1                                       ; preds = %1, %0
  ...
  %2 = getelementptr inbounds [1000 x i32]* @compressed, i32 0, i32 %i.03
  %3 = load i32* %2, align 4, !tbaa !1
  %4 = getelementptr inbounds [1000 x i32]* @test_compressed, i32 0, i32 %i.03
  %5 = load i32* %4, align 4, !tbaa !1
  %6 = icmp eq i32 %3, %5
  %7 = zext i1 %6 to i32
  %.main_result.0 = add nsw i32 %7, %main_result.04
  %8 = add nsw i32 %i.03, 1
  %exitcond5 = icmp eq i32 %8, 500
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %9 = getelementptr inbounds [1000 x i32]* @result, i32 0, i32 %i.11
  %10 = load i32* %9, align 4, !tbaa !1
  %11 = getelementptr inbounds [1000 x i32]* @test_result, i32 0, i32 %i.11
  %12 = load i32* %11, align 4, !tbaa !1
  %13 = icmp eq i32 %10, %12
  %14 = zext i1 %13 to i32
  %.main_result.2 = add nsw i32 %14, %main_result.22
  %15 = add nsw i32 %i.11, 1
  %exitcond = icmp eq i32 %15, 1000
...
; <label>:16                                      ; preds = %.preheader
  ...
  %18 = icmp eq i32 %.main_result.2.lcssa, 496
  br i1 %18, label %19, label %21

; <label>:19                                      ; preds = %16
  %20 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str1, i32 0, i32 0)) #5
  br label %23
