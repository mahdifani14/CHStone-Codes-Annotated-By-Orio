...
; <label>:31                                      ; preds = %27
  ...
  %33 = load i32* getelementptr inbounds ([6 x i32]* @delay_bpl, i32 0, i32 0), align 4, !tbaa !1
  %34 = load i32* getelementptr inbounds ([6 x i32]* @delay_dltx, i32 0, i32 0), align 4, !tbaa !1
  %35 = mul nsw i32 %34, %33
  br label %36

; <label>:36                                      ; preds = %36, %31
  %bpl.pn.i = phi i32* [ getelementptr inbounds ([6 x i32]* @delay_bpl, i32 0, i32 0), %31 ], [ %.017.i, %36 ]
  %dlt.pn.i = phi i32* [ getelementptr inbounds ([6 x i32]* @delay_dltx, i32 0, i32 0), %31 ], [ %.06.i, %36 ]
  %zl.05.i = phi i32 [ %35, %31 ], [ %40, %36 ]
  %i.04.i = phi i32 [ 1, %31 ], [ %41, %36 ]
  %.06.i = getelementptr inbounds i32* %dlt.pn.i, i32 1
  %.017.i = getelementptr inbounds i32* %bpl.pn.i, i32 1
  %37 = load i32* %.017.i, align 4, !tbaa !1
  %38 = load i32* %.06.i, align 4, !tbaa !1
  %39 = mul nsw i32 %38, %37
  %40 = add nsw i32 %39, %zl.05.i
  %41 = add nsw i32 %i.04.i, 1
  %exitcond.i = icmp eq i32 %41, 6
  br i1 %exitcond.i, label %filtez.exit, label %36

filtez.exit:                                      ; preds = %36
  %.lcssa6 = phi i32 [ %40, %36 ]
  %42 = add nsw i32 %32, %.lcssa7
  %43 = add nsw i32 %42, %.lcssa8
  %44 = sub nsw i32 %.lcssa8, %42
  %45 = ashr i32 %43, 15
  %46 = ashr i32 %44, 15
  %47 = ashr i32 %.lcssa6, 14
...
.preheader.i21:                                   ; preds = %.preheader.i21..preheader.i21_crit_edge, %quantl.exit
  %92 = phi i32 [ %.pre, %.preheader.i21..preheader.i21_crit_edge ], [ %33, %quantl.exit ]
...
.preheader1.i24:                                  ; preds = %.preheader1.i24..preheader1.i24_crit_edge, %quantl.exit
  %97 = phi i32 [ %.pre61, %.preheader1.i24..preheader1.i24_crit_edge ], [ %33, %quantl.exit ]
  %98 = phi i32 [ %.pre59, %.preheader1.i24..preheader1.i24_crit_edge ], [ %34, %quantl.exit ]
...
upzero.exit25:                                    ; preds = %.preheader1.i24, %.preheader.i21
  ...
  store i32 %34, i32* getelementptr inbounds ([6 x i32]* @delay_dltx, i32 0, i32 1), align 4, !tbaa !1
...
filtez.exit11:                                    ; preds = %140
  ...
  br i1 %185, label %.preheader.i, label %.preheader1.i

.preheader.i:                                     ; preds = %.preheader.i..preheader.i_crit_edge, %filtez.exit11
  %186 = phi i32 [ %.pre53, %.preheader.i..preheader.i_crit_edge ], [ %137, %filtez.exit11 ]
  %i.03.i = phi i32 [ %190, %.preheader.i..preheader.i_crit_edge ], [ 0, %filtez.exit11 ]
  %187 = getelementptr inbounds [6 x i32]* @delay_bph, i32 0, i32 %i.03.i
  %188 = mul nsw i32 %186, 255
  %189 = ashr i32 %188, 8
  store i32 %189, i32* %187, align 4, !tbaa !1
  %190 = add nsw i32 %i.03.i, 1
  %exitcond.i1 = icmp eq i32 %190, 6
...
.preheader.i..preheader.i_crit_edge:              ; preds = %.preheader.i
  %.phi.trans.insert52 = getelementptr inbounds [6 x i32]* @delay_bph, i32 0, i32 %190
  %.pre53 = load i32* %.phi.trans.insert52, align 4, !tbaa !1
  br label %.preheader.i

.preheader1.i:                                    ; preds = %.preheader1.i..preheader1.i_crit_edge, %filtez.exit11
  %191 = phi i32 [ %.pre57, %.preheader1.i..preheader1.i_crit_edge ], [ %137, %filtez.exit11 ]
  %192 = phi i32 [ %.pre55, %.preheader1.i..preheader1.i_crit_edge ], [ %138, %filtez.exit11 ]
  %i.14.i = phi i32 [ %201, %.preheader1.i..preheader1.i_crit_edge ], [ 0, %filtez.exit11 ]
  %193 = mul nsw i32 %192, %167
  %194 = ashr i32 %193, 31
  %195 = and i32 %194, -256
  %196 = or i32 %195, 128
  %197 = getelementptr inbounds [6 x i32]* @delay_bph, i32 0, i32 %i.14.i
  %198 = mul nsw i32 %191, 255
  %199 = ashr i32 %198, 8
  %200 = add nsw i32 %196, %199
  store i32 %200, i32* %197, align 4, !tbaa !1
  %201 = add nsw i32 %i.14.i, 1
  %exitcond5.i = icmp eq i32 %201, 6
...
.preheader1.i..preheader1.i_crit_edge:            ; preds = %.preheader1.i
  %.phi.trans.insert54 = getelementptr inbounds [6 x i32]* @delay_dhx, i32 0, i32 %201
  %.pre55 = load i32* %.phi.trans.insert54, align 4, !tbaa !1
  %.phi.trans.insert56 = getelementptr inbounds [6 x i32]* @delay_bph, i32 0, i32 %201
...
; <label>:49                                      ; preds = %decode.exit.i, %.preheader.i
  ...
  %dec_rh1.0 = phi i32 [ 0, %.preheader.i ], [ %212, %decode.exit.i ]
  ...
  %53 = load i32* getelementptr inbounds ([6 x i32]* @dec_del_bpl, i32 0, i32 0), align 4, !tbaa !1
  %54 = load i32* getelementptr inbounds ([6 x i32]* @dec_del_dltx, i32 0, i32 0), align 4, !tbaa !1
  %55 = mul nsw i32 %54, %53
  br label %56

; <label>:56                                      ; preds = %56, %49
  %bpl.pn.i.i.i = phi i32* [ getelementptr inbounds ([6 x i32]* @dec_del_bpl, i32 0, i32 0), %49 ], [ %.017.i.i.i, %56 ]
  %dlt.pn.i.i.i = phi i32* [ getelementptr inbounds ([6 x i32]* @dec_del_dltx, i32 0, i32 0), %49 ], [ %.06.i.i.i, %56 ]
  %zl.05.i.i.i = phi i32 [ %55, %49 ], [ %60, %56 ]
  %i.04.i.i.i = phi i32 [ 1, %49 ], [ %61, %56 ]
  %.06.i.i.i = getelementptr inbounds i32* %dlt.pn.i.i.i, i32 1
  %.017.i.i.i = getelementptr inbounds i32* %bpl.pn.i.i.i, i32 1
  %57 = load i32* %.017.i.i.i, align 4, !tbaa !1
  %58 = load i32* %.06.i.i.i, align 4, !tbaa !1
  %59 = mul nsw i32 %58, %57
  %60 = add nsw i32 %59, %zl.05.i.i.i
  %61 = add nsw i32 %i.04.i.i.i, 1
  %exitcond.i.i.i = icmp eq i32 %61, 6
  br i1 %exitcond.i.i.i, label %filtez.exit.i.i, label %56

filtez.exit.i.i:                                  ; preds = %56
  %.lcssa = phi i32 [ %60, %56 ]
  %62 = ashr i32 %52, 6
  %63 = ashr i32 %.lcssa, 14
  %64 = mul i32 %dec_al1.0, %dec_rlt1.0
  %65 = mul i32 %dec_al2.0, %dec_rlt2.0
  %tmp.i28.i.i = add i32 %65, %64
  %tmp1.i29.i.i = shl i32 %tmp.i28.i.i, 1
  %66 = ashr i32 %tmp1.i29.i.i, 15
...
.preheader.i21.i.i:                               ; preds = %.preheader.i21..preheader.i21_crit_edge.i.i, %filtez.exit.i.i
  %94 = phi i32 [ %.pre.i.i, %.preheader.i21..preheader.i21_crit_edge.i.i ], [ %53, %filtez.exit.i.i ]
...
.preheader1.i24.i.i:                              ; preds = %.preheader1.i24..preheader1.i24_crit_edge.i.i, %filtez.exit.i.i
  %99 = phi i32 [ %.pre65.i.i, %.preheader1.i24..preheader1.i24_crit_edge.i.i ], [ %53, %filtez.exit.i.i ]
  %100 = phi i32 [ %.pre63.i.i, %.preheader1.i24..preheader1.i24_crit_edge.i.i ], [ %54, %filtez.exit.i.i ]
...
upzero.exit25.i.i:                                ; preds = %.preheader1.i24.i.i, %.preheader.i21.i.i
  ...
  store i32 %54, i32* getelementptr inbounds ([6 x i32]* @dec_del_dltx, i32 0, i32 1), align 4, !tbaa !1
  ...
  %134 = sub nsw i32 0, %132
  %135 = load i32* getelementptr inbounds ([6 x i32]* @dec_del_bph, i32 0, i32 0), align 4, !tbaa !1
  %136 = load i32* getelementptr inbounds ([6 x i32]* @dec_del_dhx, i32 0, i32 0), align 4, !tbaa !1
  %137 = mul nsw i32 %136, %135
  br label %138

; <label>:138                                     ; preds = %138, %upzero.exit25.i.i
  %bpl.pn.i4.i.i = phi i32* [ getelementptr inbounds ([6 x i32]* @dec_del_bph, i32 0, i32 0), %upzero.exit25.i.i ], [ %.017.i9.i.i, %138 ]
  %dlt.pn.i5.i.i = phi i32* [ getelementptr inbounds ([6 x i32]* @dec_del_dhx, i32 0, i32 0), %upzero.exit25.i.i ], [ %.06.i8.i.i, %138 ]
  %zl.05.i6.i.i = phi i32 [ %137, %upzero.exit25.i.i ], [ %142, %138 ]
  %i.04.i7.i.i = phi i32 [ 1, %upzero.exit25.i.i ], [ %143, %138 ]
  %.06.i8.i.i = getelementptr inbounds i32* %dlt.pn.i5.i.i, i32 1
  %.017.i9.i.i = getelementptr inbounds i32* %bpl.pn.i4.i.i, i32 1
  %139 = load i32* %.017.i9.i.i, align 4, !tbaa !1
  %140 = load i32* %.06.i8.i.i, align 4, !tbaa !1
  %141 = mul nsw i32 %140, %139
  %142 = add nsw i32 %141, %zl.05.i6.i.i
  %143 = add nsw i32 %i.04.i7.i.i, 1
  %exitcond.i10.i.i = icmp eq i32 %143, 6
  br i1 %exitcond.i10.i.i, label %filtez.exit11.i.i, label %138

filtez.exit11.i.i:                                ; preds = %138
  %.lcssa6 = phi i32 [ %142, %138 ]
  %.apl1.0.i13.i.i = select i1 %133, i32 %132, i32 %apl1.0.i12.i.i
  %144 = icmp slt i32 %.apl1.0.i13.i.i, %134
  %apl1.2.i14.i.i = select i1 %144, i32 %134, i32 %.apl1.0.i13.i.i
  %145 = add nsw i32 %73, %67
  ...
  %151 = getelementptr inbounds [4 x i32]* @qq2_code2_table, i32 0, i32 %62
  %152 = load i32* %151, align 4, !tbaa !1
  %153 = mul nsw i32 %152, %dec_deth.0
  %154 = ashr i32 %153, 15
  %155 = mul nsw i32 %dec_nbh.0, 127
  %156 = ashr i32 %155, 7
  %157 = getelementptr inbounds [4 x i32]* @wh_code_table, i32 0, i32 %62
...
.preheader.i.i.i:                                 ; preds = %.preheader.i..preheader.i_crit_edge.i.i, %filtez.exit11.i.i
  %172 = phi i32 [ %.pre57.i.i, %.preheader.i..preheader.i_crit_edge.i.i ], [ %135, %filtez.exit11.i.i ]
...
.preheader1.i.i.i:                                ; preds = %.preheader1.i..preheader1.i_crit_edge.i.i, %filtez.exit11.i.i
  %177 = phi i32 [ %.pre61.i.i, %.preheader1.i..preheader1.i_crit_edge.i.i ], [ %135, %filtez.exit11.i.i ]
  %178 = phi i32 [ %.pre59.i.i, %.preheader1.i..preheader1.i_crit_edge.i.i ], [ %136, %filtez.exit11.i.i ]
...
upzero.exit.i.i:                                  ; preds = %.preheader1.i.i.i, %.preheader.i.i.i
  ...
  store i32 %136, i32* getelementptr inbounds ([6 x i32]* @dec_del_dhx, i32 0, i32 1), align 4, !tbaa !1
  ...
  %212 = add nsw i32 %154, %150
  %213 = sub nsw i32 %76, %212
  %214 = add nsw i32 %212, %76
  %215 = mul nsw i32 %213, 12
  %216 = mul nsw i32 %214, -44
  br label %217

; <label>:217                                     ; preds = %217, %upzero.exit.i.i
  %ad_ptr.045.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumd, i32 0, i32 0), %upzero.exit.i.i ], [ %224, %217 ]
  %ac_ptr.044.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumc, i32 0, i32 0), %upzero.exit.i.i ], [ %218, %217 ]
  %h_ptr.043.i.i = phi i32* [ getelementptr inbounds ([24 x i32]* @h, i32 0, i32 2), %upzero.exit.i.i ], [ %226, %217 ]
  %xa2.042.i.i = phi i32 [ %216, %upzero.exit.i.i ], [ %229, %217 ]
  %xa1.041.i.i = phi i32 [ %215, %upzero.exit.i.i ], [ %223, %217 ]
  %i.040.i.i = phi i32 [ 0, %upzero.exit.i.i ], [ %230, %217 ]
  %218 = getelementptr inbounds i32* %ac_ptr.044.i.i, i32 1
  %219 = load i32* %ac_ptr.044.i.i, align 4, !tbaa !1
  %220 = getelementptr inbounds i32* %h_ptr.043.i.i, i32 1
  %221 = load i32* %h_ptr.043.i.i, align 4, !tbaa !1
  %222 = mul nsw i32 %221, %219
  %223 = add nsw i32 %222, %xa1.041.i.i
  %224 = getelementptr inbounds i32* %ad_ptr.045.i.i, i32 1
  %225 = load i32* %ad_ptr.045.i.i, align 4, !tbaa !1
  %226 = getelementptr inbounds i32* %h_ptr.043.i.i, i32 2
  %227 = load i32* %220, align 4, !tbaa !1
  %228 = mul nsw i32 %227, %225
  %229 = add nsw i32 %228, %xa2.042.i.i
  %230 = add nsw i32 %i.040.i.i, 1
  %exitcond55.i.i = icmp eq i32 %230, 10
  br i1 %exitcond55.i.i, label %231, label %217

; <label>:231                                     ; preds = %217
  %.lcssa8 = phi i32 [ %229, %217 ]
  %.lcssa7 = phi i32 [ %223, %217 ]
  %232 = sub nsw i32 0, %210
  %233 = load i32* getelementptr inbounds ([11 x i32]* @accumc, i32 0, i32 10), align 4, !tbaa !1
  %234 = load i32* getelementptr inbounds ([11 x i32]* @accumd, i32 0, i32 10), align 4, !tbaa !1
  br label %235

; <label>:235                                     ; preds = %235, %231
  %ac_ptr1.039.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumc, i32 0, i32 9), %231 ], [ %ac_ptr1.0.i.i, %235 ]
  %ad_ptr1.038.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumd, i32 0, i32 9), %231 ], [ %ad_ptr1.0.i.i, %235 ]
  %ad_ptr.137.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumd, i32 0, i32 10), %231 ], [ %239, %235 ]
  %ac_ptr.136.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumc, i32 0, i32 10), %231 ], [ %237, %235 ]
  %i.135.i.i = phi i32 [ 0, %231 ], [ %240, %235 ]
  %236 = load i32* %ac_ptr1.039.i.i, align 4, !tbaa !1
  %237 = getelementptr inbounds i32* %ac_ptr.136.i.i, i32 -1
  store i32 %236, i32* %ac_ptr.136.i.i, align 4, !tbaa !1
  %238 = load i32* %ad_ptr1.038.i.i, align 4, !tbaa !1
  %239 = getelementptr inbounds i32* %ad_ptr.137.i.i, i32 -1
  store i32 %238, i32* %ad_ptr.137.i.i, align 4, !tbaa !1
  %240 = add nsw i32 %i.135.i.i, 1
  ...
  %exitcond.i1.i = icmp eq i32 %240, 10
  br i1 %exitcond.i1.i, label %decode.exit.i, label %235

decode.exit.i:                                    ; preds = %235
  %.apl1.0.i.i.i = select i1 %211, i32 %210, i32 %apl1.0.i.i.i
  %241 = mul nsw i32 %233, -44
  %242 = mul nsw i32 %234, 12
  %243 = icmp slt i32 %.apl1.0.i.i.i, %232
  %244 = add nsw i32 %241, %.lcssa7
  %245 = ashr i32 %244, 14
  %apl1.2.i.i.i = select i1 %243, i32 %232, i32 %.apl1.0.i.i.i
  %246 = add nsw i32 %242, %.lcssa8
  %247 = ashr i32 %246, 14
  store i32 %213, i32* getelementptr inbounds ([11 x i32]* @accumc, i32 0, i32 0), align 4, !tbaa !1
  store i32 %214, i32* getelementptr inbounds ([11 x i32]* @accumd, i32 0, i32 0), align 4, !tbaa !1
  %248 = getelementptr inbounds [100 x i32]* @result, i32 0, i32 %i.03.i
  store i32 %245, i32* %248, align 4, !tbaa !1
  %249 = or i32 %i.03.i, 1
