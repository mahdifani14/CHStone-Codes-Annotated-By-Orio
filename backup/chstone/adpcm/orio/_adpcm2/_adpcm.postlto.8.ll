...
; <label>:31                                      ; preds = %27
  ...
  %35 = load i32* getelementptr inbounds ([6 x i32]* @delay_bpl, i32 0, i32 0), align 4, !tbaa !1
  %36 = load i32* getelementptr inbounds ([6 x i32]* @delay_dltx, i32 0, i32 0), align 4, !tbaa !1
  %37 = mul nsw i32 %36, %35
  br label %38

; <label>:38                                      ; preds = %38, %31
  %bpl.pn.i = phi i32* [ getelementptr inbounds ([6 x i32]* @delay_bpl, i32 0, i32 0), %31 ], [ %.017.i, %38 ]
  %dlt.pn.i = phi i32* [ getelementptr inbounds ([6 x i32]* @delay_dltx, i32 0, i32 0), %31 ], [ %.06.i, %38 ]
  %zl.05.i = phi i32 [ %37, %31 ], [ %42, %38 ]
  %i.04.i = phi i32 [ 1, %31 ], [ %43, %38 ]
  %.06.i = getelementptr inbounds i32* %dlt.pn.i, i32 1
  %.017.i = getelementptr inbounds i32* %bpl.pn.i, i32 1
  %39 = load i32* %.017.i, align 4, !tbaa !1
  %40 = load i32* %.06.i, align 4, !tbaa !1
  %41 = mul nsw i32 %40, %39
  %42 = add nsw i32 %41, %zl.05.i
  %43 = add nsw i32 %i.04.i, 1
  %exitcond.i = icmp eq i32 %43, 6
  br i1 %exitcond.i, label %filtez.exit, label %38

filtez.exit:                                      ; preds = %38
  %.lcssa3 = phi i32 [ %42, %38 ]
  %44 = sub nsw i32 %.lcssa5, %33
  %45 = ashr i32 %34, 15
  %46 = ashr i32 %44, 15
...
.preheader.i21:                                   ; preds = %.preheader.i21..preheader.i21_crit_edge, %quantl.exit
  %92 = phi i32 [ %.pre, %.preheader.i21..preheader.i21_crit_edge ], [ %35, %quantl.exit ]
...
.preheader1.i24:                                  ; preds = %.preheader1.i24..preheader1.i24_crit_edge, %quantl.exit
  %97 = phi i32 [ %.pre61, %.preheader1.i24..preheader1.i24_crit_edge ], [ %35, %quantl.exit ]
  %98 = phi i32 [ %.pre59, %.preheader1.i24..preheader1.i24_crit_edge ], [ %36, %quantl.exit ]
...
upzero.exit25:                                    ; preds = %.preheader1.i24, %.preheader.i21
  ...
  store i32 %36, i32* getelementptr inbounds ([6 x i32]* @delay_dltx, i32 0, i32 1), align 4, !tbaa !1
...
; <label>:49                                      ; preds = %decode.exit.i, %.preheader.i
  ...
  %dec_rh1.0 = phi i32 [ 0, %.preheader.i ], [ %213, %decode.exit.i ]
...
upzero.exit.i.i:                                  ; preds = %.preheader1.i.i.i, %.preheader.i.i.i
  ...
  %213 = add nsw i32 %154, %150
  %214 = sub nsw i32 %76, %213
  %215 = add nsw i32 %213, %76
  %216 = mul nsw i32 %214, 12
  %217 = mul nsw i32 %215, -44
  br label %218

; <label>:218                                     ; preds = %218, %upzero.exit.i.i
  %ad_ptr.045.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumd, i32 0, i32 0), %upzero.exit.i.i ], [ %225, %218 ]
  %ac_ptr.044.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumc, i32 0, i32 0), %upzero.exit.i.i ], [ %219, %218 ]
  %h_ptr.043.i.i = phi i32* [ getelementptr inbounds ([24 x i32]* @h, i32 0, i32 2), %upzero.exit.i.i ], [ %227, %218 ]
  %xa2.042.i.i = phi i32 [ %217, %upzero.exit.i.i ], [ %230, %218 ]
  %xa1.041.i.i = phi i32 [ %216, %upzero.exit.i.i ], [ %224, %218 ]
  %i.040.i.i = phi i32 [ 0, %upzero.exit.i.i ], [ %231, %218 ]
  %219 = getelementptr inbounds i32* %ac_ptr.044.i.i, i32 1
  %220 = load i32* %ac_ptr.044.i.i, align 4, !tbaa !1
  %221 = getelementptr inbounds i32* %h_ptr.043.i.i, i32 1
  %222 = load i32* %h_ptr.043.i.i, align 4, !tbaa !1
  %223 = mul nsw i32 %222, %220
  %224 = add nsw i32 %223, %xa1.041.i.i
  %225 = getelementptr inbounds i32* %ad_ptr.045.i.i, i32 1
  %226 = load i32* %ad_ptr.045.i.i, align 4, !tbaa !1
  %227 = getelementptr inbounds i32* %h_ptr.043.i.i, i32 2
  %228 = load i32* %221, align 4, !tbaa !1
  %229 = mul nsw i32 %228, %226
  %230 = add nsw i32 %229, %xa2.042.i.i
  %231 = add nsw i32 %i.040.i.i, 1
  %exitcond55.i.i = icmp eq i32 %231, 10
  br i1 %exitcond55.i.i, label %232, label %218

; <label>:232                                     ; preds = %218
  %.lcssa5 = phi i32 [ %230, %218 ]
  %.lcssa4 = phi i32 [ %224, %218 ]
  ...
  %234 = mul nsw i32 %233, -44
  %235 = load i32* getelementptr inbounds ([11 x i32]* @accumd, i32 0, i32 10), align 4, !tbaa !1
  %236 = mul nsw i32 %235, 12
  br label %237

; <label>:237                                     ; preds = %237, %232
  %ac_ptr1.039.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumc, i32 0, i32 9), %232 ], [ %ac_ptr1.0.i.i, %237 ]
  %ad_ptr1.038.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumd, i32 0, i32 9), %232 ], [ %ad_ptr1.0.i.i, %237 ]
  %ad_ptr.137.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumd, i32 0, i32 10), %232 ], [ %241, %237 ]
  %ac_ptr.136.i.i = phi i32* [ getelementptr inbounds ([11 x i32]* @accumc, i32 0, i32 10), %232 ], [ %239, %237 ]
  %i.135.i.i = phi i32 [ 0, %232 ], [ %242, %237 ]
  %238 = load i32* %ac_ptr1.039.i.i, align 4, !tbaa !1
  %239 = getelementptr inbounds i32* %ac_ptr.136.i.i, i32 -1
  store i32 %238, i32* %ac_ptr.136.i.i, align 4, !tbaa !1
  %240 = load i32* %ad_ptr1.038.i.i, align 4, !tbaa !1
  %241 = getelementptr inbounds i32* %ad_ptr.137.i.i, i32 -1
  store i32 %240, i32* %ad_ptr.137.i.i, align 4, !tbaa !1
  %242 = add nsw i32 %i.135.i.i, 1
  ...
  %exitcond.i1.i = icmp eq i32 %242, 10
  br i1 %exitcond.i1.i, label %decode.exit.i, label %237

decode.exit.i:                                    ; preds = %237
  %243 = icmp slt i32 %.apl1.0.i.i.i, %212
  %244 = add nsw i32 %234, %.lcssa4
  %245 = ashr i32 %244, 14
  %apl1.2.i.i.i = select i1 %243, i32 %212, i32 %.apl1.0.i.i.i
  %246 = add nsw i32 %236, %.lcssa5
  %247 = ashr i32 %246, 14
  store i32 %214, i32* getelementptr inbounds ([11 x i32]* @accumc, i32 0, i32 0), align 4, !tbaa !1
  store i32 %215, i32* getelementptr inbounds ([11 x i32]* @accumd, i32 0, i32 0), align 4, !tbaa !1
