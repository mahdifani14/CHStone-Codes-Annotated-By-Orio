...
quantl.exit.i:                                    ; preds = %114, %112
  ...
  tail call fastcc void @upzero(i32 %125, i32* getelementptr inbounds ([6 x i32]* @delay_dltx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @delay_bpl, i32 0, i32 0))
  ...
  tail call fastcc void @upzero(i32 %207, i32* getelementptr inbounds ([6 x i32]* @delay_dhx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @delay_bph, i32 0, i32 0))
...
.preheader.i:                                     ; preds = %.preheader.i, %.preheader.i.preheader
  ...
  tail call fastcc void @upzero(i32 %293, i32* getelementptr inbounds ([6 x i32]* @dec_del_dltx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @dec_del_bpl, i32 0, i32 0))
  ...
  tail call fastcc void @upzero(i32 %368, i32* getelementptr inbounds ([6 x i32]* @dec_del_dhx, i32 0, i32 0), i32* getelementptr inbounds ([6 x i32]* @dec_del_bph, i32 0, i32 0))
...
; <label>:478                                     ; preds = %.preheader
  ...
  %479 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %.main_result.2.lcssa)
  %480 = icmp eq i32 %.main_result.2.lcssa, 150
  br i1 %480, label %481, label %483

; <label>:481                                     ; preds = %478
  %482 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0))
  br label %485

; <label>:483                                     ; preds = %478
  %484 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0))
  br label %485
