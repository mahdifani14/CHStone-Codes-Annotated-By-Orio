...
; <label>:1                                       ; preds = %dfsin.exit, %0
  ...
  %4 = tail call fastcc i64 @float64_mul(i64 %3, i64 %3) #2
...
; <label>:6                                       ; preds = %float64_ge.exit.i, %1
  ...
  %7 = tail call fastcc i64 @float64_mul(i64 %diff.0.i, i64 %5) #2
...
dfsin.exit:                                       ; preds = %float64_ge.exit.i, %568
  %.0.i3.i8 = phi i64 [ %.0.i3.i.lcssa, %568 ], [ %.0.i3.i, %float64_ge.exit.i ]
  %574 = getelementptr inbounds [36 x i64]* @test_out, i32 0, i32 %i.01
  %575 = load i64* %574, align 8, !tbaa !5
  %576 = icmp eq i64 %.0.i3.i8, %575
  %577 = zext i1 %576 to i32
  %578 = add nsw i32 %577, %main_result.02
  %579 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([47 x i8]* @.str, i32 0, i32 0), i64 %3, i64 %575, i64 %.0.i3.i8) #2
  %580 = add nsw i32 %i.01, 1
  %exitcond = icmp eq i32 %580, 36
  br i1 %exitcond, label %581, label %1

; <label>:581                                     ; preds = %dfsin.exit
  %.lcssa9 = phi i32 [ %578, %dfsin.exit ]
  %582 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %.lcssa9) #2
  %583 = icmp eq i32 %.lcssa9, 36
  br i1 %583, label %584, label %586

; <label>:584                                     ; preds = %581
  %585 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #2
  br label %588

; <label>:586                                     ; preds = %581
  %587 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str3, i32 0, i32 0)) #2
  br label %588
