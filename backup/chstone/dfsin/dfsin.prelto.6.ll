...
; <label>:126                                     ; preds = %normalizeFloat64Subnormal.exit, %100
  ...
  %.18 = add i32 %129, %.18.v
  %157 = tail call fastcc i64 @roundAndPackFloat64(i32 %9, i32 %.18, i64 %.) #2
  br label %158
...
; <label>:1                                       ; preds = %dfsin.exit, %0
  %main_result.02 = phi i32 [ 0, %0 ], [ %578, %dfsin.exit ]
  %i.01 = phi i32 [ 0, %0 ], [ %580, %dfsin.exit ]
  %2 = getelementptr inbounds [36 x i64]* @test_in, i32 0, i32 %i.01
  %3 = load i64* %2, align 8, !tbaa !5
  %4 = tail call fastcc i64 @float64_mul(i64 %3, i64 %3) #3
  %5 = xor i64 %4, -9223372036854775808
  br label %6

; <label>:6                                       ; preds = %float64_ge.exit.i, %1
  %diff.0.i = phi i64 [ %3, %1 ], [ %.0.i1.i, %float64_ge.exit.i ]
  %app.0.i = phi i64 [ %3, %1 ], [ %.0.i3.i, %float64_ge.exit.i ]
  %inc.0.i = phi i32 [ 1, %1 ], [ %572, %float64_ge.exit.i ]
  %7 = tail call fastcc i64 @float64_mul(i64 %diff.0.i, i64 %5) #3
  %8 = shl nsw i32 %inc.0.i, 1
  %9 = or i32 %8, 1
  %10 = mul nsw i32 %9, %8
  %11 = icmp eq i32 %10, 0
...
int32_to_float64.exit.i:                          ; preds = %countLeadingZeros32.exit.i.i, %6
  %.0.i.i = phi i64 [ %36, %countLeadingZeros32.exit.i.i ], [ 0, %6 ]
  %37 = and i64 %7, 4503599627370495
  %38 = lshr i64 %7, 52
...
propagateFloat64NaN.exit23.i.i:                   ; preds = %.thread.i19.i.i, %float64_is_signaling_nan.exit.i18.i.i
  ...
  %.mux2.v.i21.i.i = select i1 %.sink.i20.i.i, i64 %.0.i.i, i64 %7
...
propagateFloat64NaN.exit16.i.i:                   ; preds = %.thread.i12.i.i, %float64_is_signaling_nan.exit.i11.i.i
  ...
  %.mux2.v.i14.i.i = select i1 %.sink.i13.i.i, i64 %.0.i.i, i64 %7
...
propagateFloat64NaN.exit.i.i:                     ; preds = %.thread.i.i.i, %float64_is_signaling_nan.exit.i.i.i
  ...
  %.mux2.v.i.i.i = select i1 %.sink.i.i.i, i64 %.0.i.i, i64 %7
...
; <label>:157                                     ; preds = %153
  ...
  %159 = lshr i64 %37, 32
  %a.sink.i.i.i.i = select i1 %158, i64 %7, i64 %159
...
; <label>:213                                     ; preds = %213, %.lr.ph.i.i.i
  ...
  %overflow_intrinsic_carry = trunc i65 %overflow_intrinsic3 to i1
  %217 = add i64 %215, %193
  %218 = zext i1 %overflow_intrinsic_carry to i64
  %219 = add i64 %217, %218
  %220 = icmp slt i64 %219, 0
  br i1 %220, label %213, label %._crit_edge.i.i.i

._crit_edge.i.i.i:                                ; preds = %213, %199
  %z.0.lcssa.i.i.i = phi i64 [ %200, %199 ], [ %216, %213 ]
  %.lcssa4.i.i.i = phi i64 [ %207, %199 ], [ %overflow_intrinsic_sum, %213 ]
  %.lcssa.i.i.i = phi i64 [ %210, %199 ], [ %219, %213 ]
...
; <label>:231                                     ; preds = %estimateDiv128To64.exit.i.i
  ...
  %overflow_intrinsic8 = lshr i65 %overflow_intrinsic6, 64
  %overflow_intrinsic_carry9 = trunc i65 %overflow_intrinsic8 to i1
  %238 = zext i1 %overflow_intrinsic_carry9 to i64
  ...
  %.neg26.i.i = sext i1 %overflow_intrinsic_carry15 to i64
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %231
  %zSig.034.i.i = phi i64 [ %250, %.lr.ph.i.i ], [ %228, %231 ]
  %248 = phi i64 [ %overflow_intrinsic_sum19, %.lr.ph.i.i ], [ %243, %231 ]
  %249 = phi i64 [ %252, %.lr.ph.i.i ], [ %246, %231 ]
  ...
  %251 = zext i1 %overflow_intrinsic_carry21 to i64
  %252 = add i64 %251, %249
  %253 = icmp slt i64 %252, 0
  br i1 %253, label %.lr.ph.i.i, label %._crit_edge.i.i

._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i, %231
  %zSig.0.lcssa.i.i = phi i64 [ %228, %231 ], [ %250, %.lr.ph.i.i ]
  %.lcssa.i.i = phi i64 [ %243, %231 ], [ %overflow_intrinsic_sum19, %.lr.ph.i.i ]
...
estimateDiv128To64.exit.thread.i.i:               ; preds = %._crit_edge.i.i, %estimateDiv128To64.exit.i.i, %189
  ...
  %257 = tail call fastcc i64 @roundAndPackFloat64(i32 %45, i32 %zExp.0.i.i, i64 %zSig.1.i.i) #3
  br label %float64_div.exit.i
...
; <label>:402                                     ; preds = %shift64RightJamming.exit9.i.i.i, %392
  ...
  %403 = tail call fastcc i64 @roundAndPackFloat64(i32 %259, i32 %zExp.1.i.i.i, i64 %zSig.0.i12.i.i) #3
  br label %float64_add.exit.i
...
normalizeRoundAndPackFloat64.exit.i.i.i:          ; preds = %551, %544
  ...
  %563 = tail call fastcc i64 @roundAndPackFloat64(i32 %.0.i.i.i, i32 %560, i64 %562) #3
  br label %float64_add.exit.i
...
; <label>:568                                     ; preds = %float64_add.exit.i
  %.0.i3.i.lcssa = phi i64 [ %.0.i3.i, %float64_add.exit.i ]
...
float64_ge.exit.i:                                ; preds = %float64_add.exit.i
  ...
  %572 = add nsw i32 %inc.0.i, 1
  %573 = icmp ugt i64 %571, 4532020583610935536
  br i1 %573, label %6, label %dfsin.exit

dfsin.exit:                                       ; preds = %float64_ge.exit.i, %568
  %.0.i3.i13 = phi i64 [ %.0.i3.i.lcssa, %568 ], [ %.0.i3.i, %float64_ge.exit.i ]
  %574 = getelementptr inbounds [36 x i64]* @test_out, i32 0, i32 %i.01
  %575 = load i64* %574, align 8, !tbaa !5
  %576 = icmp eq i64 %.0.i3.i13, %575
  %577 = zext i1 %576 to i32
  %578 = add nsw i32 %577, %main_result.02
  %579 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([47 x i8]* @.str, i32 0, i32 0), i64 %3, i64 %575, i64 %.0.i3.i13) #3
  %580 = add nsw i32 %i.01, 1
  %exitcond = icmp eq i32 %580, 36
  br i1 %exitcond, label %581, label %1

; <label>:581                                     ; preds = %dfsin.exit
  %.lcssa14 = phi i32 [ %578, %dfsin.exit ]
  %582 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %.lcssa14) #3
  %583 = icmp eq i32 %.lcssa14, 36
  br i1 %583, label %584, label %586

; <label>:584                                     ; preds = %581
  %585 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #3
  br label %588

; <label>:586                                     ; preds = %581
  %587 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str3, i32 0, i32 0)) #3
  br label %588

; <label>:588                                     ; preds = %586, %584
  ret i32 %.lcssa14
}
