...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %194
  %zSig.037.i = phi i64 [ %213, %.lr.ph.i ], [ %191, %194 ]
  %211 = phi i64 [ %overflow_intrinsic_sum19, %.lr.ph.i ], [ %206, %194 ]
  %212 = phi i64 [ %215, %.lr.ph.i ], [ %209, %194 ]
...
float64_div.exit:                                 ; preds = %.thread6.i.i, %230, %118, %90, %88, %80, %float64_is_signaling_nan.exit.i.i, %57, %55, %float64_is_signaling_nan.exit.i13.i, %float64_is_signaling_nan.exit.i20.i
  ...
  %275 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([65 x i8]* @.str, i32 0, i32 0), i64 %3, i64 %5, i64 %271, i64 %.0.i) #2
  %276 = add nsw i32 %i.01, 1
  %exitcond = icmp eq i32 %276, 22
  br i1 %exitcond, label %277, label %1

; <label>:277                                     ; preds = %float64_div.exit
  %.lcssa17 = phi i32 [ %274, %float64_div.exit ]
  %278 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %.lcssa17) #2
  %279 = icmp eq i32 %.lcssa17, 22
  br i1 %279, label %280, label %282

; <label>:280                                     ; preds = %277
  %281 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #2
  br label %284

; <label>:282                                     ; preds = %277
  %283 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str3, i32 0, i32 0)) #2
  br label %284
