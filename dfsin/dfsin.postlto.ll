...
dfsin.exit:                                       ; preds = %float64_ge.exit.i, %568
  %.0.i3.i9 = phi i64 [ %.0.i3.i.lcssa, %568 ], [ %.0.i3.i, %float64_ge.exit.i ]
  %574 = getelementptr inbounds [36 x i64]* @test_out, i32 0, i32 %i.01
  %575 = load i64* %574, align 8, !tbaa !5
  %576 = icmp eq i64 %.0.i3.i9, %575
  %577 = zext i1 %576 to i32
  %578 = add nsw i32 %577, %main_result.02
  %579 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([47 x i8]* @.str, i32 0, i32 0), i64 %3, i64 %575, i64 %.0.i3.i9) #2
  %580 = add nsw i32 %i.01, 1
  %exitcond = icmp eq i32 %580, 36
  br i1 %exitcond, label %581, label %1

; <label>:581                                     ; preds = %dfsin.exit
  %.lcssa10 = phi i32 [ %578, %dfsin.exit ]
  %582 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %.lcssa10) #2
  %583 = icmp eq i32 %.lcssa10, 36
