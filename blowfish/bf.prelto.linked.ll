...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  %p2.03 = phi i32* [ %5, %.lr.ph ], [ %s2, %.lr.ph.preheader ]
  %p1.02 = phi i32* [ %4, %.lr.ph ], [ %s1, %.lr.ph.preheader ]
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %0
  %p2.03.i = phi i32* [ %4, %.lr.ph.i ], [ getelementptr inbounds ([18 x i32]* @bf_init_P, i32 0, i32 0), %0 ]
  %p1.02.i = phi i32* [ %3, %.lr.ph.i ], [ getelementptr inbounds ([18 x i32]* @key_P, i32 0, i32 0), %0 ]
  %.01.i = phi i32 [ %1, %.lr.ph.i ], [ 18, %0 ]
  %1 = add nsw i32 %.01.i, -1
  %2 = load i32* %p2.03.i, align 4, !tbaa !1
  store i32 %2, i32* %p1.02.i, align 4, !tbaa !1
  %3 = getelementptr inbounds i32* %p1.02.i, i32 1
  %4 = getelementptr inbounds i32* %p2.03.i, i32 1
  %5 = icmp sgt i32 %1, 0
  br i1 %5, label %.lr.ph.i, label %.lr.ph.i5.preheader

.lr.ph.i5.preheader:                              ; preds = %.lr.ph.i
  br label %.lr.ph.i5

.lr.ph.i5:                                        ; preds = %.lr.ph.i5, %.lr.ph.i5.preheader
  %p2.03.i2 = phi i32* [ %9, %.lr.ph.i5 ], [ getelementptr inbounds ([1024 x i32]* @bf_init_S, i32 0, i32 0), %.lr.ph.i5.preheader ]
  %p1.02.i3 = phi i32* [ %8, %.lr.ph.i5 ], [ getelementptr inbounds ([1024 x i32]* @key_S, i32 0, i32 0), %.lr.ph.i5.preheader ]
  %.01.i4 = phi i32 [ %6, %.lr.ph.i5 ], [ 1024, %.lr.ph.i5.preheader ]
  %6 = add nsw i32 %.01.i4, -1
  %7 = load i32* %p2.03.i2, align 4, !tbaa !1
  store i32 %7, i32* %p1.02.i3, align 4, !tbaa !1
  %8 = getelementptr inbounds i32* %p1.02.i3, i32 1
  %9 = getelementptr inbounds i32* %p2.03.i2, i32 1
  %10 = icmp sgt i32 %6, 0
  br i1 %10, label %.lr.ph.i5, label %memcpy.exit6

memcpy.exit6:                                     ; preds = %.lr.ph.i5
  %11 = icmp sgt i32 %len, 72
  %.len = select i1 %11, i32 72, i32 %len
  %12 = getelementptr inbounds i8* %data, i32 %.len
  br label %13

; <label>:13                                      ; preds = %13, %memcpy.exit6
  %d.010 = phi i8* [ %data, %memcpy.exit6 ], [ %d.4, %13 ]
  %i.09 = phi i32 [ 0, %memcpy.exit6 ], [ %39, %13 ]
  %14 = getelementptr inbounds i8* %d.010, i32 1
  %15 = load i8* %d.010, align 1, !tbaa !5
  %16 = zext i8 %15 to i32
  %17 = icmp ult i8* %14, %12
  %.data = select i1 %17, i8* %14, i8* %data
  %18 = shl nuw nsw i32 %16, 8
  %19 = getelementptr inbounds i8* %.data, i32 1
  %20 = load i8* %.data, align 1, !tbaa !5
  %21 = zext i8 %20 to i32
  %22 = or i32 %18, %21
  %23 = icmp ult i8* %19, %12
  %d.2 = select i1 %23, i8* %19, i8* %data
  %24 = shl nuw nsw i32 %22, 8
  %25 = getelementptr inbounds i8* %d.2, i32 1
  %26 = load i8* %d.2, align 1, !tbaa !5
  %27 = zext i8 %26 to i32
  %28 = or i32 %24, %27
  %29 = icmp ult i8* %25, %12
  %.data1 = select i1 %29, i8* %25, i8* %data
  %30 = shl nuw i32 %28, 8
  %31 = getelementptr inbounds i8* %.data1, i32 1
  %32 = load i8* %.data1, align 1, !tbaa !5
  %33 = zext i8 %32 to i32
  %34 = or i32 %30, %33
  %35 = icmp ult i8* %31, %12
  %d.4 = select i1 %35, i8* %31, i8* %data
  %36 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %i.09
  %37 = load i32* %36, align 4, !tbaa !1
  %38 = xor i32 %34, %37
  store i32 %38, i32* %36, align 4, !tbaa !1
  %39 = add nsw i32 %i.09, 1
  %exitcond = icmp eq i32 %39, 18
  br i1 %exitcond, label %40, label %13

; <label>:40                                      ; preds = %13
  %41 = getelementptr inbounds [2 x i32]* %in, i32 0, i32 0
  store i32 0, i32* %41, align 4, !tbaa !1
  %42 = getelementptr inbounds [2 x i32]* %in, i32 0, i32 1
  store i32 0, i32* %42, align 4, !tbaa !1
  br label %43

; <label>:43                                      ; preds = %43, %40
  %i.18 = phi i32 [ 0, %40 ], [ %49, %43 ]
  call void @BF_encrypt(i32* %41, i32 1) #3
  %44 = load i32* %41, align 4, !tbaa !1
  %45 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %i.18
  store i32 %44, i32* %45, align 4, !tbaa !1
  %46 = load i32* %42, align 4, !tbaa !1
  %47 = or i32 %i.18, 1
  %48 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %47
  store i32 %46, i32* %48, align 4, !tbaa !1
  %49 = add nsw i32 %i.18, 2
  %50 = icmp slt i32 %49, 18
  br i1 %50, label %43, label %.preheader.preheader

.preheader.preheader:                             ; preds = %43
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  %i.27 = phi i32 [ %56, %.preheader ], [ 0, %.preheader.preheader ]
  call void @BF_encrypt(i32* %41, i32 1) #3
  %51 = load i32* %41, align 4, !tbaa !1
  %52 = getelementptr inbounds [1024 x i32]* @key_S, i32 0, i32 %i.27
  store i32 %51, i32* %52, align 4, !tbaa !1
  %53 = load i32* %42, align 4, !tbaa !1
  %54 = or i32 %i.27, 1
  %55 = getelementptr inbounds [1024 x i32]* @key_S, i32 0, i32 %54
  store i32 %53, i32* %55, align 4, !tbaa !1
  %56 = add nsw i32 %i.27, 2
...
; <label>:70                                      ; preds = %25, %22
  ...
  %78 = and i32 %77, 7
  %79 = icmp eq i32 %23, 0
  br i1 %79, label %.loopexit.loopexit17, label %22
...
; <label>:128                                     ; preds = %83, %80
  ...
  br i1 %137, label %.loopexit.loopexit, label %80

.loopexit.loopexit:                               ; preds = %128
  %.lcssa = phi i32 [ %136, %128 ]
  br label %.loopexit

.loopexit.loopexit17:                             ; preds = %70
  %.lcssa18 = phi i32 [ %78, %70 ]
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit17, %.loopexit.loopexit, %.preheader, %.preheader3
  %n.2 = phi i32 [ %1, %.preheader ], [ %1, %.preheader3 ], [ %.lcssa, %.loopexit.loopexit ], [ %.lcssa18, %.loopexit.loopexit17 ]
...
; <label>:3                                       ; preds = %3, %0
  %i.015 = phi i32 [ 0, %0 ], [ %6, %3 ]
  %4 = getelementptr inbounds [8 x i8]* %ukey, i32 0, i32 %i.015
  store i8 0, i8* %4, align 1, !tbaa !5
  %5 = getelementptr inbounds [8 x i8]* %ivec, i32 0, i32 %i.015
  store i8 0, i8* %5, align 1, !tbaa !5
  %6 = add nsw i32 %i.015, 1
  %exitcond20 = icmp eq i32 %6, 8
  br i1 %exitcond20, label %7, label %3
...
..loopexit_crit_edge:                             ; preds = %.lr.ph9
  %.lcssa = phi i32 [ %31, %.lr.ph9 ]
  %10 = sub i32 %l.013, %umax
  br label %.loopexit

.loopexit:                                        ; preds = %.critedge, %..loopexit_crit_edge
  %check.1.lcssa = phi i32 [ %.lcssa, %..loopexit_crit_edge ], [ %check.014, %.critedge ]
  %l.1.lcssa = phi i32 [ %10, %..loopexit_crit_edge ], [ %l.013, %.critedge ]
  %11 = icmp slt i32 %22, 5200
  br i1 %11, label %.preheader, label %.loopexit23.loopexit

.preheader:                                       ; preds = %.loopexit, %7
  %check.014 = phi i32 [ 0, %7 ], [ %check.1.lcssa, %.loopexit ]
  %l.013 = phi i32 [ 0, %7 ], [ %l.1.lcssa, %.loopexit ]
  %k.012 = phi i32 [ 0, %7 ], [ %22, %.loopexit ]
  %12 = icmp slt i32 %k.012, 5200
  br i1 %12, label %.lr.ph, label %.loopexit.thread

.loopexit.thread:                                 ; preds = %.preheader
  %check.014.lcssa = phi i32 [ %check.014, %.preheader ]
  call void @BF_cfb64_encrypt(i8* %1, i8* %2, i32 0, i8* %9, i32* %num, i32 1) #3
  br label %.loopexit23

.lr.ph:                                           ; preds = %.preheader
  %13 = add i32 %k.012, -5200
  %14 = icmp ugt i32 %13, -40
  %umax = select i1 %14, i32 %13, i32 -40
  %15 = sub i32 0, %umax
  br label %16

; <label>:16                                      ; preds = %16, %.lr.ph
  %i.24 = phi i32 [ 0, %.lr.ph ], [ %20, %16 ]
  %k.13 = phi i32 [ %k.012, %.lr.ph ], [ %17, %16 ]
  %17 = add nsw i32 %k.13, 1
  %18 = getelementptr inbounds [5200 x i8]* @in_key, i32 0, i32 %k.13
  %19 = load i8* %18, align 1, !tbaa !5
  %20 = add nsw i32 %i.24, 1
  %21 = getelementptr inbounds [40 x i8]* %indata, i32 0, i32 %i.24
  store i8 %19, i8* %21, align 1, !tbaa !5
  %exitcond = icmp eq i32 %20, %15
  br i1 %exitcond, label %.critedge, label %16

.critedge:                                        ; preds = %16
  %22 = sub i32 %k.012, %umax
  call void @BF_cfb64_encrypt(i8* %1, i8* %2, i32 %15, i8* %9, i32* %num, i32 1) #3
  %23 = icmp sgt i32 %15, 0
  br i1 %23, label %.lr.ph9.preheader, label %.loopexit

.lr.ph9.preheader:                                ; preds = %.critedge
  br label %.lr.ph9

.lr.ph9:                                          ; preds = %.lr.ph9, %.lr.ph9.preheader
  %check.18 = phi i32 [ %31, %.lr.ph9 ], [ %check.014, %.lr.ph9.preheader ]
  %j.07 = phi i32 [ %32, %.lr.ph9 ], [ 0, %.lr.ph9.preheader ]
  %l.16 = phi i32 [ %26, %.lr.ph9 ], [ %l.013, %.lr.ph9.preheader ]
  %24 = getelementptr inbounds [40 x i8]* %outdata, i32 0, i32 %j.07
  %25 = load i8* %24, align 1, !tbaa !5
  %26 = add nsw i32 %l.16, 1
  %27 = getelementptr inbounds [5200 x i8]* @out_key, i32 0, i32 %l.16
  %28 = load i8* %27, align 1, !tbaa !5
  %29 = icmp eq i8 %25, %28
  %30 = zext i1 %29 to i32
  %31 = add nsw i32 %30, %check.18
  %32 = add nsw i32 %j.07, 1
  %exitcond19 = icmp eq i32 %32, %15
  br i1 %exitcond19, label %..loopexit_crit_edge, label %.lr.ph9

.loopexit23.loopexit:                             ; preds = %.loopexit
  %check.1.lcssa.lcssa = phi i32 [ %check.1.lcssa, %.loopexit ]
  br label %.loopexit23

.loopexit23:                                      ; preds = %.loopexit23.loopexit, %.loopexit.thread
  %check.1.lcssa22 = phi i32 [ %check.014.lcssa, %.loopexit.thread ], [ %check.1.lcssa.lcssa, %.loopexit23.loopexit ]
  call void @llvm.lifetime.end(i64 40, i8* %2) #1
  call void @llvm.lifetime.end(i64 40, i8* %1) #1
  ret i32 %check.1.lcssa22
}
...
define i32 @main() #0 {
  ...
  %2 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %1) #4
  %3 = icmp eq i32 %1, 5200
  br i1 %3, label %4, label %6

; <label>:4                                       ; preds = %0
  %5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #4
  br label %8

; <label>:6                                       ; preds = %0
  %7 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #4
  br label %8
