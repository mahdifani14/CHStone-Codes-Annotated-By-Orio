...
define i32 @main() #0 {
  ...
  %2 = bitcast [8 x i8]* %ivec.i to i8*
  %3 = getelementptr inbounds [40 x i8]* %indata.i, i32 0, i32 0
  %4 = getelementptr inbounds [40 x i8]* %outdata.i, i32 0, i32 0
  br label %5

; <label>:5                                       ; preds = %5, %0
  %i.015.i = phi i32 [ 0, %0 ], [ %8, %5 ]
  %6 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 %i.015.i
  store i8 0, i8* %6, align 1, !tbaa !5
  %7 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 %i.015.i
  store i8 0, i8* %7, align 1, !tbaa !5
  %8 = add nsw i32 %i.015.i, 1
  %exitcond20.i = icmp eq i32 %8, 8
  br i1 %exitcond20.i, label %9, label %5

; <label>:9                                       ; preds = %5
  %10 = bitcast [2 x i32]* %in.i.i to i8*
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i, %9
  %p2.03.i.i.i = phi i32* [ %14, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @bf_init_P, i32 0, i32 0), %9 ]
  %p1.02.i.i.i = phi i32* [ %13, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @key_P, i32 0, i32 0), %9 ]
  %.01.i.i.i = phi i32 [ %11, %.lr.ph.i.i.i ], [ 18, %9 ]
  %11 = add nsw i32 %.01.i.i.i, -1
  %12 = load i32* %p2.03.i.i.i, align 4, !tbaa !1
  store i32 %12, i32* %p1.02.i.i.i, align 4, !tbaa !1
  %13 = getelementptr inbounds i32* %p1.02.i.i.i, i32 1
  %14 = getelementptr inbounds i32* %p2.03.i.i.i, i32 1
  %15 = icmp sgt i32 %11, 0
  br i1 %15, label %.lr.ph.i.i.i, label %.lr.ph.i5.i.i.preheader

.lr.ph.i5.i.i.preheader:                          ; preds = %.lr.ph.i.i.i
  %16 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 0
  br label %.lr.ph.i5.i.i

.lr.ph.i5.i.i:                                    ; preds = %.lr.ph.i5.i.i, %.lr.ph.i5.i.i.preheader
  %p2.03.i2.i.i = phi i32* [ %20, %.lr.ph.i5.i.i ], [ getelementptr inbounds ([1024 x i32]* @bf_init_S, i32 0, i32 0), %.lr.ph.i5.i.i.preheader ]
  %p1.02.i3.i.i = phi i32* [ %19, %.lr.ph.i5.i.i ], [ getelementptr inbounds ([1024 x i32]* @key_S, i32 0, i32 0), %.lr.ph.i5.i.i.preheader ]
  %.01.i4.i.i = phi i32 [ %17, %.lr.ph.i5.i.i ], [ 1024, %.lr.ph.i5.i.i.preheader ]
  %17 = add nsw i32 %.01.i4.i.i, -1
  %18 = load i32* %p2.03.i2.i.i, align 4, !tbaa !1
  store i32 %18, i32* %p1.02.i3.i.i, align 4, !tbaa !1
  %19 = getelementptr inbounds i32* %p1.02.i3.i.i, i32 1
  %20 = getelementptr inbounds i32* %p2.03.i2.i.i, i32 1
  %21 = icmp sgt i32 %17, 0
  br i1 %21, label %.lr.ph.i5.i.i, label %memcpy.exit6.i.i

memcpy.exit6.i.i:                                 ; preds = %.lr.ph.i5.i.i
  %22 = getelementptr inbounds i8* %16, i32 8
  br label %23

; <label>:23                                      ; preds = %23, %memcpy.exit6.i.i
  %d.010.i.i = phi i8* [ %16, %memcpy.exit6.i.i ], [ %d.4.i.i, %23 ]
  ...
  %.data.i.i = select i1 %27, i8* %24, i8* %16
  ...
  %d.2.i.i = select i1 %33, i8* %29, i8* %16
  ...
  %.data1.i.i = select i1 %39, i8* %35, i8* %16
  %40 = shl nuw i32 %38, 8
  ...
  %d.4.i.i = select i1 %45, i8* %41, i8* %16
...
; <label>:53                                      ; preds = %53, %50
  ...
  call fastcc void @BF_encrypt(i32* %51) #2
...
.loopexit.i:                                      ; preds = %BF_cfb64_encrypt.exit.i, %.critedge.i, %..loopexit_crit_edge.i
  ...
  %check.1.lcssa.i = phi i32 [ %.lcssa4, %..loopexit_crit_edge.i ], [ %check.014.i, %BF_cfb64_encrypt.exit.i ], [ %check.014.i, %.critedge.i ]
...
.lr.ph11.i.i:                                     ; preds = %137, %.critedge.i
  ...
  %.09.i.i = phi i8* [ %138, %137 ], [ %3, %.critedge.i ]
  %.018.i.i = phi i8* [ %143, %137 ], [ %4, %.critedge.i ]
...
blowfish_main.exit:                               ; preds = %.preheader.i, %.loopexit.i
  ...
  %157 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %check.1.lcssa22.i) #2
  %158 = icmp eq i32 %check.1.lcssa22.i, 5200
  br i1 %158, label %159, label %161

; <label>:159                                     ; preds = %blowfish_main.exit
  %160 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #2
  br label %163

; <label>:161                                     ; preds = %blowfish_main.exit
  %162 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #2
  br label %163
