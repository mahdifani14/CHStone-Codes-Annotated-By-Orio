...
; <label>:1                                       ; preds = %1, %0
  %i.015.i = phi i32 [ 0, %0 ], [ %4, %1 ]
  %2 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 %i.015.i
  store i8 0, i8* %2, align 1, !tbaa !5
  %3 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 %i.015.i
  store i8 0, i8* %3, align 1, !tbaa !5
  %4 = add nsw i32 %i.015.i, 1
  %exitcond20.i = icmp eq i32 %4, 8
  br i1 %exitcond20.i, label %5, label %1

; <label>:5                                       ; preds = %1
  %6 = getelementptr inbounds [40 x i8]* %indata.i, i32 0, i32 0
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i, %5
  %p2.03.i.i.i = phi i32* [ %10, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @bf_init_P, i32 0, i32 0), %5 ]
  %p1.02.i.i.i = phi i32* [ %9, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @key_P, i32 0, i32 0), %5 ]
  %.01.i.i.i = phi i32 [ %7, %.lr.ph.i.i.i ], [ 18, %5 ]
  %7 = add nsw i32 %.01.i.i.i, -1
  %8 = load i32* %p2.03.i.i.i, align 4, !tbaa !1
  store i32 %8, i32* %p1.02.i.i.i, align 4, !tbaa !1
  %9 = getelementptr inbounds i32* %p1.02.i.i.i, i32 1
  %10 = getelementptr inbounds i32* %p2.03.i.i.i, i32 1
  %11 = icmp sgt i32 %7, 0
  br i1 %11, label %.lr.ph.i.i.i, label %.lr.ph.i5.i.i.preheader

.lr.ph.i5.i.i.preheader:                          ; preds = %.lr.ph.i.i.i
  %12 = getelementptr inbounds [40 x i8]* %outdata.i, i32 0, i32 0
  br label %.lr.ph.i5.i.i

.lr.ph.i5.i.i:                                    ; preds = %.lr.ph.i5.i.i, %.lr.ph.i5.i.i.preheader
  %p2.03.i2.i.i = phi i32* [ %16, %.lr.ph.i5.i.i ], [ getelementptr inbounds ([1024 x i32]* @bf_init_S, i32 0, i32 0), %.lr.ph.i5.i.i.preheader ]
  %p1.02.i3.i.i = phi i32* [ %15, %.lr.ph.i5.i.i ], [ getelementptr inbounds ([1024 x i32]* @key_S, i32 0, i32 0), %.lr.ph.i5.i.i.preheader ]
  %.01.i4.i.i = phi i32 [ %13, %.lr.ph.i5.i.i ], [ 1024, %.lr.ph.i5.i.i.preheader ]
  %13 = add nsw i32 %.01.i4.i.i, -1
  %14 = load i32* %p2.03.i2.i.i, align 4, !tbaa !1
  store i32 %14, i32* %p1.02.i3.i.i, align 4, !tbaa !1
  %15 = getelementptr inbounds i32* %p1.02.i3.i.i, i32 1
  %16 = getelementptr inbounds i32* %p2.03.i2.i.i, i32 1
  %17 = icmp sgt i32 %13, 0
  br i1 %17, label %.lr.ph.i5.i.i, label %memcpy.exit6.i.i

memcpy.exit6.i.i:                                 ; preds = %.lr.ph.i5.i.i
  %18 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 0
  %19 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 8
  br label %20

; <label>:20                                      ; preds = %20, %memcpy.exit6.i.i
  %d.010.i.i = phi i8* [ %18, %memcpy.exit6.i.i ], [ %d.4.i.i, %20 ]
  %i.09.i.i = phi i32 [ 0, %memcpy.exit6.i.i ], [ %46, %20 ]
  %21 = getelementptr inbounds i8* %d.010.i.i, i32 1
  %22 = load i8* %d.010.i.i, align 1, !tbaa !5
  %23 = zext i8 %22 to i32
  %24 = icmp ult i8* %21, %19
  %.data.i.i = select i1 %24, i8* %21, i8* %18
  %25 = shl nuw nsw i32 %23, 8
  %26 = getelementptr inbounds i8* %.data.i.i, i32 1
  %27 = load i8* %.data.i.i, align 1, !tbaa !5
  %28 = zext i8 %27 to i32
  %29 = or i32 %25, %28
  %30 = icmp ult i8* %26, %19
  %d.2.i.i = select i1 %30, i8* %26, i8* %18
  %31 = shl nuw nsw i32 %29, 8
  %32 = getelementptr inbounds i8* %d.2.i.i, i32 1
  %33 = load i8* %d.2.i.i, align 1, !tbaa !5
  %34 = zext i8 %33 to i32
  %35 = or i32 %31, %34
  %36 = icmp ult i8* %32, %19
  %.data1.i.i = select i1 %36, i8* %32, i8* %18
  %37 = shl nuw i32 %35, 8
  %38 = getelementptr inbounds i8* %.data1.i.i, i32 1
  %39 = load i8* %.data1.i.i, align 1, !tbaa !5
  %40 = zext i8 %39 to i32
  %41 = or i32 %37, %40
  %42 = icmp ult i8* %38, %19
  %d.4.i.i = select i1 %42, i8* %38, i8* %18
  %43 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %i.09.i.i
  %44 = load i32* %43, align 4, !tbaa !1
  %45 = xor i32 %41, %44
  store i32 %45, i32* %43, align 4, !tbaa !1
  %46 = add nsw i32 %i.09.i.i, 1
  %exitcond.i.i = icmp eq i32 %46, 18
  br i1 %exitcond.i.i, label %47, label %20

; <label>:47                                      ; preds = %20
  %48 = getelementptr inbounds [2 x i32]* %in.i.i, i32 0, i32 0
  store i32 0, i32* %48, align 4, !tbaa !1
  %49 = getelementptr inbounds [2 x i32]* %in.i.i, i32 0, i32 1
  store i32 0, i32* %49, align 4, !tbaa !1
  br label %50

; <label>:50                                      ; preds = %50, %47
  %i.18.i.i = phi i32 [ 0, %47 ], [ %56, %50 ]
  call fastcc void @BF_encrypt(i32* %48) #1
  %51 = load i32* %48, align 4, !tbaa !1
  %52 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %i.18.i.i
  store i32 %51, i32* %52, align 4, !tbaa !1
  %53 = load i32* %49, align 4, !tbaa !1
  %54 = or i32 %i.18.i.i, 1
  %55 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %54
  store i32 %53, i32* %55, align 4, !tbaa !1
  %56 = add nsw i32 %i.18.i.i, 2
  %57 = icmp slt i32 %56, 18
  br i1 %57, label %50, label %.preheader.i.i

.preheader.i.i:                                   ; preds = %.preheader.i.i, %50
  %i.27.i.i = phi i32 [ %63, %.preheader.i.i ], [ 0, %50 ]
  call fastcc void @BF_encrypt(i32* %48) #1
  %58 = load i32* %48, align 4, !tbaa !1
  %59 = getelementptr inbounds [1024 x i32]* @key_S, i32 0, i32 %i.27.i.i
  store i32 %58, i32* %59, align 4, !tbaa !1
  %60 = load i32* %49, align 4, !tbaa !1
  %61 = or i32 %i.27.i.i, 1
  %62 = getelementptr inbounds [1024 x i32]* @key_S, i32 0, i32 %61
  store i32 %60, i32* %62, align 4, !tbaa !1
  %63 = add nsw i32 %i.27.i.i, 2
  %64 = icmp slt i32 %63, 1024
  br i1 %64, label %.preheader.i.i, label %BF_set_key.exit.i

BF_set_key.exit.i:                                ; preds = %.preheader.i.i
  %65 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 0
  %66 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 1
  %67 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 2
  %68 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 3
  %69 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 4
  %70 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 5
  %71 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 6
  %72 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 7
  br label %.preheader.i

..loopexit_crit_edge.i:                           ; preds = %.lr.ph9.i
  %.lcssa2 = phi i32 [ %152, %.lr.ph9.i ]
  %73 = sub i32 %l.013.i, %umax.i
  br label %.loopexit.i
...
.loopexit.i:                                      ; preds = %BF_cfb64_encrypt.exit.i, %.critedge.i, %..loopexit_crit_edge.i
  ...
  %check.1.lcssa.i = phi i32 [ %.lcssa2, %..loopexit_crit_edge.i ], [ %check.014.i, %BF_cfb64_encrypt.exit.i ], [ %check.014.i, %.critedge.i ]
  %l.1.lcssa.i = phi i32 [ %73, %..loopexit_crit_edge.i ], [ %l.013.i, %BF_cfb64_encrypt.exit.i ], [ %l.013.i, %.critedge.i ]
  %74 = icmp slt i32 %85, 5200
  br i1 %74, label %.preheader.i, label %blowfish_main.exit
...
.preheader.i:                                     ; preds = %.loopexit.i, %BF_set_key.exit.i
  ...
  %k.012.i = phi i32 [ 0, %BF_set_key.exit.i ], [ %85, %.loopexit.i ]
  %75 = icmp slt i32 %k.012.i, 5200
  br i1 %75, label %.lr.ph.i, label %blowfish_main.exit

.lr.ph.i:                                         ; preds = %.preheader.i
  %76 = add i32 %k.012.i, -5200
  %77 = icmp ugt i32 %76, -40
  %umax.i = select i1 %77, i32 %76, i32 -40
  %78 = sub i32 0, %umax.i
  br label %79

; <label>:79                                      ; preds = %79, %.lr.ph.i
  %i.24.i = phi i32 [ 0, %.lr.ph.i ], [ %83, %79 ]
  %k.13.i = phi i32 [ %k.012.i, %.lr.ph.i ], [ %80, %79 ]
  %80 = add nsw i32 %k.13.i, 1
  %81 = getelementptr inbounds [5200 x i8]* @in_key, i32 0, i32 %k.13.i
  %82 = load i8* %81, align 1, !tbaa !5
  %83 = add nsw i32 %i.24.i, 1
  %84 = getelementptr inbounds [40 x i8]* %indata.i, i32 0, i32 %i.24.i
  store i8 %82, i8* %84, align 1, !tbaa !5
  %exitcond.i = icmp eq i32 %83, %78
  br i1 %exitcond.i, label %.critedge.i, label %79

.critedge.i:                                      ; preds = %79
  %85 = sub i32 %k.012.i, %umax.i
  %86 = icmp eq i32 %umax.i, 0
  br i1 %86, label %.loopexit.i, label %.lr.ph11.i.i

.lr.ph11.i.i:                                     ; preds = %134, %.critedge.i
  %.in.i.i = phi i32 [ %87, %134 ], [ %78, %.critedge.i ]
  %n.010.i.i = phi i32 [ %142, %134 ], [ %num.i.1, %.critedge.i ]
  %.09.i.i = phi i8* [ %135, %134 ], [ %6, %.critedge.i ]
  %.018.i.i = phi i8* [ %140, %134 ], [ %12, %.critedge.i ]
  %87 = add nsw i32 %.in.i.i, -1
  %88 = icmp eq i32 %n.010.i.i, 0
  br i1 %88, label %89, label %134

; <label>:89                                      ; preds = %.lr.ph11.i.i
  %90 = load i8* %65, align 1, !tbaa !5
  %91 = zext i8 %90 to i32
  %92 = shl nuw i32 %91, 24
  %93 = load i8* %66, align 1, !tbaa !5
  %94 = zext i8 %93 to i32
  %95 = shl nuw nsw i32 %94, 16
  %96 = or i32 %95, %92
  %97 = load i8* %67, align 1, !tbaa !5
  %98 = zext i8 %97 to i32
  %99 = shl nuw nsw i32 %98, 8
  %100 = or i32 %96, %99
  %101 = load i8* %68, align 1, !tbaa !5
  %102 = zext i8 %101 to i32
  %103 = or i32 %100, %102
  store i32 %103, i32* %48, align 4, !tbaa !1
  %104 = load i8* %69, align 1, !tbaa !5
  %105 = zext i8 %104 to i32
  %106 = shl nuw i32 %105, 24
  %107 = load i8* %70, align 1, !tbaa !5
  %108 = zext i8 %107 to i32
  %109 = shl nuw nsw i32 %108, 16
  %110 = or i32 %109, %106
  %111 = load i8* %71, align 1, !tbaa !5
  %112 = zext i8 %111 to i32
  %113 = shl nuw nsw i32 %112, 8
  %114 = or i32 %110, %113
  %115 = load i8* %72, align 1, !tbaa !5
  %116 = zext i8 %115 to i32
  %117 = or i32 %114, %116
  store i32 %117, i32* %49, align 4, !tbaa !1
  call fastcc void @BF_encrypt(i32* %48) #1
  %118 = load i32* %48, align 4, !tbaa !1
  %119 = lshr i32 %118, 24
  %120 = trunc i32 %119 to i8
  store i8 %120, i8* %65, align 1, !tbaa !5
  %121 = lshr i32 %118, 16
  %122 = trunc i32 %121 to i8
  store i8 %122, i8* %66, align 1, !tbaa !5
  %123 = lshr i32 %118, 8
  %124 = trunc i32 %123 to i8
  store i8 %124, i8* %67, align 1, !tbaa !5
  %125 = trunc i32 %118 to i8
  store i8 %125, i8* %68, align 1, !tbaa !5
  %126 = load i32* %49, align 4, !tbaa !1
  %127 = lshr i32 %126, 24
  %128 = trunc i32 %127 to i8
  store i8 %128, i8* %69, align 1, !tbaa !5
  %129 = lshr i32 %126, 16
  %130 = trunc i32 %129 to i8
  store i8 %130, i8* %70, align 1, !tbaa !5
  %131 = lshr i32 %126, 8
  %132 = trunc i32 %131 to i8
  store i8 %132, i8* %71, align 1, !tbaa !5
  %133 = trunc i32 %126 to i8
  store i8 %133, i8* %72, align 1, !tbaa !5
  br label %134

; <label>:134                                     ; preds = %89, %.lr.ph11.i.i
  %135 = getelementptr inbounds i8* %.09.i.i, i32 1
  %136 = load i8* %.09.i.i, align 1, !tbaa !5
  %137 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 %n.010.i.i
  %138 = load i8* %137, align 1, !tbaa !5
  %139 = xor i8 %138, %136
  %140 = getelementptr inbounds i8* %.018.i.i, i32 1
  store i8 %139, i8* %.018.i.i, align 1, !tbaa !5
  store i8 %139, i8* %137, align 1, !tbaa !5
  %141 = add nsw i32 %n.010.i.i, 1
  %142 = and i32 %141, 7
  %143 = icmp eq i32 %87, 0
  br i1 %143, label %BF_cfb64_encrypt.exit.i, label %.lr.ph11.i.i

BF_cfb64_encrypt.exit.i:                          ; preds = %134
  %.lcssa = phi i32 [ %142, %134 ]
  %144 = icmp sgt i32 %78, 0
  br i1 %144, label %.lr.ph9.i, label %.loopexit.i

.lr.ph9.i:                                        ; preds = %.lr.ph9.i, %BF_cfb64_encrypt.exit.i
  %check.18.i = phi i32 [ %152, %.lr.ph9.i ], [ %check.014.i, %BF_cfb64_encrypt.exit.i ]
  %j.07.i = phi i32 [ %153, %.lr.ph9.i ], [ 0, %BF_cfb64_encrypt.exit.i ]
  %l.16.i = phi i32 [ %147, %.lr.ph9.i ], [ %l.013.i, %BF_cfb64_encrypt.exit.i ]
  %145 = getelementptr inbounds [40 x i8]* %outdata.i, i32 0, i32 %j.07.i
  %146 = load i8* %145, align 1, !tbaa !5
  %147 = add nsw i32 %l.16.i, 1
  %148 = getelementptr inbounds [5200 x i8]* @out_key, i32 0, i32 %l.16.i
  %149 = load i8* %148, align 1, !tbaa !5
  %150 = icmp eq i8 %146, %149
  %151 = zext i1 %150 to i32
  %152 = add nsw i32 %151, %check.18.i
  %153 = add nsw i32 %j.07.i, 1
  %exitcond19.i = icmp eq i32 %153, %78
...
blowfish_main.exit:                               ; preds = %.preheader.i, %.loopexit.i
  ...
  %154 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %check.1.lcssa22.i) #1
  %155 = icmp eq i32 %check.1.lcssa22.i, 5200
  br i1 %155, label %156, label %158

; <label>:156                                     ; preds = %blowfish_main.exit
  %157 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #1
  br label %160

; <label>:158                                     ; preds = %blowfish_main.exit
  %159 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1
  br label %160
