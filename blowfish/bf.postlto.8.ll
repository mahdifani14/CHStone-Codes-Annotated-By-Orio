...
define i32 @main() #0 {
  ...
  %1 = bitcast [8 x i8]* %ukey.i to i8*
  %2 = getelementptr inbounds [40 x i8]* %indata.i, i32 0, i32 0
  br label %3

; <label>:3                                       ; preds = %3, %0
  %i.015.i = phi i32 [ 0, %0 ], [ %6, %3 ]
  %4 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 %i.015.i
  store i8 0, i8* %4, align 1, !tbaa !5
  %5 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 %i.015.i
  store i8 0, i8* %5, align 1, !tbaa !5
  %6 = add nsw i32 %i.015.i, 1
  %exitcond20.i = icmp eq i32 %6, 8
  br i1 %exitcond20.i, label %7, label %3

; <label>:7                                       ; preds = %3
  %8 = bitcast [8 x i8]* %ivec.i to i8*
  %9 = getelementptr inbounds [40 x i8]* %outdata.i, i32 0, i32 0
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i, %7
  %p2.03.i.i.i = phi i32* [ %13, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @bf_init_P, i32 0, i32 0), %7 ]
  %p1.02.i.i.i = phi i32* [ %12, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @key_P, i32 0, i32 0), %7 ]
  %.01.i.i.i = phi i32 [ %10, %.lr.ph.i.i.i ], [ 18, %7 ]
  %10 = add nsw i32 %.01.i.i.i, -1
  %11 = load i32* %p2.03.i.i.i, align 4, !tbaa !1
  store i32 %11, i32* %p1.02.i.i.i, align 4, !tbaa !1
  %12 = getelementptr inbounds i32* %p1.02.i.i.i, i32 1
  %13 = getelementptr inbounds i32* %p2.03.i.i.i, i32 1
  %14 = icmp sgt i32 %10, 0
  br i1 %14, label %.lr.ph.i.i.i, label %.lr.ph.i5.i.i.preheader

.lr.ph.i5.i.i.preheader:                          ; preds = %.lr.ph.i.i.i
  %15 = bitcast [2 x i32]* %in.i.i to i8*
  br label %.lr.ph.i5.i.i

.lr.ph.i5.i.i:                                    ; preds = %.lr.ph.i5.i.i, %.lr.ph.i5.i.i.preheader
  %p2.03.i2.i.i = phi i32* [ %19, %.lr.ph.i5.i.i ], [ getelementptr inbounds ([1024 x i32]* @bf_init_S, i32 0, i32 0), %.lr.ph.i5.i.i.preheader ]
  %p1.02.i3.i.i = phi i32* [ %18, %.lr.ph.i5.i.i ], [ getelementptr inbounds ([1024 x i32]* @key_S, i32 0, i32 0), %.lr.ph.i5.i.i.preheader ]
  %.01.i4.i.i = phi i32 [ %16, %.lr.ph.i5.i.i ], [ 1024, %.lr.ph.i5.i.i.preheader ]
  %16 = add nsw i32 %.01.i4.i.i, -1
  %17 = load i32* %p2.03.i2.i.i, align 4, !tbaa !1
  store i32 %17, i32* %p1.02.i3.i.i, align 4, !tbaa !1
  %18 = getelementptr inbounds i32* %p1.02.i3.i.i, i32 1
  %19 = getelementptr inbounds i32* %p2.03.i2.i.i, i32 1
  %20 = icmp sgt i32 %16, 0
  br i1 %20, label %.lr.ph.i5.i.i, label %memcpy.exit6.i.i

memcpy.exit6.i.i:                                 ; preds = %.lr.ph.i5.i.i
  %21 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 0
  %22 = getelementptr inbounds i8* %21, i32 8
  br label %23

; <label>:23                                      ; preds = %23, %memcpy.exit6.i.i
  %d.010.i.i = phi i8* [ %21, %memcpy.exit6.i.i ], [ %d.4.i.i, %23 ]
  %i.09.i.i = phi i32 [ 0, %memcpy.exit6.i.i ], [ %49, %23 ]
  %24 = getelementptr inbounds i8* %d.010.i.i, i32 1
  %25 = load i8* %d.010.i.i, align 1, !tbaa !5
  %26 = zext i8 %25 to i32
  %27 = icmp ult i8* %24, %22
  %.data.i.i = select i1 %27, i8* %24, i8* %21
  %28 = shl nuw nsw i32 %26, 8
  %29 = getelementptr inbounds i8* %.data.i.i, i32 1
  %30 = load i8* %.data.i.i, align 1, !tbaa !5
  %31 = zext i8 %30 to i32
  %32 = or i32 %28, %31
  %33 = icmp ult i8* %29, %22
  %d.2.i.i = select i1 %33, i8* %29, i8* %21
  %34 = shl nuw nsw i32 %32, 8
  %35 = getelementptr inbounds i8* %d.2.i.i, i32 1
  %36 = load i8* %d.2.i.i, align 1, !tbaa !5
  %37 = zext i8 %36 to i32
  %38 = or i32 %34, %37
  %39 = icmp ult i8* %35, %22
  %.data1.i.i = select i1 %39, i8* %35, i8* %21
  %40 = shl nuw i32 %38, 8
  %41 = getelementptr inbounds i8* %.data1.i.i, i32 1
  %42 = load i8* %.data1.i.i, align 1, !tbaa !5
  %43 = zext i8 %42 to i32
  %44 = or i32 %40, %43
  %45 = icmp ult i8* %41, %22
  %d.4.i.i = select i1 %45, i8* %41, i8* %21
  %46 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %i.09.i.i
  %47 = load i32* %46, align 4, !tbaa !1
  %48 = xor i32 %44, %47
  store i32 %48, i32* %46, align 4, !tbaa !1
  %49 = add nsw i32 %i.09.i.i, 1
  %exitcond.i.i = icmp eq i32 %49, 18
  br i1 %exitcond.i.i, label %50, label %23

; <label>:50                                      ; preds = %23
  %51 = getelementptr inbounds [2 x i32]* %in.i.i, i32 0, i32 0
  store i32 0, i32* %51, align 4, !tbaa !1
  %52 = getelementptr inbounds [2 x i32]* %in.i.i, i32 0, i32 1
  store i32 0, i32* %52, align 4, !tbaa !1
  br label %53

; <label>:53                                      ; preds = %53, %50
  %i.18.i.i = phi i32 [ 0, %50 ], [ %59, %53 ]
  call fastcc void @BF_encrypt(i32* %51) #1
  %54 = load i32* %51, align 4, !tbaa !1
  %55 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %i.18.i.i
  store i32 %54, i32* %55, align 4, !tbaa !1
  %56 = load i32* %52, align 4, !tbaa !1
  %57 = or i32 %i.18.i.i, 1
  %58 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %57
  store i32 %56, i32* %58, align 4, !tbaa !1
  %59 = add nsw i32 %i.18.i.i, 2
  %60 = icmp slt i32 %59, 18
  br i1 %60, label %53, label %.preheader.i.i

.preheader.i.i:                                   ; preds = %.preheader.i.i, %53
  %i.27.i.i = phi i32 [ %66, %.preheader.i.i ], [ 0, %53 ]
  call fastcc void @BF_encrypt(i32* %51) #1
  %61 = load i32* %51, align 4, !tbaa !1
  %62 = getelementptr inbounds [1024 x i32]* @key_S, i32 0, i32 %i.27.i.i
  store i32 %61, i32* %62, align 4, !tbaa !1
  %63 = load i32* %52, align 4, !tbaa !1
  %64 = or i32 %i.27.i.i, 1
  %65 = getelementptr inbounds [1024 x i32]* @key_S, i32 0, i32 %64
  store i32 %63, i32* %65, align 4, !tbaa !1
  %66 = add nsw i32 %i.27.i.i, 2
  %67 = icmp slt i32 %66, 1024
  br i1 %67, label %.preheader.i.i, label %BF_set_key.exit.i

BF_set_key.exit.i:                                ; preds = %.preheader.i.i
  %68 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 0
  %69 = getelementptr inbounds i8* %68, i32 1
  %70 = getelementptr inbounds i8* %68, i32 2
  %71 = getelementptr inbounds i8* %68, i32 3
  %72 = getelementptr inbounds i8* %68, i32 4
  %73 = getelementptr inbounds i8* %68, i32 5
  %74 = getelementptr inbounds i8* %68, i32 6
  %75 = getelementptr inbounds i8* %68, i32 7
  br label %.preheader.i

..loopexit_crit_edge.i:                           ; preds = %.lr.ph9.i
  %.lcssa1 = phi i32 [ %155, %.lr.ph9.i ]
  %76 = sub i32 %l.013.i, %umax.i
  br label %.loopexit.i

.loopexit.i:                                      ; preds = %BF_cfb64_encrypt.exit.i, %.critedge.i, %..loopexit_crit_edge.i
  %num.i.0 = phi i32 [ %.lcssa, %..loopexit_crit_edge.i ], [ %.lcssa, %BF_cfb64_encrypt.exit.i ], [ %num.i.1, %.critedge.i ]
  %check.1.lcssa.i = phi i32 [ %.lcssa1, %..loopexit_crit_edge.i ], [ %check.014.i, %BF_cfb64_encrypt.exit.i ], [ %check.014.i, %.critedge.i ]
  %l.1.lcssa.i = phi i32 [ %76, %..loopexit_crit_edge.i ], [ %l.013.i, %BF_cfb64_encrypt.exit.i ], [ %l.013.i, %.critedge.i ]
  %77 = icmp slt i32 %88, 5200
  br i1 %77, label %.preheader.i, label %blowfish_main.exit

.preheader.i:                                     ; preds = %.loopexit.i, %BF_set_key.exit.i
  ...
  %k.012.i = phi i32 [ 0, %BF_set_key.exit.i ], [ %88, %.loopexit.i ]
  %78 = icmp slt i32 %k.012.i, 5200
  br i1 %78, label %.lr.ph.i, label %blowfish_main.exit

.lr.ph.i:                                         ; preds = %.preheader.i
  %79 = add i32 %k.012.i, -5200
  %80 = icmp ugt i32 %79, -40
  %umax.i = select i1 %80, i32 %79, i32 -40
  %81 = sub i32 0, %umax.i
  br label %82

; <label>:82                                      ; preds = %82, %.lr.ph.i
  %i.24.i = phi i32 [ 0, %.lr.ph.i ], [ %86, %82 ]
  %k.13.i = phi i32 [ %k.012.i, %.lr.ph.i ], [ %83, %82 ]
  %83 = add nsw i32 %k.13.i, 1
  %84 = getelementptr inbounds [5200 x i8]* @in_key, i32 0, i32 %k.13.i
  %85 = load i8* %84, align 1, !tbaa !5
  %86 = add nsw i32 %i.24.i, 1
  %87 = getelementptr inbounds [40 x i8]* %indata.i, i32 0, i32 %i.24.i
  store i8 %85, i8* %87, align 1, !tbaa !5
  %exitcond.i = icmp eq i32 %86, %81
  br i1 %exitcond.i, label %.critedge.i, label %82

.critedge.i:                                      ; preds = %82
  %88 = sub i32 %k.012.i, %umax.i
  %89 = icmp eq i32 %81, 0
  br i1 %89, label %.loopexit.i, label %.lr.ph11.i.i

.lr.ph11.i.i:                                     ; preds = %137, %.critedge.i
  %.in.i.i = phi i32 [ %90, %137 ], [ %81, %.critedge.i ]
  %n.010.i.i = phi i32 [ %145, %137 ], [ %num.i.1, %.critedge.i ]
  %.09.i.i = phi i8* [ %138, %137 ], [ %2, %.critedge.i ]
  %.018.i.i = phi i8* [ %143, %137 ], [ %9, %.critedge.i ]
  %90 = add nsw i32 %.in.i.i, -1
  %91 = icmp eq i32 %n.010.i.i, 0
  br i1 %91, label %92, label %137

; <label>:92                                      ; preds = %.lr.ph11.i.i
  %93 = load i8* %68, align 1, !tbaa !5
  %94 = zext i8 %93 to i32
  %95 = shl nuw i32 %94, 24
  %96 = load i8* %69, align 1, !tbaa !5
  %97 = zext i8 %96 to i32
  %98 = shl nuw nsw i32 %97, 16
  %99 = or i32 %98, %95
  %100 = load i8* %70, align 1, !tbaa !5
  %101 = zext i8 %100 to i32
  %102 = shl nuw nsw i32 %101, 8
  %103 = or i32 %99, %102
  %104 = load i8* %71, align 1, !tbaa !5
  %105 = zext i8 %104 to i32
  %106 = or i32 %103, %105
  store i32 %106, i32* %51, align 4, !tbaa !1
  %107 = load i8* %72, align 1, !tbaa !5
  %108 = zext i8 %107 to i32
  %109 = shl nuw i32 %108, 24
  %110 = load i8* %73, align 1, !tbaa !5
  %111 = zext i8 %110 to i32
  %112 = shl nuw nsw i32 %111, 16
  %113 = or i32 %112, %109
  %114 = load i8* %74, align 1, !tbaa !5
  %115 = zext i8 %114 to i32
  %116 = shl nuw nsw i32 %115, 8
  %117 = or i32 %113, %116
  %118 = load i8* %75, align 1, !tbaa !5
  %119 = zext i8 %118 to i32
  %120 = or i32 %117, %119
  store i32 %120, i32* %52, align 4, !tbaa !1
  call fastcc void @BF_encrypt(i32* %51) #1
  %121 = load i32* %51, align 4, !tbaa !1
  %122 = lshr i32 %121, 24
  %123 = trunc i32 %122 to i8
  store i8 %123, i8* %68, align 1, !tbaa !5
  %124 = lshr i32 %121, 16
  %125 = trunc i32 %124 to i8
  store i8 %125, i8* %69, align 1, !tbaa !5
  %126 = lshr i32 %121, 8
  %127 = trunc i32 %126 to i8
  store i8 %127, i8* %70, align 1, !tbaa !5
  %128 = trunc i32 %121 to i8
  store i8 %128, i8* %71, align 1, !tbaa !5
  %129 = load i32* %52, align 4, !tbaa !1
  %130 = lshr i32 %129, 24
  %131 = trunc i32 %130 to i8
  store i8 %131, i8* %72, align 1, !tbaa !5
  %132 = lshr i32 %129, 16
  %133 = trunc i32 %132 to i8
  store i8 %133, i8* %73, align 1, !tbaa !5
  %134 = lshr i32 %129, 8
  %135 = trunc i32 %134 to i8
  store i8 %135, i8* %74, align 1, !tbaa !5
  %136 = trunc i32 %129 to i8
  store i8 %136, i8* %75, align 1, !tbaa !5
  br label %137

; <label>:137                                     ; preds = %92, %.lr.ph11.i.i
  %138 = getelementptr inbounds i8* %.09.i.i, i32 1
  %139 = load i8* %.09.i.i, align 1, !tbaa !5
  %140 = getelementptr inbounds i8* %68, i32 %n.010.i.i
  %141 = load i8* %140, align 1, !tbaa !5
  %142 = xor i8 %141, %139
  %143 = getelementptr inbounds i8* %.018.i.i, i32 1
  store i8 %142, i8* %.018.i.i, align 1, !tbaa !5
  store i8 %142, i8* %140, align 1, !tbaa !5
  %144 = add nsw i32 %n.010.i.i, 1
  %145 = and i32 %144, 7
  %146 = icmp eq i32 %90, 0
  br i1 %146, label %BF_cfb64_encrypt.exit.i, label %.lr.ph11.i.i

BF_cfb64_encrypt.exit.i:                          ; preds = %137
  %.lcssa = phi i32 [ %145, %137 ]
  %147 = icmp sgt i32 %81, 0
  br i1 %147, label %.lr.ph9.i, label %.loopexit.i

.lr.ph9.i:                                        ; preds = %.lr.ph9.i, %BF_cfb64_encrypt.exit.i
  %check.18.i = phi i32 [ %155, %.lr.ph9.i ], [ %check.014.i, %BF_cfb64_encrypt.exit.i ]
  %j.07.i = phi i32 [ %156, %.lr.ph9.i ], [ 0, %BF_cfb64_encrypt.exit.i ]
  %l.16.i = phi i32 [ %150, %.lr.ph9.i ], [ %l.013.i, %BF_cfb64_encrypt.exit.i ]
  %148 = getelementptr inbounds [40 x i8]* %outdata.i, i32 0, i32 %j.07.i
  %149 = load i8* %148, align 1, !tbaa !5
  %150 = add nsw i32 %l.16.i, 1
  %151 = getelementptr inbounds [5200 x i8]* @out_key, i32 0, i32 %l.16.i
  %152 = load i8* %151, align 1, !tbaa !5
  %153 = icmp eq i8 %149, %152
  %154 = zext i1 %153 to i32
  %155 = add nsw i32 %154, %check.18.i
  %156 = add nsw i32 %j.07.i, 1
  %exitcond19.i = icmp eq i32 %156, %81
  br i1 %exitcond19.i, label %..loopexit_crit_edge.i, label %.lr.ph9.i

blowfish_main.exit:                               ; preds = %.preheader.i, %.loopexit.i
  %check.1.lcssa22.i = phi i32 [ %check.014.i, %.preheader.i ], [ %check.1.lcssa.i, %.loopexit.i ]
  %157 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %check.1.lcssa22.i) #1
  %158 = icmp eq i32 %check.1.lcssa22.i, 5200
  br i1 %158, label %159, label %161

; <label>:159                                     ; preds = %blowfish_main.exit
  %160 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #1
  br label %163

; <label>:161                                     ; preds = %blowfish_main.exit
  %162 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1
  br label %163
