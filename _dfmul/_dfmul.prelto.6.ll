...
; <label>:216                                     ; preds = %float64_mul.exit
  ...
  %217 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %.lcssa) #2
  %218 = icmp eq i32 %.lcssa, 20
  br i1 %218, label %219, label %221

; <label>:219                                     ; preds = %216
  %220 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0)) #2
  br label %223

; <label>:221                                     ; preds = %216
  %222 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #2
  br label %223
