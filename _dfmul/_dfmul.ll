...
; <label>:16                                      ; preds = %14
  ...
  br i1 %or.cond.i, label %float64_is_signaling_nan.exit1.i10.i, label %33
...
float64_is_signaling_nan.exit1.i10.i:             ; preds = %16, %14
  ...
  %25 = and i32 %24, 1
  %26 = icmp eq i32 %25, 0
  br i1 %26, label %float64_is_signaling_nan.exit.i11.i, label %27

; <label>:27                                      ; preds = %float64_is_signaling_nan.exit1.i10.i
  %28 = and i32 %2, -5
  %29 = icmp eq i32 %28, 0
  br label %float64_is_signaling_nan.exit.i11.i

float64_is_signaling_nan.exit.i11.i:              ; preds = %27, %float64_is_signaling_nan.exit1.i10.i
...
float64_mul.exit:                                 ; preds = %.thread6.i.i, %156, %96, %72, %65, %63, %float64_is_signaling_nan.exit.i.i, %39, %37, %float64_is_signaling_nan.exit.i11.i
