...
; <label>:1                                       ; preds = %float64_mul.exit, %0
  ...
  %i.01 = phi i32 [ 0, %0 ], [ %202, %float64_mul.exit ]
...
; <label>:15                                      ; preds = %1
  ...
  br i1 %16, label %float64_is_signaling_nan.exit1.i10.i, label %17
...
; <label>:17                                      ; preds = %15
  ...
  br i1 %or.cond.i, label %float64_is_signaling_nan.exit1.i10.i, label %35

float64_is_signaling_nan.exit1.i10.i:             ; preds = %17, %15
  %21 = lshr i32 13, %i.01
  %22 = and i32 %21, 1
  %23 = icmp eq i32 %22, 0
  ...
  %27 = and i32 %26, 1
  %28 = icmp eq i32 %27, 0
  br i1 %28, label %float64_is_signaling_nan.exit.i11.i, label %29

; <label>:29                                      ; preds = %float64_is_signaling_nan.exit1.i10.i
  %30 = and i32 %i.01, -5
  %31 = icmp eq i32 %30, 0
  br label %float64_is_signaling_nan.exit.i11.i

float64_is_signaling_nan.exit.i11.i:              ; preds = %29, %float64_is_signaling_nan.exit1.i10.i
  %32 = phi i1 [ false, %float64_is_signaling_nan.exit1.i10.i ], [ %31, %29 ]
  %33 = or i1 %.1, %32
...
; <label>:116                                     ; preds = %normalizeFloat64Subnormal.exit.i, %93
  ...
  %.18.v.i = select i1 %146, i32 -1024, i32 -1023
  %.18.i = add i32 %119, %.18.v.i
  %.tr.i1.i = trunc i64 %..i to i32
  %147 = and i32 %.tr.i1.i, 1023
  %148 = and i32 %.18.i, 65535
  %149 = icmp ugt i32 %148, 2044
  br i1 %149, label %150, label %.thread.i2.i

; <label>:150                                     ; preds = %116
  %151 = icmp sgt i32 %.18.i, 2045
  br i1 %151, label %157, label %152

; <label>:152                                     ; preds = %150
  %153 = icmp eq i32 %.18.i, 2045
  br i1 %153, label %154, label %161

; <label>:154                                     ; preds = %152
  %155 = add i64 %..i, 512
  %156 = icmp slt i64 %155, 0
  br i1 %156, label %157, label %.thread.i2.i
...
; <label>:161                                     ; preds = %152
  %162 = icmp slt i32 %.18.i, 0
  br i1 %162, label %163, label %.thread.i2.i

; <label>:163                                     ; preds = %161
  %164 = icmp sgt i32 %.18.i, -64
  br i1 %164, label %165, label %175

; <label>:165                                     ; preds = %163
  %166 = sub nsw i32 0, %.18.i
...
.thread.i2.i:                                     ; preds = %180, %161, %154, %116
  ...
  %.02.i.i = phi i32 [ 2045, %154 ], [ 0, %180 ], [ %.18.i, %161 ], [ %.18.i, %116 ]
...
float64_mul.exit:                                 ; preds = %.thread6.i.i, %157, %98, %75, %68, %66, %float64_is_signaling_nan.exit.i.i, %41, %39, %float64_is_signaling_nan.exit.i11.i
  %float_exception_flags.5 = phi i32 [ %.float_exception_flags.0, %float64_is_signaling_nan.exit.i11.i ], [ %40, %39 ], [ %float_exception_flags.0, %41 ], [ %67, %66 ], [ %float_exception_flags.0, %68 ], [ %.float_exception_flags.07, %float64_is_signaling_nan.exit.i.i ], [ %float_exception_flags.0, %75 ], [ %float_exception_flags.0, %98 ], [ %158, %157 ], [ %float_exception_flags.4, %.thread6.i.i ]
  %.0.i = phi i64 [ %.mux2.i15.i, %float64_is_signaling_nan.exit.i11.i ], [ 9223372036854775807, %39 ], [ %43, %41 ], [ 9223372036854775807, %66 ], [ %70, %68 ], [ %.mux2.i.i, %float64_is_signaling_nan.exit.i.i ], [ %76, %75 ], [ %99, %98 ], [ %160, %157 ], [ %196, %.thread6.i.i ]
  ...
  %202 = add nsw i32 %i.01, 1
  %exitcond = icmp eq i32 %202, 20
  br i1 %exitcond, label %203, label %1

; <label>:203                                     ; preds = %float64_mul.exit
  %.lcssa = phi i32 [ %201, %float64_mul.exit ]
  %204 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %.lcssa) #1
  %205 = icmp eq i32 %.lcssa, 20
  br i1 %205, label %206, label %208

; <label>:206                                     ; preds = %203
  %207 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0)) #1
  br label %210

; <label>:208                                     ; preds = %203
  %209 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #1
  br label %210
