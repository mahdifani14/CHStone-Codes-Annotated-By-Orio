...
; <label>:127                                     ; preds = %normalizeFloat64Subnormal.exit.i, %101
  ...
  %143 = mul i64 %140, %135
  %144 = mul i64 %138, %135
  %overflow_intrinsic.i = zext i64 %142 to i65
  %overflow_intrinsic1.i = zext i64 %143 to i65
  ...
  %145 = zext i1 %overflow_intrinsic_carry.i to i64
  %146 = shl nuw nsw i64 %145, 32
  %147 = lshr i64 %overflow_intrinsic_sum.i, 32
  %148 = or i64 %146, %147
  %149 = shl i64 %overflow_intrinsic_sum.i, 32
  %overflow_intrinsic4.i = zext i64 %141 to i65
  %overflow_intrinsic5.i = zext i64 %149 to i65
  ...
  %150 = zext i1 %overflow_intrinsic_carry9.i to i64
  %151 = add i64 %150, %144
  %152 = add i64 %151, %148
  %153 = icmp ne i64 %overflow_intrinsic_sum7.i, 0
...
; <label>:216                                     ; preds = %float64_mul.exit
  ...
  %217 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %.lcssa)
  %218 = icmp eq i32 %.lcssa, 20
  br i1 %218, label %219, label %221

; <label>:219                                     ; preds = %216
  %220 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0))
  br label %223

; <label>:221                                     ; preds = %216
  %222 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0))
  br label %223
