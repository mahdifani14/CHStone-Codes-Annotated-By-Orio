...
; <label>:14                                      ; preds = %1
  %15 = icmp eq i32 %2, 1
  br i1 %15, label %float64_is_signaling_nan.exit1.i10.i, label %16
...
; <label>:16                                      ; preds = %14
  ...
  br i1 %or.cond.i, label %float64_is_signaling_nan.exit1.i10.i, label %34

float64_is_signaling_nan.exit1.i10.i:             ; preds = %16, %14
  %20 = lshr i32 13, %2
  %21 = and i32 %20, 1
  %22 = icmp eq i32 %21, 0
  ...
  %26 = and i32 %25, 1
  %27 = icmp eq i32 %26, 0
  br i1 %27, label %float64_is_signaling_nan.exit.i11.i, label %28

; <label>:28                                      ; preds = %float64_is_signaling_nan.exit1.i10.i
  %29 = and i32 %2, -5
  %30 = icmp eq i32 %29, 0
  br label %float64_is_signaling_nan.exit.i11.i

float64_is_signaling_nan.exit.i11.i:              ; preds = %28, %float64_is_signaling_nan.exit1.i10.i
  %31 = phi i1 [ false, %float64_is_signaling_nan.exit1.i10.i ], [ %30, %28 ]
  %32 = or i1 %.1, %31
...
; <label>:115                                     ; preds = %normalizeFloat64Subnormal.exit.i, %92
  ...
  br i1 %148, label %149, label %.thread.i2.i
...
; <label>:153                                     ; preds = %151
  ...
  br i1 %155, label %156, label %.thread.i2.i
...
; <label>:160                                     ; preds = %151
  ...
  br i1 %161, label %162, label %.thread.i2.i
...
.thread.i2.i:                                     ; preds = %179, %160, %153, %115
...
float64_mul.exit:                                 ; preds = %.thread6.i.i, %156, %97, %74, %67, %65, %float64_is_signaling_nan.exit.i.i, %40, %38, %float64_is_signaling_nan.exit.i11.i
  %float_exception_flags.5 = phi i32 [ %.float_exception_flags.0, %float64_is_signaling_nan.exit.i11.i ], [ %39, %38 ], [ %float_exception_flags.0, %40 ], [ %66, %65 ], [ %float_exception_flags.0, %67 ], [ %.float_exception_flags.07, %float64_is_signaling_nan.exit.i.i ], [ %float_exception_flags.0, %74 ], [ %float_exception_flags.0, %97 ], [ %157, %156 ], [ %float_exception_flags.4, %.thread6.i.i ]
  %.0.i = phi i64 [ %.mux2.i15.i, %float64_is_signaling_nan.exit.i11.i ], [ 9223372036854775807, %38 ], [ %42, %40 ], [ 9223372036854775807, %65 ], [ %69, %67 ], [ %.mux2.i.i, %float64_is_signaling_nan.exit.i.i ], [ %75, %74 ], [ %98, %97 ], [ %159, %156 ], [ %195, %.thread6.i.i ]
  ...
  br i1 %exitcond1, label %201, label %1

; <label>:201                                     ; preds = %float64_mul.exit
  %.lcssa = phi i32 [ %199, %float64_mul.exit ]
  %202 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %.lcssa) #1
  %203 = icmp eq i32 %.lcssa, 20
