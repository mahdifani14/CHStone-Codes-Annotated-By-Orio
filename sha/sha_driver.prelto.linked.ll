; ModuleID = 'sha_driver.prelto.linked.bc'
...
; <label>:1                                       ; preds = %1, %0
  %main_result.02 = phi i32 [ 0, %0 ], [ %8, %1 ]
  %i.01 = phi i32 [ 0, %0 ], [ %9, %1 ]
  %2 = getelementptr inbounds [5 x i32]* @sha_info_digest, i32 0, i32 %i.01
  %3 = load i32* %2, align 4, !tbaa !1
  %4 = getelementptr inbounds [5 x i32]* @outData, i32 0, i32 %i.01
  %5 = load i32* %4, align 4, !tbaa !1
  %6 = icmp eq i32 %3, %5
  %7 = zext i1 %6 to i32
  %8 = add nsw i32 %7, %main_result.02
...
; <label>:10                                      ; preds = %1
  %.lcssa = phi i32 [ %8, %1 ]
  %11 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %.lcssa) #5
  %12 = icmp eq i32 %.lcssa, 5
  br i1 %12, label %13, label %15

; <label>:13                                      ; preds = %10
  %14 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #5
  br label %17

; <label>:15                                      ; preds = %10
  %16 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #5
  br label %17
