...
`define TAG_g_sha_info_digest `MEMORY_CONTROLLER_TAG_SIZE'd2
`define TAG_g_sha_info_digest_a {`TAG_g_sha_info_digest, 23'd64}
...
always @(*) begin
	...
	/*   %16 = load i32* getelementptr inbounds ([5 x i32]* @sha_info_digest, i32 0, i32 0), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_sha_transform_BB__15_12)) begin
		memory_controller_address_a = `TAG_g_sha_info_digest_a;
	end
	/* sha_transform: %15*/
	/*   %18 = load i32* getelementptr inbounds ([5 x i32]* @sha_info_digest, i32 0, i32 2), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_sha_transform_BB__15_13)) begin
		memory_controller_address_a = (`TAG_g_sha_info_digest_a | (4 * 32'd2));
	end
	/* sha_transform: %15*/
	/*   %20 = load i32* getelementptr inbounds ([5 x i32]* @sha_info_digest, i32 0, i32 4), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_sha_transform_BB__15_14)) begin
		memory_controller_address_a = (`TAG_g_sha_info_digest_a | (4 * 32'd4));
	end
	/* sha_transform: %82*/
	/*   store i32 %83, i32* getelementptr inbounds ([5 x i32]* @sha_info_digest, i32 0, i32 0), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_sha_transform_BB__82_31)) begin
...
always @(*) begin
	...
	/*   %17 = load i32* getelementptr inbounds ([5 x i32]* @sha_info_digest, i32 0, i32 1), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_sha_transform_BB__15_12)) begin
		memory_controller_address_b = (`TAG_g_sha_info_digest_a | (4 * 32'd1));
	end
	/* sha_transform: %15*/
	/*   %19 = load i32* getelementptr inbounds ([5 x i32]* @sha_info_digest, i32 0, i32 3), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_sha_transform_BB__15_13)) begin
		memory_controller_address_b = (`TAG_g_sha_info_digest_a | (4 * 32'd3));
	end
	/* sha_transform: %82*/
	/*   store i32 %84, i32* getelementptr inbounds ([5 x i32]* @sha_info_digest, i32 0, i32 1), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_sha_transform_BB__82_31)) begin
	...
	/*   store i32 %87, i32* getelementptr inbounds ([5 x i32]* @sha_info_digest, i32 0, i32 4), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_sha_transform_BB__82_33)) begin
		memory_controller_address_b = (`TAG_g_sha_info_digest_a | (4 * 32'd4));
	end
end
always @(*) begin
...
parameter [5:0] LEGUP_F_main_BB__34_31 = 6'd31;
parameter [5:0] LEGUP_F_main_BB__34_32 = 6'd32;
parameter [5:0] LEGUP_F_main_BB__34_33 = 6'd33;
parameter [5:0] LEGUP_F_main_BB__41_34 = 6'd34;
parameter [5:0] LEGUP_F_main_BB__44_35 = 6'd35;
parameter [5:0] LEGUP_F_main_BB__46_36 = 6'd36;
parameter [5:0] LEGUP_F_main_BB__48_37 = 6'd37;
parameter [8:0] tag_offset = 9'd0;
parameter [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] tag_addr_offset = {tag_offset, 23'd0};
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] main_preheaderlrphii_scevgep35;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] main_preheaderlrphii_scevgep35_reg;
...
reg [31:0] main_preheaderii_indvar8;
reg [31:0] main_preheaderii_indvar8_reg;
...
reg [31:0] main_9_indvar4;
reg [31:0] main_9_indvar4_reg;
reg [31:0] main_9_10;
reg [31:0] main_9_10_reg;
reg [31:0] main_9_11;
reg [31:0] main_9_11_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] main_9_scevgep10;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] main_9_scevgep10_reg;
reg [31:0] main_9_12;
reg [31:0] main_9_12_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] main_9_scevgep11;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] main_9_scevgep11_reg;
reg [31:0] main_9_13;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] main_9_scevgep13;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] main_9_scevgep13_reg;
...
reg  main_9_exitcond6;
reg  main_9_exitcond6_reg;
reg  main_memcpyexitii_29;
reg  main_memcpyexitii_29_reg;
reg [31:0] main_memcpyexitii_indvarnext9;
reg [31:0] main_memcpyexitii_indvarnext9_reg;
reg [31:0] main_sha_updateexiti_32;
reg [31:0] main_sha_updateexiti_32_reg;
reg  main_sha_updateexiti_exitcond26;
reg  main_sha_updateexiti_exitcond26_reg;
...
reg [31:0] main_34_main_result02;
reg [31:0] main_34_main_result02_reg;
reg [31:0] main_34_i01;
reg [31:0] main_34_i01_reg;
...
reg  main_34_exitcond1;
reg  main_34_exitcond1_reg;
reg  main_41_43;
reg  main_41_43_reg;
...
defparam outData.numwords_a = 5;
defparam outData.numwords_b = 5;
...
always @(posedge clk)
	...
	if ((cur_state == LEGUP_F_main_BB__41_34)) begin
		$write("Result: %d\n", $signed(main_34_39_reg));
		// to fix quartus warning
		if (reset == 1'b0 && ^(main_34_39_reg) === 1'bX) finish <= 0;
	end
	/* main: %44*/
	/*   %45 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #1*/
	if ((cur_state == LEGUP_F_main_BB__44_35)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %46*/
	/*   %47 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1*/
	if ((cur_state == LEGUP_F_main_BB__46_36)) begin
		$write("RESULT: FAIL\n");
	end
end
always @(posedge clk) begin
...
LEGUP_F_main_BB__34_31:
		next_state = LEGUP_F_main_BB__34_32;
LEGUP_F_main_BB__34_32:
		next_state = LEGUP_F_main_BB__34_33;
LEGUP_F_main_BB__34_33:
	if ((main_34_exitcond1_reg == 1'd1))
		next_state = LEGUP_F_main_BB__41_34;
	else if ((main_34_exitcond1_reg == 1'd0))
		next_state = LEGUP_F_main_BB__34_31;
LEGUP_F_main_BB__41_34:
	if ((main_41_43 == 1'd1))
		next_state = LEGUP_F_main_BB__44_35;
	else if ((main_41_43 == 1'd0))
		next_state = LEGUP_F_main_BB__46_36;
LEGUP_F_main_BB__44_35:
		next_state = LEGUP_F_main_BB__48_37;
LEGUP_F_main_BB__46_36:
		next_state = LEGUP_F_main_BB__48_37;
LEGUP_F_main_BB__48_37:
		next_state = LEGUP_0;
...
LEGUP_F_main_BB__9_13:
	if ((main_9_exitcond6_reg == 1'd1))
		next_state = LEGUP_F_main_BB_memcpyexitii_14;
	else if ((main_9_exitcond6_reg == 1'd0))
...
LEGUP_F_main_BB_sha_updateexiti_21:
	if ((main_sha_updateexiti_exitcond26 == 1'd1))
		next_state = LEGUP_F_main_BB_lrphi8preheaderii_22;
	else if ((main_sha_updateexiti_exitcond26 == 1'd0))
		next_state = LEGUP_F_main_BB_preheaderlrphii_5;
...
always @(*) begin
	...
	/* main: %.preheader.lr.ph.i.i*/
	/*   %j.02.i = phi i32 [ 0, %0 ], [ %32, %sha_update.exit.i ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB_sha_updateexiti_21) & (memory_controller_waitrequest == 1'd0)) & (main_sha_updateexiti_exitcond26 == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* main: %.preheader.lr.ph.i.i*/
	/*   %j.02.i = phi i32 [ 0, %0 ], [ %32, %sha_update.exit.i ]*/
	if ((((cur_state == LEGUP_F_main_BB_sha_updateexiti_21) & (memory_controller_waitrequest == 1'd0)) & (main_sha_updateexiti_exitcond26 == 1'd0))) begin
		main_preheaderlrphii_j02i_reg <= main_preheaderlrphii_j02i;
		if (start == 1'b0 && ^(main_preheaderlrphii_j02i) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_preheaderlrphii_j02i_reg"); $finish; end
	end
end
always @(*) begin
	...
	/*   %scevgep35 = getelementptr [2 x i32]* @in_i, i32 0, i32 %j.02.i*/
		main_preheaderlrphii_scevgep35 = (1'd0 | (4 * main_preheaderlrphii_j02i_reg));
end
always @(posedge clk) begin
	/* main: %.preheader.lr.ph.i.i*/
	/*   %scevgep35 = getelementptr [2 x i32]* @in_i, i32 0, i32 %j.02.i*/
	if ((cur_state == LEGUP_F_main_BB_preheaderlrphii_5)) begin
		main_preheaderlrphii_scevgep35_reg <= main_preheaderlrphii_scevgep35;
		if (start == 1'b0 && ^(main_preheaderlrphii_scevgep35) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_preheaderlrphii_scevgep35_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %.preheader.lr.ph.i.i*/
...
always @(posedge clk) begin
	...
	/*   %indvar8 = phi i32 [ %indvar.next9, %memcpy.exit.i.i ], [ 0, %.preheader.lr.ph.i.i ]*/
	if (((cur_state == LEGUP_F_main_BB_preheaderlrphii_6) & (memory_controller_waitrequest == 1'd0))) begin
		main_preheaderii_indvar8_reg <= main_preheaderii_indvar8;
		if (start == 1'b0 && ^(main_preheaderii_indvar8) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_preheaderii_indvar8_reg"); $finish; end
	end
	/* main: %.preheader.i.i*/
	/*   %indvar8 = phi i32 [ %indvar.next9, %memcpy.exit.i.i ], [ 0, %.preheader.lr.ph.i.i ]*/
...
always @(*) begin
	/* main: %.preheader.i.i*/
	/*   %3 = shl i32 %indvar8, 6*/
		main_preheaderii_3 = (main_preheaderii_indvar8_reg <<< (32'd6 % 32));
end
always @(posedge clk) begin
	/* main: %.preheader.i.i*/
	/*   %3 = shl i32 %indvar8, 6*/
...
always @(*) begin
	...
	if (((cur_state == LEGUP_F_main_BB_preheaderii_8) & (memory_controller_waitrequest == 1'd0))) begin
		main_9_indvar4 = 32'd0;
	end
	/* main: %9*/
	/*   %indvar4 = phi i32 [ %indvar.next5, %9 ], [ 0, %.preheader.i.i ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB__9_13) & (memory_controller_waitrequest == 1'd0)) & (main_9_exitcond6_reg == 1'd0))) */ begin
		main_9_indvar4 = main_9_indvarnext5_reg;
	end
end
always @(posedge clk) begin
	/* main: %9*/
	/*   %indvar4 = phi i32 [ %indvar.next5, %9 ], [ 0, %.preheader.i.i ]*/
	if (((cur_state == LEGUP_F_main_BB_preheaderii_8) & (memory_controller_waitrequest == 1'd0))) begin
		main_9_indvar4_reg <= main_9_indvar4;
		if (start == 1'b0 && ^(main_9_indvar4) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_9_indvar4_reg"); $finish; end
	end
	/* main: %9*/
	/*   %indvar4 = phi i32 [ %indvar.next5, %9 ], [ 0, %.preheader.i.i ]*/
	if ((((cur_state == LEGUP_F_main_BB__9_13) & (memory_controller_waitrequest == 1'd0)) & (main_9_exitcond6_reg == 1'd0))) begin
		main_9_indvar4_reg <= main_9_indvar4;
		if (start == 1'b0 && ^(main_9_indvar4) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_9_indvar4_reg"); $finish; end
	end
end
always @(*) begin
	...
	/*   %10 = shl i32 %indvar4, 2*/
		main_9_10 = (main_9_indvar4_reg <<< (32'd2 % 32));
end
always @(posedge clk) begin
	/* main: %9*/
	/*   %10 = shl i32 %indvar4, 2*/
...
always @(*) begin
	...
	/*   %scevgep10 = getelementptr [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 %11*/
		main_9_scevgep10 = (1'd0 | ((8192 * main_preheaderlrphii_j02i_reg) + (1 * main_9_11_reg)));
end
always @(posedge clk) begin
	/* main: %9*/
	/*   %scevgep10 = getelementptr [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 %11*/
	if ((cur_state == LEGUP_F_main_BB__9_10)) begin
		main_9_scevgep10_reg <= main_9_scevgep10;
		if (start == 1'b0 && ^(main_9_scevgep10) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_9_scevgep10_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %9*/
...
always @(*) begin
	...
	/*   %scevgep11 = getelementptr [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 %12*/
		main_9_scevgep11 = (1'd0 | ((8192 * main_preheaderlrphii_j02i_reg) + (1 * main_9_12_reg)));
end
always @(posedge clk) begin
	/* main: %9*/
	/*   %scevgep11 = getelementptr [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 %12*/
	if ((cur_state == LEGUP_F_main_BB__9_10)) begin
		main_9_scevgep11_reg <= main_9_scevgep11;
		if (start == 1'b0 && ^(main_9_scevgep11) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_9_scevgep11_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %9*/
...
always @(*) begin
	...
	/*   %scevgep13 = getelementptr [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 %14*/
		main_9_scevgep13 = (1'd0 | ((8192 * main_preheaderlrphii_j02i_reg) + (1 * main_9_14_reg)));
end
always @(posedge clk) begin
	/* main: %9*/
	/*   %scevgep13 = getelementptr [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 %14*/
	if ((cur_state == LEGUP_F_main_BB__9_10)) begin
		main_9_scevgep13_reg <= main_9_scevgep13;
		if (start == 1'b0 && ^(main_9_scevgep13) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_9_scevgep13_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %9*/
	/*   %p1.02.i.i.i = getelementptr [16 x i32]* @sha_info_data, i32 0, i32 %indvar4*/
		main_9_p102iii = (`TAG_g_sha_info_data_a | (4 * main_9_indvar4_reg));
end
always @(posedge clk) begin
	/* main: %9*/
	/*   %p1.02.i.i.i = getelementptr [16 x i32]* @sha_info_data, i32 0, i32 %indvar4*/
...
always @(*) begin
	...
	/*   %indvar.next5 = add i32 %indvar4, 1*/
		main_9_indvarnext5 = (main_9_indvar4_reg + 32'd1);
end
always @(posedge clk) begin
	/* main: %9*/
	/*   %indvar.next5 = add i32 %indvar4, 1*/
...
always @(*) begin
	...
	/*   %exitcond6 = icmp eq i32 %indvar.next5, 16*/
		main_9_exitcond6 = (main_9_indvarnext5 == 32'd16);
end
always @(posedge clk) begin
	/* main: %9*/
	/*   %exitcond6 = icmp eq i32 %indvar.next5, 16*/
	if ((cur_state == LEGUP_F_main_BB__9_9)) begin
		main_9_exitcond6_reg <= main_9_exitcond6;
		if (start == 1'b0 && ^(main_9_exitcond6) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_9_exitcond6_reg"); $finish; end
	end
end
always @(*) begin
...
always @(*) begin
	/* main: %memcpy.exit.i.i*/
	/*   %indvar.next9 = add i32 %indvar8, 1*/
		main_memcpyexitii_indvarnext9 = (main_preheaderii_indvar8_reg + 32'd1);
end
always @(posedge clk) begin
	/* main: %memcpy.exit.i.i*/
	/*   %indvar.next9 = add i32 %indvar8, 1*/
	if ((cur_state == LEGUP_F_main_BB_memcpyexitii_14)) begin
		main_memcpyexitii_indvarnext9_reg <= main_memcpyexitii_indvarnext9;
		if (start == 1'b0 && ^(main_memcpyexitii_indvarnext9) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_memcpyexitii_indvarnext9_reg"); $finish; end
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %exitcond26 = icmp eq i32 %32, 2*/
		main_sha_updateexiti_exitcond26 = (main_sha_updateexiti_32 == 32'd2);
end
always @(posedge clk) begin
	/* main: %sha_update.exit.i*/
	/*   %exitcond26 = icmp eq i32 %32, 2*/
	if ((cur_state == LEGUP_F_main_BB_sha_updateexiti_21)) begin
		main_sha_updateexiti_exitcond26_reg <= main_sha_updateexiti_exitcond26;
		if (start == 1'b0 && ^(main_sha_updateexiti_exitcond26) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_sha_updateexiti_exitcond26_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %.lr.ph.i8.i.i*/
...
always @(*) begin
	...
	if (((cur_state == LEGUP_F_main_BB_sha_streamexit_30) & (memory_controller_waitrequest == 1'd0))) begin
		main_34_main_result02 = 32'd0;
	end
	/* main: %34*/
	/*   %main_result.02 = phi i32 [ 0, %sha_stream.exit ], [ %39, %34 ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB__34_33) & (memory_controller_waitrequest == 1'd0)) & (main_34_exitcond1_reg == 1'd0))) */ begin
		main_34_main_result02 = main_34_39;
	end
end
always @(posedge clk) begin
	/* main: %34*/
	/*   %main_result.02 = phi i32 [ 0, %sha_stream.exit ], [ %39, %34 ]*/
	if (((cur_state == LEGUP_F_main_BB_sha_streamexit_30) & (memory_controller_waitrequest == 1'd0))) begin
		main_34_main_result02_reg <= main_34_main_result02;
		if (start == 1'b0 && ^(main_34_main_result02) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_34_main_result02_reg"); $finish; end
	end
	/* main: %34*/
	/*   %main_result.02 = phi i32 [ 0, %sha_stream.exit ], [ %39, %34 ]*/
	if ((((cur_state == LEGUP_F_main_BB__34_33) & (memory_controller_waitrequest == 1'd0)) & (main_34_exitcond1_reg == 1'd0))) begin
		main_34_main_result02_reg <= main_34_main_result02;
		if (start == 1'b0 && ^(main_34_main_result02) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_34_main_result02_reg"); $finish; end
	end
end
...
always @(posedge clk) begin
	...
	/*   %i.01 = phi i32 [ 0, %sha_stream.exit ], [ %40, %34 ]*/
	if (((cur_state == LEGUP_F_main_BB_sha_streamexit_30) & (memory_controller_waitrequest == 1'd0))) begin
		main_34_i01_reg <= main_34_i01;
		if (start == 1'b0 && ^(main_34_i01) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_34_i01_reg"); $finish; end
	end
	/* main: %34*/
	/*   %i.01 = phi i32 [ 0, %sha_stream.exit ], [ %40, %34 ]*/
	if ((((cur_state == LEGUP_F_main_BB__34_33) & (memory_controller_waitrequest == 1'd0)) & (main_34_exitcond1_reg == 1'd0))) begin
...
always @(*) begin
	...
	/*   %scevgep = getelementptr [5 x i32]* @outData, i32 0, i32 %i.01*/
		main_34_scevgep = (1'd0 | (4 * main_34_i01_reg));
end
always @(posedge clk) begin
	/* main: %34*/
	/*   %scevgep = getelementptr [5 x i32]* @outData, i32 0, i32 %i.01*/
	if ((cur_state == LEGUP_F_main_BB__34_31)) begin
...
always @(*) begin
	...
	/*   %scevgep2 = getelementptr [5 x i32]* @sha_info_digest, i32 0, i32 %i.01*/
		main_34_scevgep2 = (`TAG_g_sha_info_digest_a | (4 * main_34_i01_reg));
end
always @(posedge clk) begin
	/* main: %34*/
	/*   %scevgep2 = getelementptr [5 x i32]* @sha_info_digest, i32 0, i32 %i.01*/
...
always @(*) begin
	...
	/*   %35 = load i32* %scevgep2, align 4, !tbaa !1*/
		main_34_35 = memory_controller_out_b[31:0];
end
always @(posedge clk) begin
	/* main: %34*/
	/*   %35 = load i32* %scevgep2, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__34_33)) begin
...
always @(*) begin
	...
	/*   %36 = load i32* %scevgep, align 4, !tbaa !1*/
		main_34_36 = outData_out_a;
end
always @(posedge clk) begin
	/* main: %34*/
	/*   %36 = load i32* %scevgep, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__34_32)) begin
...
always @(*) begin
	...
	/*   %37 = icmp eq i32 %35, %36*/
		main_34_37 = (main_34_35 == main_34_36_reg);
end
always @(posedge clk) begin
	/* main: %34*/
	/*   %37 = icmp eq i32 %35, %36*/
...
always @(*) begin
	...
	/*   %39 = add nsw i32 %38, %main_result.02*/
		main_34_39 = (main_34_38 + main_34_main_result02_reg);
end
always @(posedge clk) begin
	/* main: %34*/
	/*   %39 = add nsw i32 %38, %main_result.02*/
...
always @(*) begin
	...
	/*   %40 = add nsw i32 %i.01, 1*/
		main_34_40 = (main_34_i01_reg + 32'd1);
end
always @(posedge clk) begin
	/* main: %34*/
	/*   %40 = add nsw i32 %i.01, 1*/
...
always @(*) begin
	...
	/*   %exitcond1 = icmp eq i32 %40, 5*/
		main_34_exitcond1 = (main_34_40 == 32'd5);
end
always @(posedge clk) begin
	/* main: %34*/
	/*   %exitcond1 = icmp eq i32 %40, 5*/
	if ((cur_state == LEGUP_F_main_BB__34_31)) begin
		main_34_exitcond1_reg <= main_34_exitcond1;
		if (start == 1'b0 && ^(main_34_exitcond1) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_34_exitcond1_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %41*/
	/*   %43 = icmp eq i32 %39, 5*/
		main_41_43 = (main_34_39_reg == 32'd5);
end
always @(posedge clk) begin
	/* main: %41*/
	/*   %43 = icmp eq i32 %39, 5*/
...
always @(*) begin
	...
	/*   %21 = load i8* %scevgep11, align 1, !tbaa !5*/
	if ((cur_state == LEGUP_F_main_BB__9_11)) begin
		indata_address_a = (main_9_scevgep11_reg >>> 3'd0);
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %17 = load i8* %scevgep13, align 1, !tbaa !5*/
	if ((cur_state == LEGUP_F_main_BB__9_10)) begin
		indata_address_b = (main_9_scevgep13 >>> 3'd0);
	end
	/* main: %9*/
	/*   %25 = load i8* %scevgep10, align 1, !tbaa !5*/
	if ((cur_state == LEGUP_F_main_BB__9_11)) begin
		indata_address_b = (main_9_scevgep10_reg >>> 3'd0);
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %1 = load i32* %scevgep35, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_preheaderlrphii_5)) begin
		in_i_address_a = (main_preheaderlrphii_scevgep35 >>> 3'd2);
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %36 = load i32* %scevgep, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__34_31)) begin
		outData_address_a = (main_34_scevgep >>> 3'd2);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_preheaderii_7_en == 1'd1)) begin
		main_preheaderii_7_stage0_reg <= (main_preheaderii_indvar8_reg * -32'd64);
	end
end
always @(posedge clk) begin
	if ((cur_state == LEGUP_0)) begin
	...
	/* main: %48*/
	/*   ret i32 %39*/
	if ((cur_state == LEGUP_F_main_BB__48_37)) begin
		finish <= (memory_controller_waitrequest == 1'd0);
		if (start == 1'b0 && ^((memory_controller_waitrequest == 1'd0)) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to finish"); $finish; end
	end
end
...
always @(*) begin
	...
	/*   %35 = load i32* %scevgep2, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__34_31)) begin
		memory_controller_address_b = main_34_scevgep2;
	end
end
always @(*) begin
	memory_controller_write_enable_b = 1'd0;
...
always @(posedge clk) begin
	...
	/*   ret i32 %39*/
	if ((cur_state == LEGUP_F_main_BB__48_37)) begin
		return_val <= main_34_39_reg;
		if (start == 1'b0 && ^(main_34_39_reg) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to return_val"); $finish; end
	end
end
