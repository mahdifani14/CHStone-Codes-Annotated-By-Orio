; ModuleID = 'sha_driver.postlto.8.bc'
...
@sha_info_digest = internal unnamed_addr global [5 x i32] zeroinitializer, align 4
@sha_info_data = internal unnamed_addr global [16 x i32] zeroinitializer, align 4
@outData = internal unnamed_addr constant [5 x i32] [i32 6969911, i32 -1814260603, i32 742465810, i32 1677179459, i32 -1384908510], align 4
...
._crit_edge10.i.i:                                ; preds = %sha_update.exit.i, %0
  %sha_info_count_hi.0 = phi i32 [ 0, %0 ], [ %8, %sha_update.exit.i ]
  %sha_info_count_lo.0 = phi i32 [ 0, %0 ], [ %6, %sha_update.exit.i ]
  %j.02.i = phi i32 [ 0, %0 ], [ %64, %sha_update.exit.i ]
  %1 = getelementptr inbounds [2 x i32]* @in_i, i32 0, i32 %j.02.i
  %2 = load i32* %1, align 4, !tbaa !1
  %3 = getelementptr inbounds [2 x [8192 x i8]]* @indata, i32 0, i32 %j.02.i, i32 0
  %4 = shl i32 %2, 3
  %overflow_intrinsic = zext i32 %sha_info_count_lo.0 to i33
  %overflow_intrinsic1 = zext i32 %4 to i33
  ...
  %5 = add i32 %sha_info_count_hi.0, 1
  %.sha_info_count_hi.0 = select i1 %overflow_intrinsic_carry, i32 %5, i32 %sha_info_count_hi.0
  %6 = add i32 %sha_info_count_lo.0, %4
  %7 = lshr i32 %2, 29
  %8 = add i32 %.sha_info_count_hi.0, %7
  %9 = icmp sgt i32 %2, 63
  br i1 %9, label %.preheader.lr.ph.i.i, label %39

.preheader.lr.ph.i.i:                             ; preds = %._crit_edge10.i.i
  %10 = add i32 %2, -64
  br label %.preheader.i.i

.preheader.i.i:                                   ; preds = %memcpy.exit.i.i, %.preheader.lr.ph.i.i
  %.07.i.i = phi i32 [ %2, %.preheader.lr.ph.i.i ], [ %34, %memcpy.exit.i.i ]
  %.016.i.i = phi i8* [ %3, %.preheader.lr.ph.i.i ], [ %33, %memcpy.exit.i.i ]
  br label %11

; <label>:11                                      ; preds = %11, %.preheader.i.i
  %m.03.i.i.i = phi i32 [ %12, %11 ], [ 16, %.preheader.i.i ]
  %p1.02.i.i.i = phi i32* [ %31, %11 ], [ getelementptr inbounds ([16 x i32]* @sha_info_data, i32 0, i32 0), %.preheader.i.i ]
  %p2.01.i.i.i = phi i8* [ %26, %11 ], [ %.016.i.i, %.preheader.i.i ]
  %12 = add nsw i32 %m.03.i.i.i, -1
  %13 = getelementptr inbounds i8* %p2.01.i.i.i, i32 1
  %14 = load i8* %p2.01.i.i.i, align 1, !tbaa !5
  %15 = zext i8 %14 to i32
  %16 = getelementptr inbounds i8* %p2.01.i.i.i, i32 2
  %17 = load i8* %13, align 1, !tbaa !5
  %18 = zext i8 %17 to i32
  %19 = shl nuw nsw i32 %18, 8
  %20 = or i32 %19, %15
  %21 = getelementptr inbounds i8* %p2.01.i.i.i, i32 3
  %22 = load i8* %16, align 1, !tbaa !5
  %23 = zext i8 %22 to i32
  %24 = shl nuw nsw i32 %23, 16
  %25 = or i32 %20, %24
  %26 = getelementptr inbounds i8* %p2.01.i.i.i, i32 4
  %27 = load i8* %21, align 1, !tbaa !5
  %28 = zext i8 %27 to i32
  %29 = shl nuw i32 %28, 24
  %30 = or i32 %25, %29
  store i32 %30, i32* %p1.02.i.i.i, align 4, !tbaa !1
  %31 = getelementptr inbounds i32* %p1.02.i.i.i, i32 1
  %32 = icmp sgt i32 %12, 0
  br i1 %32, label %11, label %memcpy.exit.i.i

memcpy.exit.i.i:                                  ; preds = %11
  tail call fastcc void @sha_transform() #1
  %33 = getelementptr inbounds i8* %.016.i.i, i32 64
  %34 = add nsw i32 %.07.i.i, -64
  %35 = icmp sgt i32 %34, 63
  br i1 %35, label %.preheader.i.i, label %._crit_edge.i.i

._crit_edge.i.i:                                  ; preds = %memcpy.exit.i.i
  %36 = and i32 %10, -64
  %37 = add i32 %36, 64
  %38 = sub i32 %10, %36
  %scevgep.i.i = getelementptr i8* %3, i32 %37
  br label %39

; <label>:39                                      ; preds = %._crit_edge.i.i, %._crit_edge10.i.i
  %.0.lcssa.i.i = phi i32 [ %38, %._crit_edge.i.i ], [ %2, %._crit_edge10.i.i ]
  %.01.lcssa.i.i = phi i8* [ %scevgep.i.i, %._crit_edge.i.i ], [ %3, %._crit_edge10.i.i ]
  %40 = icmp sgt i32 %.0.lcssa.i.i, 3
  br i1 %40, label %.lr.ph.i.i1.i, label %sha_update.exit.i

.lr.ph.i.i1.i:                                    ; preds = %39
  %41 = sdiv i32 %.0.lcssa.i.i, 4
  br label %42

; <label>:42                                      ; preds = %42, %.lr.ph.i.i1.i
  %m.03.i2.i.i = phi i32 [ %41, %.lr.ph.i.i1.i ], [ %43, %42 ]
  %p1.02.i3.i.i = phi i32* [ getelementptr inbounds ([16 x i32]* @sha_info_data, i32 0, i32 0), %.lr.ph.i.i1.i ], [ %62, %42 ]
  %p2.01.i4.i.i = phi i8* [ %.01.lcssa.i.i, %.lr.ph.i.i1.i ], [ %57, %42 ]
  %43 = add nsw i32 %m.03.i2.i.i, -1
  %44 = getelementptr inbounds i8* %p2.01.i4.i.i, i32 1
  %45 = load i8* %p2.01.i4.i.i, align 1, !tbaa !5
  %46 = zext i8 %45 to i32
  %47 = getelementptr inbounds i8* %p2.01.i4.i.i, i32 2
  %48 = load i8* %44, align 1, !tbaa !5
  %49 = zext i8 %48 to i32
  %50 = shl nuw nsw i32 %49, 8
  %51 = or i32 %50, %46
  %52 = getelementptr inbounds i8* %p2.01.i4.i.i, i32 3
  %53 = load i8* %47, align 1, !tbaa !5
  %54 = zext i8 %53 to i32
  %55 = shl nuw nsw i32 %54, 16
  %56 = or i32 %51, %55
  %57 = getelementptr inbounds i8* %p2.01.i4.i.i, i32 4
  %58 = load i8* %52, align 1, !tbaa !5
  %59 = zext i8 %58 to i32
  %60 = shl nuw i32 %59, 24
  %61 = or i32 %56, %60
  store i32 %61, i32* %p1.02.i3.i.i, align 4, !tbaa !1
  %62 = getelementptr inbounds i32* %p1.02.i3.i.i, i32 1
  %63 = icmp sgt i32 %43, 0
  br i1 %63, label %42, label %sha_update.exit.i

sha_update.exit.i:                                ; preds = %42, %39
  %64 = add nsw i32 %j.02.i, 1
  %exitcond.i = icmp eq i32 %64, 2
  br i1 %exitcond.i, label %.lr.ph.i8.preheader.i.i, label %._crit_edge10.i.i

.lr.ph.i8.preheader.i.i:                          ; preds = %sha_update.exit.i
  store i32 128, i32* getelementptr inbounds ([16 x i32]* @sha_info_data, i32 0, i32 0), align 4, !tbaa !1
  br label %.lr.ph.i8.i.i

.lr.ph.i8.i.i:                                    ; preds = %.lr.ph.i8.i.i, %.lr.ph.i8.preheader.i.i
  %m.02.i6.i.i = phi i32 [ %65, %.lr.ph.i8.i.i ], [ 13, %.lr.ph.i8.preheader.i.i ]
  %p.11.i7.i.i = phi i32* [ %66, %.lr.ph.i8.i.i ], [ getelementptr inbounds ([16 x i32]* @sha_info_data, i32 0, i32 1), %.lr.ph.i8.preheader.i.i ]
  %65 = add nsw i32 %m.02.i6.i.i, -1
  %66 = getelementptr inbounds i32* %p.11.i7.i.i, i32 1
  store i32 0, i32* %p.11.i7.i.i, align 4, !tbaa !1
  %67 = icmp sgt i32 %65, 0
  br i1 %67, label %.lr.ph.i8.i.i, label %sha_stream.exit

sha_stream.exit:                                  ; preds = %.lr.ph.i8.i.i
...
; <label>:68                                      ; preds = %68, %sha_stream.exit
  %main_result.02 = phi i32 [ 0, %sha_stream.exit ], [ %75, %68 ]
  %i.01 = phi i32 [ 0, %sha_stream.exit ], [ %76, %68 ]
  %69 = getelementptr inbounds [5 x i32]* @sha_info_digest, i32 0, i32 %i.01
  %70 = load i32* %69, align 4, !tbaa !1
  %71 = getelementptr inbounds [5 x i32]* @outData, i32 0, i32 %i.01
  %72 = load i32* %71, align 4, !tbaa !1
  %73 = icmp eq i32 %70, %72
  %74 = zext i1 %73 to i32
  %75 = add nsw i32 %74, %main_result.02
  %76 = add nsw i32 %i.01, 1
  %exitcond = icmp eq i32 %76, 5
  br i1 %exitcond, label %77, label %68

; <label>:77                                      ; preds = %68
  %.lcssa = phi i32 [ %75, %68 ]
  %78 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %.lcssa) #1
  %79 = icmp eq i32 %.lcssa, 5
  br i1 %79, label %80, label %82

; <label>:80                                      ; preds = %77
  %81 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #1
  br label %84

; <label>:82                                      ; preds = %77
  %83 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1
  br label %84
...
; <label>:1                                       ; preds = %1, %0
  %i.029 = phi i32 [ 0, %0 ], [ %5, %1 ]
  %2 = getelementptr inbounds [16 x i32]* @sha_info_data, i32 0, i32 %i.029
  %3 = load i32* %2, align 4, !tbaa !1
  %4 = getelementptr inbounds [80 x i32]* %W, i32 0, i32 %i.029
  store i32 %3, i32* %4, align 4, !tbaa !1
  %5 = add nsw i32 %i.029, 1
  %exitcond41 = icmp eq i32 %5, 16
  br i1 %exitcond41, label %.preheader3.preheader, label %1

.preheader3.preheader:                            ; preds = %1
  %6 = bitcast [80 x i32]* %W to i8*
  br label %.preheader3
...
; <label>:30                                      ; preds = %30, %24
  ...
  br i1 %exitcond39, label %.preheader2, label %30

.preheader2:                                      ; preds = %.preheader2, %30
  %E.121 = phi i32 [ %D.120, %.preheader2 ], [ %D.026, %30 ]
  %D.120 = phi i32 [ %C.119, %.preheader2 ], [ %C.025, %30 ]
  %C.119 = phi i32 [ %61, %.preheader2 ], [ %46, %30 ]
  %B.118 = phi i32 [ %A.117, %.preheader2 ], [ %A.023, %30 ]
  %A.117 = phi i32 [ %58, %.preheader2 ], [ %43, %30 ]
  %i.316 = phi i32 [ %62, %.preheader2 ], [ 20, %30 ]
  %48 = shl i32 %A.117, 5
  ...
  br i1 %exitcond38, label %.preheader1, label %.preheader2

.preheader1:                                      ; preds = %.preheader1, %.preheader2
  %E.215 = phi i32 [ %D.214, %.preheader1 ], [ %D.120, %.preheader2 ]
  %D.214 = phi i32 [ %C.213, %.preheader1 ], [ %C.119, %.preheader2 ]
  %C.213 = phi i32 [ %78, %.preheader1 ], [ %61, %.preheader2 ]
  %B.212 = phi i32 [ %A.211, %.preheader1 ], [ %A.117, %.preheader2 ]
  %A.211 = phi i32 [ %75, %.preheader1 ], [ %58, %.preheader2 ]
  %i.410 = phi i32 [ %79, %.preheader1 ], [ 40, %.preheader2 ]
  %63 = shl i32 %A.211, 5
  ...
  br i1 %exitcond37, label %.preheader, label %.preheader1

.preheader:                                       ; preds = %.preheader, %.preheader1
  %E.39 = phi i32 [ %D.38, %.preheader ], [ %D.214, %.preheader1 ]
  %D.38 = phi i32 [ %C.37, %.preheader ], [ %C.213, %.preheader1 ]
  %C.37 = phi i32 [ %93, %.preheader ], [ %78, %.preheader1 ]
  %B.36 = phi i32 [ %A.35, %.preheader ], [ %A.211, %.preheader1 ]
  %A.35 = phi i32 [ %90, %.preheader ], [ %75, %.preheader1 ]
  %i.54 = phi i32 [ %94, %.preheader ], [ 60, %.preheader1 ]
  %80 = shl i32 %A.35, 5
  %81 = lshr i32 %A.35, 27
  %82 = or i32 %80, %81
