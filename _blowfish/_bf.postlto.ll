...
; <label>:1                                       ; preds = %1, %0
  %i.07.i = phi i32 [ 0, %0 ], [ %4, %1 ]
  %2 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 %i.07.i
  store i8 0, i8* %2, align 1, !tbaa !5
  %3 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 %i.07.i
  store i8 0, i8* %3, align 1, !tbaa !5
  %4 = add nsw i32 %i.07.i, 1
  %exitcond9.i = icmp eq i32 %4, 8
  br i1 %exitcond9.i, label %.lr.ph.i.i.i, label %1

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i, %1
  %p2.03.i.i.i = phi i32* [ %8, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @bf_init_P, i32 0, i32 0), %1 ]
  %p1.02.i.i.i = phi i32* [ %7, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @key_P, i32 0, i32 0), %1 ]
  %.01.i.i.i = phi i32 [ %5, %.lr.ph.i.i.i ], [ 18, %1 ]
  %5 = add nsw i32 %.01.i.i.i, -1
  %6 = load i32* %p2.03.i.i.i, align 4, !tbaa !1
  store i32 %6, i32* %p1.02.i.i.i, align 4, !tbaa !1
  %7 = getelementptr inbounds i32* %p1.02.i.i.i, i32 1
  %8 = getelementptr inbounds i32* %p2.03.i.i.i, i32 1
  %9 = icmp sgt i32 %5, 0
  br i1 %9, label %.lr.ph.i.i.i, label %.lr.ph.i4.i.i

.lr.ph.i4.i.i:                                    ; preds = %.lr.ph.i4.i.i, %.lr.ph.i.i.i
  %p2.03.i1.i.i = phi i32* [ %13, %.lr.ph.i4.i.i ], [ getelementptr inbounds ([1024 x i32]* @bf_init_S, i32 0, i32 0), %.lr.ph.i.i.i ]
  %p1.02.i2.i.i = phi i32* [ %12, %.lr.ph.i4.i.i ], [ getelementptr inbounds ([1024 x i32]* @key_S, i32 0, i32 0), %.lr.ph.i.i.i ]
  %.01.i3.i.i = phi i32 [ %10, %.lr.ph.i4.i.i ], [ 1024, %.lr.ph.i.i.i ]
  %10 = add nsw i32 %.01.i3.i.i, -1
  %11 = load i32* %p2.03.i1.i.i, align 4, !tbaa !1
  store i32 %11, i32* %p1.02.i2.i.i, align 4, !tbaa !1
  %12 = getelementptr inbounds i32* %p1.02.i2.i.i, i32 1
  %13 = getelementptr inbounds i32* %p2.03.i1.i.i, i32 1
  %14 = icmp sgt i32 %10, 0
  br i1 %14, label %.lr.ph.i4.i.i, label %memcpy.exit5.i.i

memcpy.exit5.i.i:                                 ; preds = %.lr.ph.i4.i.i
  %15 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 0
  %16 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 8
  br label %17

; <label>:17                                      ; preds = %17, %memcpy.exit5.i.i
  %d.05.i.i = phi i8* [ %15, %memcpy.exit5.i.i ], [ %d.4.i.i, %17 ]
  %i.04.i.i = phi i32 [ 0, %memcpy.exit5.i.i ], [ %43, %17 ]
  %18 = getelementptr inbounds i8* %d.05.i.i, i32 1
  %19 = load i8* %d.05.i.i, align 1, !tbaa !5
  %20 = zext i8 %19 to i32
  %21 = icmp ult i8* %18, %16
  %.data.i.i = select i1 %21, i8* %18, i8* %15
  %22 = shl nuw nsw i32 %20, 8
  %23 = getelementptr inbounds i8* %.data.i.i, i32 1
  %24 = load i8* %.data.i.i, align 1, !tbaa !5
  %25 = zext i8 %24 to i32
  %26 = or i32 %22, %25
  %27 = icmp ult i8* %23, %16
  %d.2.i.i = select i1 %27, i8* %23, i8* %15
  %28 = shl nuw nsw i32 %26, 8
  %29 = getelementptr inbounds i8* %d.2.i.i, i32 1
  %30 = load i8* %d.2.i.i, align 1, !tbaa !5
  %31 = zext i8 %30 to i32
  %32 = or i32 %28, %31
  %33 = icmp ult i8* %29, %16
  %.data1.i.i = select i1 %33, i8* %29, i8* %15
  %34 = shl nuw i32 %32, 8
  %35 = getelementptr inbounds i8* %.data1.i.i, i32 1
  %36 = load i8* %.data1.i.i, align 1, !tbaa !5
  %37 = zext i8 %36 to i32
  %38 = or i32 %34, %37
  %39 = icmp ult i8* %35, %16
  %d.4.i.i = select i1 %39, i8* %35, i8* %15
  %40 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %i.04.i.i
  %41 = load i32* %40, align 4, !tbaa !1
  %42 = xor i32 %38, %41
  store i32 %42, i32* %40, align 4, !tbaa !1
  %43 = add nsw i32 %i.04.i.i, 1
  %exitcond.i.i = icmp eq i32 %43, 18
  br i1 %exitcond.i.i, label %44, label %17

; <label>:44                                      ; preds = %17
  %45 = getelementptr inbounds [2 x i32]* %in.i.i, i32 0, i32 0
  store i32 0, i32* %45, align 4, !tbaa !1
  %46 = getelementptr inbounds [2 x i32]* %in.i.i, i32 0, i32 1
  store i32 0, i32* %46, align 4, !tbaa !1
  br label %47

; <label>:47                                      ; preds = %47, %44
  %i.13.i.i = phi i32 [ 0, %44 ], [ %53, %47 ]
  call fastcc void @BF_encrypt(i32* %45) #1
  %48 = load i32* %45, align 4, !tbaa !1
  %49 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %i.13.i.i
  store i32 %48, i32* %49, align 4, !tbaa !1
  %50 = load i32* %46, align 4, !tbaa !1
  %51 = or i32 %i.13.i.i, 1
  %52 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %51
  store i32 %50, i32* %52, align 4, !tbaa !1
  %53 = add nsw i32 %i.13.i.i, 2
  %54 = icmp slt i32 %53, 18
  br i1 %54, label %47, label %.preheader.i.i

.preheader.i.i:                                   ; preds = %.preheader.i.i, %47
  %i.22.i.i = phi i32 [ %60, %.preheader.i.i ], [ 0, %47 ]
  call fastcc void @BF_encrypt(i32* %45) #1
  %55 = load i32* %45, align 4, !tbaa !1
  %56 = getelementptr inbounds [1024 x i32]* @key_S, i32 0, i32 %i.22.i.i
  store i32 %55, i32* %56, align 4, !tbaa !1
  %57 = load i32* %46, align 4, !tbaa !1
  %58 = or i32 %i.22.i.i, 1
  %59 = getelementptr inbounds [1024 x i32]* @key_S, i32 0, i32 %58
  store i32 %57, i32* %59, align 4, !tbaa !1
  %60 = add nsw i32 %i.22.i.i, 2
  %61 = icmp slt i32 %60, 1024
  br i1 %61, label %.preheader.i.i, label %BF_set_key.exit.i

BF_set_key.exit.i:                                ; preds = %.preheader.i.i
  %62 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 0
  %63 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 1
  %64 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 2
  %65 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 3
  %66 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 4
  %67 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 5
  %68 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 6
  %69 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 7
  br label %.loopexit.i

.loopexit.i:                                      ; preds = %BF_cfb64_encrypt.exit.i, %BF_set_key.exit.i
  %num.i.0 = phi i32 [ 0, %BF_set_key.exit.i ], [ %122, %BF_cfb64_encrypt.exit.i ]
  %k.06.i = phi i32 [ 0, %BF_set_key.exit.i ], [ %128, %BF_cfb64_encrypt.exit.i ]
  %check.05.i = phi i32 [ 0, %BF_set_key.exit.i ], [ %127, %BF_cfb64_encrypt.exit.i ]
  %70 = getelementptr inbounds [5200 x i8]* @in_key, i32 0, i32 %k.06.i
  %71 = load i8* %70, align 1, !tbaa !5
  %72 = icmp eq i32 %num.i.0, 0
  br i1 %72, label %73, label %BF_cfb64_encrypt.exit.i

; <label>:73                                      ; preds = %.loopexit.i
  %74 = load i8* %62, align 1, !tbaa !5
  %75 = zext i8 %74 to i32
  %76 = shl nuw i32 %75, 24
  %77 = load i8* %63, align 1, !tbaa !5
  %78 = zext i8 %77 to i32
  %79 = shl nuw nsw i32 %78, 16
  %80 = or i32 %79, %76
  %81 = load i8* %64, align 1, !tbaa !5
  %82 = zext i8 %81 to i32
  %83 = shl nuw nsw i32 %82, 8
  %84 = or i32 %80, %83
  %85 = load i8* %65, align 1, !tbaa !5
  %86 = zext i8 %85 to i32
  %87 = or i32 %84, %86
  store i32 %87, i32* %45, align 4, !tbaa !1
  %88 = load i8* %66, align 1, !tbaa !5
  %89 = zext i8 %88 to i32
  %90 = shl nuw i32 %89, 24
  %91 = load i8* %67, align 1, !tbaa !5
  %92 = zext i8 %91 to i32
  %93 = shl nuw nsw i32 %92, 16
  %94 = or i32 %93, %90
  %95 = load i8* %68, align 1, !tbaa !5
  %96 = zext i8 %95 to i32
  %97 = shl nuw nsw i32 %96, 8
  %98 = or i32 %94, %97
  %99 = load i8* %69, align 1, !tbaa !5
  %100 = zext i8 %99 to i32
  %101 = or i32 %98, %100
  store i32 %101, i32* %46, align 4, !tbaa !1
  call fastcc void @BF_encrypt(i32* %45) #1
  %102 = load i32* %45, align 4, !tbaa !1
  %103 = lshr i32 %102, 24
  %104 = trunc i32 %103 to i8
  store i8 %104, i8* %62, align 1, !tbaa !5
  %105 = lshr i32 %102, 16
  %106 = trunc i32 %105 to i8
  store i8 %106, i8* %63, align 1, !tbaa !5
  %107 = lshr i32 %102, 8
  %108 = trunc i32 %107 to i8
  store i8 %108, i8* %64, align 1, !tbaa !5
  %109 = trunc i32 %102 to i8
  store i8 %109, i8* %65, align 1, !tbaa !5
  %110 = load i32* %46, align 4, !tbaa !1
  %111 = lshr i32 %110, 24
  %112 = trunc i32 %111 to i8
  store i8 %112, i8* %66, align 1, !tbaa !5
  %113 = lshr i32 %110, 16
  %114 = trunc i32 %113 to i8
  store i8 %114, i8* %67, align 1, !tbaa !5
  %115 = lshr i32 %110, 8
  %116 = trunc i32 %115 to i8
  store i8 %116, i8* %68, align 1, !tbaa !5
  %117 = trunc i32 %110 to i8
  store i8 %117, i8* %69, align 1, !tbaa !5
  br label %BF_cfb64_encrypt.exit.i

BF_cfb64_encrypt.exit.i:                          ; preds = %73, %.loopexit.i
  %118 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 %num.i.0
  %119 = load i8* %118, align 1, !tbaa !5
  %120 = xor i8 %119, %71
  store i8 %120, i8* %118, align 1, !tbaa !5
  %121 = add nuw nsw i32 %num.i.0, 1
  %122 = and i32 %121, 7
  %123 = getelementptr inbounds [5200 x i8]* @out_key, i32 0, i32 %k.06.i
  %124 = load i8* %123, align 1, !tbaa !5
  %125 = icmp eq i8 %120, %124
  %126 = zext i1 %125 to i32
  %127 = add nsw i32 %126, %check.05.i
  %128 = add nsw i32 %k.06.i, 1
  %exitcond.i = icmp eq i32 %128, 5200
  br i1 %exitcond.i, label %blowfish_main.exit, label %.loopexit.i

blowfish_main.exit:                               ; preds = %BF_cfb64_encrypt.exit.i
  %.lcssa = phi i32 [ %127, %BF_cfb64_encrypt.exit.i ]
  %129 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %.lcssa) #1
  %130 = icmp eq i32 %.lcssa, 5200
  br i1 %130, label %131, label %133

; <label>:131                                     ; preds = %blowfish_main.exit
  %132 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0)) #1
  br label %135

; <label>:133                                     ; preds = %blowfish_main.exit
  %134 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #1
  br label %135
