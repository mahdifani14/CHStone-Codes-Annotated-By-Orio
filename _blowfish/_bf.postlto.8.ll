...
; <label>:2                                       ; preds = %2, %0
  %i.07.i = phi i32 [ 0, %0 ], [ %5, %2 ]
  %3 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 %i.07.i
  store i8 0, i8* %3, align 1, !tbaa !5
  %4 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 %i.07.i
  store i8 0, i8* %4, align 1, !tbaa !5
  %5 = add nsw i32 %i.07.i, 1
  %exitcond9.i = icmp eq i32 %5, 8
  br i1 %exitcond9.i, label %6, label %2

; <label>:6                                       ; preds = %2
  %7 = bitcast [8 x i8]* %ivec.i to i8*
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i, %6
  %p2.03.i.i.i = phi i32* [ %11, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @bf_init_P, i32 0, i32 0), %6 ]
  %p1.02.i.i.i = phi i32* [ %10, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @key_P, i32 0, i32 0), %6 ]
  %.01.i.i.i = phi i32 [ %8, %.lr.ph.i.i.i ], [ 18, %6 ]
  %8 = add nsw i32 %.01.i.i.i, -1
  %9 = load i32* %p2.03.i.i.i, align 4, !tbaa !1
  store i32 %9, i32* %p1.02.i.i.i, align 4, !tbaa !1
  %10 = getelementptr inbounds i32* %p1.02.i.i.i, i32 1
  %11 = getelementptr inbounds i32* %p2.03.i.i.i, i32 1
  %12 = icmp sgt i32 %8, 0
  br i1 %12, label %.lr.ph.i.i.i, label %.lr.ph.i4.i.i.preheader

.lr.ph.i4.i.i.preheader:                          ; preds = %.lr.ph.i.i.i
  %13 = bitcast [2 x i32]* %in.i.i to i8*
  br label %.lr.ph.i4.i.i

.lr.ph.i4.i.i:                                    ; preds = %.lr.ph.i4.i.i, %.lr.ph.i4.i.i.preheader
  %p2.03.i1.i.i = phi i32* [ %17, %.lr.ph.i4.i.i ], [ getelementptr inbounds ([1024 x i32]* @bf_init_S, i32 0, i32 0), %.lr.ph.i4.i.i.preheader ]
  %p1.02.i2.i.i = phi i32* [ %16, %.lr.ph.i4.i.i ], [ getelementptr inbounds ([1024 x i32]* @key_S, i32 0, i32 0), %.lr.ph.i4.i.i.preheader ]
  %.01.i3.i.i = phi i32 [ %14, %.lr.ph.i4.i.i ], [ 1024, %.lr.ph.i4.i.i.preheader ]
  %14 = add nsw i32 %.01.i3.i.i, -1
  %15 = load i32* %p2.03.i1.i.i, align 4, !tbaa !1
  store i32 %15, i32* %p1.02.i2.i.i, align 4, !tbaa !1
  %16 = getelementptr inbounds i32* %p1.02.i2.i.i, i32 1
  %17 = getelementptr inbounds i32* %p2.03.i1.i.i, i32 1
  %18 = icmp sgt i32 %14, 0
  br i1 %18, label %.lr.ph.i4.i.i, label %memcpy.exit5.i.i

memcpy.exit5.i.i:                                 ; preds = %.lr.ph.i4.i.i
  %19 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 0
  %20 = getelementptr inbounds i8* %19, i32 8
  br label %21

; <label>:21                                      ; preds = %21, %memcpy.exit5.i.i
  %d.05.i.i = phi i8* [ %19, %memcpy.exit5.i.i ], [ %d.4.i.i, %21 ]
  ...
  %.data.i.i = select i1 %25, i8* %22, i8* %19
  ...
  %d.2.i.i = select i1 %31, i8* %27, i8* %19
  ...
  %.data1.i.i = select i1 %37, i8* %33, i8* %19
  %38 = shl nuw i32 %36, 8
  ...
  %d.4.i.i = select i1 %43, i8* %39, i8* %19
...
; <label>:51                                      ; preds = %51, %48
  ...
  call fastcc void @BF_encrypt(i32* %49) #1
...
blowfish_main.exit:                               ; preds = %BF_cfb64_encrypt.exit.i
  ...
  %133 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %.lcssa) #1
  %134 = icmp eq i32 %.lcssa, 5200
  br i1 %134, label %135, label %137

; <label>:135                                     ; preds = %blowfish_main.exit
  %136 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0)) #1
  br label %139

; <label>:137                                     ; preds = %blowfish_main.exit
  %138 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #1
  br label %139
