...
; <label>:3                                       ; preds = %3, %0
  %i.07.i = phi i32 [ 0, %0 ], [ %6, %3 ]
  %4 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 %i.07.i
  store i8 0, i8* %4, align 1, !tbaa !5
  %5 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 %i.07.i
  store i8 0, i8* %5, align 1, !tbaa !5
  %6 = add nsw i32 %i.07.i, 1
  %exitcond9.i = icmp eq i32 %6, 8
  br i1 %exitcond9.i, label %7, label %3

; <label>:7                                       ; preds = %3
  %8 = bitcast [2 x i32]* %in.i.i to i8*
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i, %7
  %p2.03.i.i.i = phi i32* [ %12, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @bf_init_P, i32 0, i32 0), %7 ]
  %p1.02.i.i.i = phi i32* [ %11, %.lr.ph.i.i.i ], [ getelementptr inbounds ([18 x i32]* @key_P, i32 0, i32 0), %7 ]
  %.01.i.i.i = phi i32 [ %9, %.lr.ph.i.i.i ], [ 18, %7 ]
  %9 = add nsw i32 %.01.i.i.i, -1
  %10 = load i32* %p2.03.i.i.i, align 4, !tbaa !1
  store i32 %10, i32* %p1.02.i.i.i, align 4, !tbaa !1
  %11 = getelementptr inbounds i32* %p1.02.i.i.i, i32 1
  %12 = getelementptr inbounds i32* %p2.03.i.i.i, i32 1
  %13 = icmp sgt i32 %9, 0
  br i1 %13, label %.lr.ph.i.i.i, label %.lr.ph.i4.i.i.preheader

.lr.ph.i4.i.i.preheader:                          ; preds = %.lr.ph.i.i.i
  %14 = getelementptr inbounds [8 x i8]* %ukey.i, i32 0, i32 0
  br label %.lr.ph.i4.i.i

.lr.ph.i4.i.i:                                    ; preds = %.lr.ph.i4.i.i, %.lr.ph.i4.i.i.preheader
  %p2.03.i1.i.i = phi i32* [ %18, %.lr.ph.i4.i.i ], [ getelementptr inbounds ([1024 x i32]* @bf_init_S, i32 0, i32 0), %.lr.ph.i4.i.i.preheader ]
  %p1.02.i2.i.i = phi i32* [ %17, %.lr.ph.i4.i.i ], [ getelementptr inbounds ([1024 x i32]* @key_S, i32 0, i32 0), %.lr.ph.i4.i.i.preheader ]
  %.01.i3.i.i = phi i32 [ %15, %.lr.ph.i4.i.i ], [ 1024, %.lr.ph.i4.i.i.preheader ]
  %15 = add nsw i32 %.01.i3.i.i, -1
  %16 = load i32* %p2.03.i1.i.i, align 4, !tbaa !1
  store i32 %16, i32* %p1.02.i2.i.i, align 4, !tbaa !1
  %17 = getelementptr inbounds i32* %p1.02.i2.i.i, i32 1
  %18 = getelementptr inbounds i32* %p2.03.i1.i.i, i32 1
  %19 = icmp sgt i32 %15, 0
  br i1 %19, label %.lr.ph.i4.i.i, label %memcpy.exit5.i.i

memcpy.exit5.i.i:                                 ; preds = %.lr.ph.i4.i.i
  %20 = getelementptr inbounds i8* %14, i32 8
  br label %21

; <label>:21                                      ; preds = %21, %memcpy.exit5.i.i
  %d.05.i.i = phi i8* [ %14, %memcpy.exit5.i.i ], [ %d.4.i.i, %21 ]
  %i.04.i.i = phi i32 [ 0, %memcpy.exit5.i.i ], [ %47, %21 ]
  %22 = getelementptr inbounds i8* %d.05.i.i, i32 1
  %23 = load i8* %d.05.i.i, align 1, !tbaa !5
  %24 = zext i8 %23 to i32
  %25 = icmp ult i8* %22, %20
  %.data.i.i = select i1 %25, i8* %22, i8* %14
  %26 = shl nuw nsw i32 %24, 8
  %27 = getelementptr inbounds i8* %.data.i.i, i32 1
  %28 = load i8* %.data.i.i, align 1, !tbaa !5
  %29 = zext i8 %28 to i32
  %30 = or i32 %26, %29
  %31 = icmp ult i8* %27, %20
  %d.2.i.i = select i1 %31, i8* %27, i8* %14
  %32 = shl nuw nsw i32 %30, 8
  %33 = getelementptr inbounds i8* %d.2.i.i, i32 1
  %34 = load i8* %d.2.i.i, align 1, !tbaa !5
  %35 = zext i8 %34 to i32
  %36 = or i32 %32, %35
  %37 = icmp ult i8* %33, %20
  %.data1.i.i = select i1 %37, i8* %33, i8* %14
  %38 = shl nuw i32 %36, 8
  %39 = getelementptr inbounds i8* %.data1.i.i, i32 1
  %40 = load i8* %.data1.i.i, align 1, !tbaa !5
  %41 = zext i8 %40 to i32
  %42 = or i32 %38, %41
  %43 = icmp ult i8* %39, %20
  %d.4.i.i = select i1 %43, i8* %39, i8* %14
  %44 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %i.04.i.i
  %45 = load i32* %44, align 4, !tbaa !1
  %46 = xor i32 %42, %45
  store i32 %46, i32* %44, align 4, !tbaa !1
  %47 = add nsw i32 %i.04.i.i, 1
  %exitcond.i.i = icmp eq i32 %47, 18
  br i1 %exitcond.i.i, label %48, label %21

; <label>:48                                      ; preds = %21
  %49 = getelementptr inbounds [2 x i32]* %in.i.i, i32 0, i32 0
  store i32 0, i32* %49, align 4, !tbaa !1
  %50 = getelementptr inbounds [2 x i32]* %in.i.i, i32 0, i32 1
  store i32 0, i32* %50, align 4, !tbaa !1
  br label %51

; <label>:51                                      ; preds = %51, %48
  %i.13.i.i = phi i32 [ 0, %48 ], [ %57, %51 ]
  call fastcc void @BF_encrypt(i32* %49) #2
  %52 = load i32* %49, align 4, !tbaa !1
  %53 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %i.13.i.i
  store i32 %52, i32* %53, align 4, !tbaa !1
  %54 = load i32* %50, align 4, !tbaa !1
  %55 = or i32 %i.13.i.i, 1
  %56 = getelementptr inbounds [18 x i32]* @key_P, i32 0, i32 %55
  store i32 %54, i32* %56, align 4, !tbaa !1
  %57 = add nsw i32 %i.13.i.i, 2
  %58 = icmp slt i32 %57, 18
  br i1 %58, label %51, label %.preheader.i.i

.preheader.i.i:                                   ; preds = %.preheader.i.i, %51
  %i.22.i.i = phi i32 [ %64, %.preheader.i.i ], [ 0, %51 ]
  call fastcc void @BF_encrypt(i32* %49) #2
  %59 = load i32* %49, align 4, !tbaa !1
  %60 = getelementptr inbounds [1024 x i32]* @key_S, i32 0, i32 %i.22.i.i
  store i32 %59, i32* %60, align 4, !tbaa !1
  %61 = load i32* %50, align 4, !tbaa !1
  %62 = or i32 %i.22.i.i, 1
  %63 = getelementptr inbounds [1024 x i32]* @key_S, i32 0, i32 %62
  store i32 %61, i32* %63, align 4, !tbaa !1
  %64 = add nsw i32 %i.22.i.i, 2
  %65 = icmp slt i32 %64, 1024
  br i1 %65, label %.preheader.i.i, label %BF_set_key.exit.i

BF_set_key.exit.i:                                ; preds = %.preheader.i.i
  %66 = getelementptr inbounds [8 x i8]* %ivec.i, i32 0, i32 0
  %67 = getelementptr inbounds i8* %66, i32 1
  %68 = getelementptr inbounds i8* %66, i32 2
  %69 = getelementptr inbounds i8* %66, i32 3
  %70 = getelementptr inbounds i8* %66, i32 4
  %71 = getelementptr inbounds i8* %66, i32 5
  %72 = getelementptr inbounds i8* %66, i32 6
  %73 = getelementptr inbounds i8* %66, i32 7
  br label %.loopexit.i

.loopexit.i:                                      ; preds = %BF_cfb64_encrypt.exit.i, %BF_set_key.exit.i
  %num.i.0 = phi i32 [ 0, %BF_set_key.exit.i ], [ %126, %BF_cfb64_encrypt.exit.i ]
  %k.06.i = phi i32 [ 0, %BF_set_key.exit.i ], [ %132, %BF_cfb64_encrypt.exit.i ]
  %check.05.i = phi i32 [ 0, %BF_set_key.exit.i ], [ %131, %BF_cfb64_encrypt.exit.i ]
  %74 = getelementptr inbounds [5200 x i8]* @in_key, i32 0, i32 %k.06.i
  %75 = load i8* %74, align 1, !tbaa !5
  %76 = icmp eq i32 %num.i.0, 0
  br i1 %76, label %77, label %BF_cfb64_encrypt.exit.i

; <label>:77                                      ; preds = %.loopexit.i
  %78 = load i8* %66, align 1, !tbaa !5
  %79 = zext i8 %78 to i32
  %80 = shl nuw i32 %79, 24
  %81 = load i8* %67, align 1, !tbaa !5
  %82 = zext i8 %81 to i32
  %83 = shl nuw nsw i32 %82, 16
  %84 = or i32 %83, %80
  %85 = load i8* %68, align 1, !tbaa !5
  %86 = zext i8 %85 to i32
  %87 = shl nuw nsw i32 %86, 8
  %88 = or i32 %84, %87
  %89 = load i8* %69, align 1, !tbaa !5
  %90 = zext i8 %89 to i32
  %91 = or i32 %88, %90
  store i32 %91, i32* %49, align 4, !tbaa !1
  %92 = load i8* %70, align 1, !tbaa !5
  %93 = zext i8 %92 to i32
  %94 = shl nuw i32 %93, 24
  %95 = load i8* %71, align 1, !tbaa !5
  %96 = zext i8 %95 to i32
  %97 = shl nuw nsw i32 %96, 16
  %98 = or i32 %97, %94
  %99 = load i8* %72, align 1, !tbaa !5
  %100 = zext i8 %99 to i32
  %101 = shl nuw nsw i32 %100, 8
  %102 = or i32 %98, %101
  %103 = load i8* %73, align 1, !tbaa !5
  %104 = zext i8 %103 to i32
  %105 = or i32 %102, %104
  store i32 %105, i32* %50, align 4, !tbaa !1
  call fastcc void @BF_encrypt(i32* %49) #2
  %106 = load i32* %49, align 4, !tbaa !1
  %107 = lshr i32 %106, 24
  %108 = trunc i32 %107 to i8
  store i8 %108, i8* %66, align 1, !tbaa !5
  %109 = lshr i32 %106, 16
  %110 = trunc i32 %109 to i8
  store i8 %110, i8* %67, align 1, !tbaa !5
  %111 = lshr i32 %106, 8
  %112 = trunc i32 %111 to i8
  store i8 %112, i8* %68, align 1, !tbaa !5
  %113 = trunc i32 %106 to i8
  store i8 %113, i8* %69, align 1, !tbaa !5
  %114 = load i32* %50, align 4, !tbaa !1
  %115 = lshr i32 %114, 24
  %116 = trunc i32 %115 to i8
  store i8 %116, i8* %70, align 1, !tbaa !5
  %117 = lshr i32 %114, 16
  %118 = trunc i32 %117 to i8
  store i8 %118, i8* %71, align 1, !tbaa !5
  %119 = lshr i32 %114, 8
  %120 = trunc i32 %119 to i8
  store i8 %120, i8* %72, align 1, !tbaa !5
  %121 = trunc i32 %114 to i8
  store i8 %121, i8* %73, align 1, !tbaa !5
  br label %BF_cfb64_encrypt.exit.i

BF_cfb64_encrypt.exit.i:                          ; preds = %77, %.loopexit.i
  %122 = getelementptr inbounds i8* %66, i32 %num.i.0
  %123 = load i8* %122, align 1, !tbaa !5
  %124 = xor i8 %123, %75
  store i8 %124, i8* %122, align 1, !tbaa !5
  %125 = add nsw i32 %num.i.0, 1
  %126 = and i32 %125, 7
  %127 = getelementptr inbounds [5200 x i8]* @out_key, i32 0, i32 %k.06.i
  %128 = load i8* %127, align 1, !tbaa !5
  %129 = icmp eq i8 %124, %128
  %130 = zext i1 %129 to i32
  %131 = add nsw i32 %130, %check.05.i
  %132 = add nsw i32 %k.06.i, 1
  %exitcond.i = icmp eq i32 %132, 5200
  br i1 %exitcond.i, label %blowfish_main.exit, label %.loopexit.i

blowfish_main.exit:                               ; preds = %BF_cfb64_encrypt.exit.i
  %.lcssa = phi i32 [ %131, %BF_cfb64_encrypt.exit.i ]
  %133 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %.lcssa) #2
  %134 = icmp eq i32 %.lcssa, 5200
  br i1 %134, label %135, label %137

; <label>:135                                     ; preds = %blowfish_main.exit
  %136 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0)) #2
  br label %139

; <label>:137                                     ; preds = %blowfish_main.exit
  %138 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0)) #2
  br label %139
