...
; <label>:33                                      ; preds = %33, %30
  ...
  br i1 %40, label %33, label %.preheader.preheader

.preheader.preheader:                             ; preds = %33
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  %i.22 = phi i32 [ %46, %.preheader ], [ 0, %.preheader.preheader ]
  call void @BF_encrypt(i32* %31, i32 1) #3
...
; <label>:70                                      ; preds = %25, %22
  ...
  %78 = and i32 %77, 7
  %79 = icmp eq i32 %23, 0
  br i1 %79, label %.loopexit.loopexit1, label %22
...
.loopexit.loopexit1:                              ; preds = %70
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit1, %.loopexit.loopexit, %.preheader, %.preheader3
  %n.2 = phi i32 [ %1, %.preheader ], [ %1, %.preheader3 ], [ %136, %.loopexit.loopexit ], [ %78, %.loopexit.loopexit1 ]
