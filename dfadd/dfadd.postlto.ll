...
; <label>:1                                       ; preds = %float64_add.exit, %0
  ...
  %i.01 = phi i32 [ 0, %0 ], [ %246, %float64_add.exit ]
...
; <label>:24                                      ; preds = %22
  %25 = icmp eq i64 %18, 0
  br i1 %25, label %float64_add.exit, label %float64_is_signaling_nan.exit1.i10.i.i

float64_is_signaling_nan.exit1.i10.i.i:           ; preds = %24
  ...
  %.mux2.v.i14.i.i = select i1 %29, i64 %5, i64 %3
...
; <label>:32                                      ; preds = %22
  ...
  %expDiff.0.i2.i = add nsw i32 %36, %15
  %37 = icmp eq i32 %expDiff.0.i2.i, 0
  br i1 %37, label %shift64RightJamming.exit9.i.i, label %38

; <label>:38                                      ; preds = %32
  %39 = icmp slt i32 %expDiff.0.i2.i, 64
  br i1 %39, label %40, label %50

; <label>:40                                      ; preds = %38
  %41 = zext i32 %expDiff.0.i2.i to i64
  %42 = lshr i64 %35, %41
  %43 = sub nsw i32 0, %expDiff.0.i2.i
  %44 = and i32 %43, 63
...
; <label>:57                                      ; preds = %55
  %58 = icmp eq i64 %20, 0
  br i1 %58, label %65, label %float64_is_signaling_nan.exit1.i1.i.i

float64_is_signaling_nan.exit1.i1.i.i:            ; preds = %57
  ...
  %.mux2.v.i5.i.i = select i1 %62, i64 %5, i64 %3
...
; <label>:68                                      ; preds = %55
  ...
  %expDiff.1.i3.i = add nsw i32 %15, %72
  %73 = sub nsw i32 0, %expDiff.1.i3.i
  %74 = icmp eq i32 %expDiff.1.i3.i, 0
  br i1 %74, label %shift64RightJamming.exit9.i.i, label %75

; <label>:75                                      ; preds = %68
  %76 = icmp sgt i32 %expDiff.1.i3.i, -64
  br i1 %76, label %77, label %86

; <label>:77                                      ; preds = %75
  %78 = zext i32 %73 to i64
  %79 = lshr i64 %71, %78
  %80 = and i32 %expDiff.1.i3.i, 63
...
; <label>:90                                      ; preds = %89
  %91 = or i64 %20, %18
  %92 = icmp eq i64 %91, 0
  br i1 %92, label %float64_add.exit, label %float64_is_signaling_nan.exit1.i.i4.i

float64_is_signaling_nan.exit1.i.i4.i:            ; preds = %90
  ...
  %.mux2.v.i.i8.i = select i1 %96, i64 %5, i64 %3
...
shift64RightJamming.exit9.i.i:                    ; preds = %86, %77, %68, %50, %40, %32
  %107 = phi i64 [ %18, %32 ], [ %18, %40 ], [ %18, %50 ], [ %85, %77 ], [ %88, %86 ], [ %71, %68 ]
  %108 = phi i64 [ %35, %32 ], [ %49, %40 ], [ %52, %50 ], [ %20, %77 ], [ %20, %86 ], [ %20, %68 ]
  %zExp.0.i11.i = phi i32 [ %12, %32 ], [ %12, %40 ], [ %12, %50 ], [ %14, %77 ], [ %14, %86 ], [ %14, %68 ]
  %109 = or i64 %107, 2305843009213693952
  %110 = add i64 %109, %108
  %111 = shl i64 %110, 1
  %112 = icmp slt i64 %111, 0
  %not..i.i = xor i1 %112, true
  %113 = sext i1 %not..i.i to i32
  %zExp.0..i.i = add nsw i32 %113, %zExp.0.i11.i
  %..i.i = select i1 %112, i64 %110, i64 %111
  br label %114

; <label>:114                                     ; preds = %shift64RightJamming.exit9.i.i, %104
  %zExp.1.i.i = phi i32 [ %12, %104 ], [ %zExp.0..i.i, %shift64RightJamming.exit9.i.i ]
  %zSig.0.i12.i = phi i64 [ %106, %104 ], [ %..i.i, %shift64RightJamming.exit9.i.i ]
  %115 = tail call fastcc i64 @roundAndPackFloat64(i32 %7, i32 %zExp.1.i.i, i64 %zSig.0.i12.i) #1
  br label %float64_add.exit
...
; <label>:125                                     ; preds = %124
  ...
  br i1 %127, label %134, label %float64_is_signaling_nan.exit1.i11.i.i

float64_is_signaling_nan.exit1.i11.i.i:           ; preds = %125
  ...
  %.mux2.v.i15.i.i = select i1 %131, i64 %5, i64 %3
  %.mux2.i16.i.i = or i64 %.mux2.v.i15.i.i, 2251799813685248
  br label %float64_add.exit

; <label>:134                                     ; preds = %125
  %135 = load i32* @float_exception_flags, align 4, !tbaa !5
  %136 = or i32 %135, 16
  store i32 %136, i32* @float_exception_flags, align 4, !tbaa !5
  br label %float64_add.exit
...
; <label>:138                                     ; preds = %137, %124
  %aExp.0.i.i = phi i32 [ 1, %137 ], [ %12, %124 ]
  %bExp.0.i.i = phi i32 [ 1, %137 ], [ %14, %124 ]
...
; <label>:144                                     ; preds = %142
  ...
  br i1 %145, label %152, label %float64_is_signaling_nan.exit1.i4.i.i

float64_is_signaling_nan.exit1.i4.i.i:            ; preds = %144
  ...
  %.mux2.v.i8.i.i = select i1 %149, i64 %5, i64 %3
...
; <label>:157                                     ; preds = %142
  ...
  %expDiff.0.i.i = add nsw i32 %15, %161
  %162 = sub nsw i32 0, %expDiff.0.i.i
  %163 = icmp eq i32 %expDiff.0.i.i, 0
  br i1 %163, label %shift64RightJamming.exit3.i.i, label %164

; <label>:164                                     ; preds = %157
  %165 = icmp sgt i32 %expDiff.0.i.i, -64
  br i1 %165, label %166, label %175

; <label>:166                                     ; preds = %164
  %167 = zext i32 %162 to i64
  %168 = lshr i64 %160, %167
  %169 = and i32 %expDiff.0.i.i, 63
...
shift64RightJamming.exit3.i.i:                    ; preds = %175, %166, %157
  %z.0.i2.i.i = phi i64 [ %174, %166 ], [ %177, %175 ], [ %160, %157 ]
  %178 = or i64 %120, 4611686018427387904
  br label %179

; <label>:179                                     ; preds = %shift64RightJamming.exit3.i.i, %140
  %180 = phi i64 [ %z.0.i2.i.i, %shift64RightJamming.exit3.i.i ], [ %118, %140 ]
  %181 = phi i64 [ %178, %shift64RightJamming.exit3.i.i ], [ %120, %140 ]
  %bExp.1.i.i = phi i32 [ %14, %shift64RightJamming.exit3.i.i ], [ %bExp.0.i.i, %140 ]
  %182 = sub i64 %181, %180
  %183 = xor i32 %7, 1
  br label %220
...
; <label>:186                                     ; preds = %184
  ...
  br i1 %187, label %float64_add.exit, label %float64_is_signaling_nan.exit1.i.i.i

float64_is_signaling_nan.exit1.i.i.i:             ; preds = %186
  ...
  %.mux2.v.i.i.i = select i1 %191, i64 %5, i64 %3
...
; <label>:194                                     ; preds = %184
  ...
  %expDiff.1.i.i = add nsw i32 %198, %15
  %199 = icmp eq i32 %expDiff.1.i.i, 0
  br i1 %199, label %shift64RightJamming.exit.i.i, label %200

; <label>:200                                     ; preds = %194
  %201 = icmp slt i32 %expDiff.1.i.i, 64
  br i1 %201, label %202, label %212

; <label>:202                                     ; preds = %200
  %203 = zext i32 %expDiff.1.i.i to i64
  %204 = lshr i64 %197, %203
  %205 = sub nsw i32 0, %expDiff.1.i.i
  %206 = and i32 %205, 63
...
shift64RightJamming.exit.i.i:                     ; preds = %212, %202, %194
  %z.0.i.i.i = phi i64 [ %211, %202 ], [ %214, %212 ], [ %197, %194 ]
  %215 = or i64 %118, 4611686018427387904
  br label %216

; <label>:216                                     ; preds = %shift64RightJamming.exit.i.i, %138
  %217 = phi i64 [ %215, %shift64RightJamming.exit.i.i ], [ %118, %138 ]
  %218 = phi i64 [ %z.0.i.i.i, %shift64RightJamming.exit.i.i ], [ %120, %138 ]
  %aExp.1.i.i = phi i32 [ %12, %shift64RightJamming.exit.i.i ], [ %aExp.0.i.i, %138 ]
  %219 = sub i64 %217, %218
  br label %220

; <label>:220                                     ; preds = %216, %179
  %.0.i.i = phi i32 [ %7, %216 ], [ %183, %179 ]
  %zExp.0.i.i = phi i32 [ %aExp.1.i.i, %216 ], [ %bExp.1.i.i, %179 ]
  %zSig.0.i.i = phi i64 [ %219, %216 ], [ %182, %179 ]
  %221 = add nsw i32 %zExp.0.i.i, -1
  %222 = icmp ult i64 %zSig.0.i.i, 4294967296
  %223 = lshr i64 %zSig.0.i.i, 32
  %a.sink.i.i.i.i = select i1 %222, i64 %zSig.0.i.i, i64 %223
  %extract.t.i.i.i.i = trunc i64 %a.sink.i.i.i.i to i32
  %224 = icmp ult i32 %extract.t.i.i.i.i, 65536
  %225 = shl i32 %extract.t.i.i.i.i, 16
  %.a.i.i.i.i.i = select i1 %224, i32 %225, i32 %extract.t.i.i.i.i
  %..i.i.i.i.i = select i1 %224, i32 16, i32 0
  %226 = icmp ult i32 %.a.i.i.i.i.i, 16777216
  br i1 %226, label %227, label %normalizeRoundAndPackFloat64.exit.i.i

; <label>:227                                     ; preds = %220
  %228 = or i32 %..i.i.i.i.i, 8
  %229 = shl i32 %.a.i.i.i.i.i, 8
  br label %normalizeRoundAndPackFloat64.exit.i.i

normalizeRoundAndPackFloat64.exit.i.i:            ; preds = %227, %220
  %.1.i.i.i.i.i = phi i32 [ %229, %227 ], [ %.a.i.i.i.i.i, %220 ]
  %shiftCount.1.i.i.i.i.i = phi i32 [ %228, %227 ], [ %..i.i.i.i.i, %220 ]
  %230 = lshr i32 %.1.i.i.i.i.i, 24
  ...
  %238 = shl i64 %zSig.0.i.i, %237
  %239 = tail call fastcc i64 @roundAndPackFloat64(i32 %.0.i.i, i32 %236, i64 %238) #1
  br label %float64_add.exit

float64_add.exit:                                 ; preds = %normalizeRoundAndPackFloat64.exit.i.i, %float64_is_signaling_nan.exit1.i.i.i, %186, %152, %float64_is_signaling_nan.exit1.i4.i.i, %140, %134, %float64_is_signaling_nan.exit1.i11.i.i, %114, %99, %float64_is_signaling_nan.exit1.i.i4.i, %90, %65, %float64_is_signaling_nan.exit1.i1.i.i, %float64_is_signaling_nan.exit1.i10.i.i, %24
  %.0.i = phi i64 [ %.mux2.i15.i.i, %float64_is_signaling_nan.exit1.i10.i.i ], [ %115, %114 ], [ %.mux2.i6.i.i, %float64_is_signaling_nan.exit1.i1.i.i ], [ %67, %65 ], [ %.mux2.i.i9.i, %float64_is_signaling_nan.exit1.i.i4.i ], [ %103, %99 ], [ %3, %24 ], [ %3, %90 ], [ %.mux2.i.i.i, %float64_is_signaling_nan.exit1.i.i.i ], [ %239, %normalizeRoundAndPackFloat64.exit.i.i ], [ %.mux2.i9.i.i, %float64_is_signaling_nan.exit1.i4.i.i ], [ %156, %152 ], [ %.mux2.i16.i.i, %float64_is_signaling_nan.exit1.i11.i.i ], [ 9223372036854775807, %134 ], [ %3, %186 ], [ 0, %140 ]
  %240 = getelementptr inbounds [46 x i64]* @z_output, i32 0, i32 %i.01
  %241 = load i64* %240, align 8, !tbaa !1
  %242 = icmp eq i64 %.0.i, %241
  %243 = zext i1 %242 to i32
  %244 = add nsw i32 %243, %main_result.02
  %245 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([65 x i8]* @.str, i32 0, i32 0), i64 %3, i64 %5, i64 %241, i64 %.0.i) #1
  %246 = add nsw i32 %i.01, 1
  %exitcond = icmp eq i32 %246, 46
  br i1 %exitcond, label %247, label %1

; <label>:247                                     ; preds = %float64_add.exit
  %.lcssa = phi i32 [ %244, %float64_add.exit ]
  %248 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %.lcssa) #1
  %249 = icmp eq i32 %.lcssa, 46
  br i1 %249, label %250, label %252

; <label>:250                                     ; preds = %247
  %251 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1
  br label %254

; <label>:252                                     ; preds = %247
  %253 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str3, i32 0, i32 0)) #1
  br label %254
